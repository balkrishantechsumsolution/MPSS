<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="Attendance.aspx.cs" Inherits="CitizenPortal.WebApp.Faculty.Attendance" %>
    ...
    <script type="text/javascript">
        ...
        function EnableControls(p_RowID) {
            ...
            if (document.getElementById("ContentPlaceHolder1_DataGridView_chkRollNo_" + p_ID).checked) {
                ...
                document.getElementById("ContentPlaceHolder1_DataGridView_txtAttendanceRemark_" + p_ID).disabled = false;
                document.getElementById("ContentPlaceHolder1_DataGridView_txtAttendance_" + p_ID).disabled = false;
            }
            else {
                //document.getElementById("ContentPlaceHolder1_DataGridView_txtMarks_" + p_ID).disabled = true;
                document.getElementById("ContentPlaceHolder1_DataGridView_txtAttendanceRemark_" + p_ID).disabled = true;
                document.getElementById("ContentPlaceHolder1_DataGridView_txtAttendance_" + p_ID).disabled = true;
            }
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i> EXAM ATTENDANCE SYSTERM</h2>
                </div>
            </div>
            <%---Start of Filter----%>
            <div class="row" style="">
                <div class="col-md-12 box-container">
                    ...
                    <div class="box-body box-body-open">
                        ...
                        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                            <div class="form-group">
                                <label class="" for="ddlSubjectType">
                                    Subject Type
                                </label>
                                <asp:DropDownList ID="ddlSubjectType" runat="server" CssClass="form-control">
                                    <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                    <asp:ListItem Value="Theory" Text="Theory"></asp:ListItem>
                                    <asp:ListItem Value="Practical" Text="Practical"></asp:ListItem>
                                    
                                </asp:DropDownList>
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlSubjectType" InitialValue="0" Display="Dynamic"
                                    ErrorMessage="Please select exam type." ValidationGroup="G" ForeColor="Red" />--%>
                            </div>
                    ...
                    <div class="box-body box-body-open">
                        <div style="text-align: center; color: red; padding: 3px"> Please  Enter : P for Present | A for Absent | M for Malpractice | U for Unfair
                            <br />Note: After submission of Attendance, take print out of the submitted marks by clicking on "PRINT SUNMITTED ATTENDANCE" button </div>
                                    ...
                                    <asp:GridView ID="DataGridView" runat="server" Width="99%" OnPreRender="DataGridView_PreRender"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Select">
                                                <HeaderTemplate>
                                                    <asp:CheckBox ID="chkAll" runat="server" onclick="return SelectAll(this);" Text="Select All" />
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Attendance">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtAttendance" runat="server" MaxLength="1" Width="70" Text='<%#Eval("IsAttendance") %>' onkeypress="return isAttendanceKey(event);" Enabled="false"></asp:TextBox>
                                                    <asp:CustomValidator ID="CustomValidator1" runat="server" Display="Dynamic" SetFocusOnError="True" ForeColor="Red" ControlToValidate="txtAttendance" ErrorMessage="Invalid Entry! Enter:(P for Present | A for Absent | M for Malpractice | U for Unfair)" ClientValidationFunction="CheckAttendance"></asp:CustomValidator>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Attendance Remark">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtAttendanceRemark" runat="server" MaxLength="50" Width="120" Text='<%#Eval("AttendanceRemark") %>' Enabled="false"></asp:TextBox>
                                                    <%--<asp:CustomValidator ID="CustomValidator2" runat="server" Display="Dynamic" SetFocusOnError="True" ForeColor="Red" ControlToValidate="txtAttendanceRemark" ErrorMessage="Invalid Entry! Enter:(<= Total Marks or AB or MB)" ClientValidationFunction="CheckMarksEnter2"></asp:CustomValidator>--%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <div class="row">
                        <div class="col-md-12 box-container" style="margin-top: 5px;">
                            <div class="box-body box-body-open" style="text-align: center;">
                                <asp:Button ID="btnSave" runat="server" CssClass="btn btn-primary" Text="Save Attendance" OnClick="btnSave_Click" />
                                <div style="display: none">
                                    <asp:Button ID="btnSubmit" runat="server" Text="Final Submission" CssClass="btn btn-danger" OnClick="btnSubmit_Click" OnClientClick="javascript:return ConfirmSubmit();" Visible="false" />
                                </div>
                                <asp:Button ID="btnPrint" runat="server" Text="Print Attendance Detail" CssClass="btn btn-success" OnClick="btnPrint_Click" />
