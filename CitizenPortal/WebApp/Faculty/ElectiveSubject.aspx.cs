...
{
    public partial class ElectiveSubject : AdminBasePage
    {
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            result = m_FacultyModuleBLL.InsertElectiveSubject(LoginID, ddlCollege.SelectedValue, ddlCourse.SelectedValue, ddlProgram.SelectedValue,
                    ddlSession.SelectedValue, ddlSemester.SelectedValue, ddlSubject.SelectedValue, ddlSubject2.SelectedValue);
        ...
        public void GetSubject()
        {
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    ddlSubject2.Items.Insert(0, new ListItem("Select", "0"));
                }
            }
            catch (Exception ex)
            {
