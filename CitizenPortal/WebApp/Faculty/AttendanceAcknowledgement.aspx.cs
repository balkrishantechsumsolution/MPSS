...
{
    public partial class AttendanceAcknowledgement : AdminBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet dt = m_FacultyModuleBLL.AttendanceSummaryPrint(mCollege, mCourse, mProgram, mSemester, mSubject, mYear, mType);
