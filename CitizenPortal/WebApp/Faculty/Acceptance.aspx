<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="Acceptance.aspx.cs" Inherits="CitizenPortal.WebApp.Faculty.Acceptance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function TakeAction(p_URL, p_ServiceID, p_AppID) {
            ...
            var t_URL = "/WebApp/Faculty/AppointmentLetter.aspx";
            t_URL = t_URL + "?RowID=" + p_AppID;
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>Acceptance for Question Paper Setting</h2>
                </div>
            </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                            <div class="form-group">
                                ...
                                <asp:dropdownlist id="ddlStatus" runat="server" appenddatabounditems="True"
                                    ...
                                    <asp:ListItem Value="P">Accepted / Refuse for QP Setting</asp:ListItem>
                                    <asp:ListItem Value="A">Accepted QP setting</asp:ListItem>
                                </asp:dropdownlist>
                            ...
                            <div class="form-group">
                                ...
                                &nbsp;&nbsp;
                                    <asp:button id="btnSearch" runat="server" causesvalidation="true" cssclass="btn btn-primary"
                                        text="Show List" onclick="btnSearch_Click" validationgroup="A" />
                            </div>
                        </div>
