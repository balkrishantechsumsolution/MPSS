<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="PracticalMarkEntry.aspx.cs" Inherits="CitizenPortal.WebApp.Faculty.PracticalMarkEntry" %>
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i> PRACTICAL MARKS ENTRY </h2>
                </div>
            </div>
            <%---Start of Filter----%>
            <div class="row" style="">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow-y: auto;">
                                    ...
                                    <asp:GridView ID="DataGridView" runat="server" Width="99%" OnPreRender="DataGridView_PreRender"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Total CT" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="TheoryMark_CT" runat="server" Text='<%# Bind("TheoryMark_CT") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Marks Obtain CT" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Sessional Mark TA" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="SessionalMark_TA" runat="server" Text='<%# Bind("SessionalMark_TA") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Sessional MO TA" Visible="false">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtSessionalMO_TA" runat="server" MaxLength="2" Width="70" Text='<%#Eval("SessionalMO_TA") %>' onkeypress="return isNumberKeyAB(event);" Enabled="false"></asp:TextBox>
