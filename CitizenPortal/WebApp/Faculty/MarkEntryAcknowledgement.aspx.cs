...
{
    public partial class MarkEntryAcknowledgement : AdminBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet dt = m_FacultyModuleBLL.MarkEntrySummaryPrint(mCollege, mCourse, mProgram, mSemester, mSubject, mYear, mType);
