...
{
    public partial class PracticalMarkEntry : AdminBasePage
    {
        ...
        public void GetSubject()
        {
            ...
            {
                DataTable dt = new DataTable();
                dt = m_FacultyModuleBLL.GetFacultySubjectCSVTU(ddlCourse.SelectedValue, ddlProgram.SelectedValue, ddlSemester.SelectedValue, ddlSession.SelectedValue, "Practical");
                if (dt != null && dt.Rows.Count > 0)
                {
        ...
        public void LoadGridData()
        {
            ...
            DataTable t_dt = null;
            DataSet t_Ds = null;
            t_Ds = m_G2GDashboardBLL.GetStudentPracticalPaper(College, ExamType, CourseCode, ProgramCode, t_Year, Semester, SubjectCode, RollNo);
            ds = t_Ds.Tables[1];
            t_dt = t_Ds.Tables[0];
                    ...
                    foreach (GridViewRow rows in DataGridView.Rows)
                    {
                        ...
                        if (chkenroll.Checked)
                        {
                            ...
                            if(chk_RowID == t_RowIDArr[i])
                            {
                                ...
                                result = m_FacultyModuleBLL.CSVTUPracticalMarkEntryData(t_CSVTUMarkEntry_DT, AFields);
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(t_RowID))
            {
                ...
                result = m_AdmissionFormBLL.PracticalMarkSubmitted(College, Coursre, ExamType, ExamYear, Semester, Subject, UID);
        ...
        {
            string t_URL = "/WebApp/Faculty/PracticalAcknowledgement.aspx?CC=" + ddlCollege.SelectedValue + "&BC=" + ddlCourse.SelectedValue + "&SS=" + ddlSubject.SelectedValue + "&SC=" + ddlSemester.SelectedValue + "&ET=" + ddlExamType.SelectedValue + "&EY=" + ddlSession.SelectedItem.Text + "&PC=" + ddlProgram.SelectedValue;
