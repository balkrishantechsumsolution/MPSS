<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="ApproveFaculty.aspx.cs" Inherits="CitizenPortal.WebApp.Faculty.ApproveFaculty" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function TakeAction(p_URL, p_ServiceID, p_AppID) {
            ...
            var t_URL = "";
            if (p_ServiceID == 'Y')
            { t_URL = "/WebApp/Faculty/AppointmentLetter.aspx?RowID=" + p_AppID; }
            else { t_URL = "/WebApp/Faculty/FacultyPage.aspx?ProfileID=" + p_AppID; }
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>Approve Faculty for QP Setting</h2>
                </div>
            </div>
            <div class="row" runat="server" id="divSubject">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 box-container">
                    ...
                    <div class="box-body box-body-open">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                            <div class="form-group">
                                ...
                                <asp:dropdownlist id="ddlStatus" runat="server" appenddatabounditems="True"
                                    ...
                                    <asp:ListItem Value="R">Recommended List by Committee</asp:ListItem>
                                    <asp:ListItem Value="C">Faculty Approved by COE</asp:ListItem>
                                    <asp:ListItem Value="Z">Faculty Acceptance / Refusal Status </asp:ListItem>
                                </asp:dropdownlist>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2 text-right pull-right">
                            <div class="form-group">
                                <label>
                                    &nbsp;&nbsp;</label>
                                &nbsp;&nbsp;
            ...
            <%---Start of Button----%>
            <div class="row" runat="server" id="divBtn" style="display:none">
                <div class="col-md-12 box-container">
                    <div class="box-body box-body-open" style="text-align: center;">
                        <asp:button id="btnAdd" runat="server" causesvalidation="true" cssclass="btn btn-primary"
                            text="Add Faculty" validationgroup="A" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
