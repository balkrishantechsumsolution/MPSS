...
{
    public partial class ElectiveSubjectNew : AdminBasePage
    {
        ...
        public void GetSubject()
        {
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    ddlSubject.DataBind();
                    ddlSubject.Items.Insert(0, new ListItem("Select Elective-I", "0"));

                    ddlSubject2.DataSource = dt;
                    ddlSubject2.DataTextField = "SubjectName";
                    ddlSubject2.DataValueField = "SubjectCode";
                    ddlSubject2.DataBind();
                    ddlSubject2.Items.Insert(0, new ListItem("Select Elective-II", "0"));

                    if ((ddlCourse.SelectedValue == "46" && ddlSemester.SelectedValue == "6 Semester") && (
                           ddlProgram.SelectedValue == "BT3022"
                        || ddlProgram.SelectedValue == "BT3018"
                        || ddlProgram.SelectedValue == "BT3019"
                        || ddlProgram.SelectedValue == "BT3039"
                        || ddlProgram.SelectedValue == "BT3067"
                        ))
                    {
                        divES3.Visible = true;
                        divES4.Visible = false;
                        ddlSubject3.DataSource = dt;
                        ddlSubject3.DataTextField = "SubjectName";
                        ddlSubject3.DataValueField = "SubjectCode";
                        ddlSubject3.DataBind();
                        ddlSubject3.Items.Insert(0, new ListItem("Select Elective-III", "0"));
                    }
                    else if (ddlCourse.SelectedValue == "11" || ddlCourse.SelectedValue == "13")
                    {
                        divES3.Visible = true;
                        divES4.Visible = true;
                        ddlSubject3.DataSource = dt;
                        ...
                        ddlSubject4.DataSource = dt;
                        ddlSubject4.DataTextField = "SubjectName";
                        ddlSubject4.DataValueField = "SubjectCode";
                        ddlSubject4.DataBind();
                        ddlSubject4.Items.Insert(0, new ListItem("Select Elective-IV", "0"));
                    }
                    else {
                        divES3.Visible = false;
                        divES4.Visible = false;
                    }
