...
{
    public partial class RecommendFaculty : AdminBasePage
    {
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            if (ddlDepartment.SelectedIndex == 0 || ddlSession.SelectedIndex == 0 || ddlSemester.SelectedIndex == 0 || ddlCourse.SelectedIndex == 0 || ddlProgram.SelectedIndex == 0 || ddlSubject.SelectedIndex == 0)
            {
