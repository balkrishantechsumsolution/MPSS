<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="ElectiveSubjectNew.aspx.cs"
    Inherits="CitizenPortal.WebApp.Faculty.ElectiveSubjectNew" %>
                            ...
                            <div id="divSubject" class="row" runat="server">
                                <div class="col-md-12 box-container mtop20">
                                    ...
                                    <div class="box-body box-body-open">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3"  id="divES3" runat="server">
                                            <div class="form-group">
                                                <label class="manadatory">Elective Subject-III</label>
                                                <div class="col-xs-12 pleft0 pright0">
                                                    <asp:DropDownList ID="ddlSubject3" runat="server" CssClass="form-control">
                                                        <asp:ListItem Value="0">--Select Subject--</asp:ListItem>
                                                    </asp:DropDownList>                                                    
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3"  id="divES4" runat="server">
                                            <div class="form-group">
                                                <label class="manadatory">Elective Subject-IV</label>
                                                <div class="col-xs-12 pleft0 pright0">
                                                    <asp:DropDownList ID="ddlSubject4" runat="server" CssClass="form-control">
                                                        <asp:ListItem Value="0">--Select Subject--</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
