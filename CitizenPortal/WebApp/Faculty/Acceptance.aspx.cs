...
{
    public partial class Acceptance : AdminBasePage
    {
        ...
        public void BindData()
        {
            ...
            try
            {
                ...
                t_DT = m_FacultyModuleBLL.GetAcceptance(LoginID, ddlDepartment.SelectedValue, ddlCourse.SelectedValue, ddlProgram.SelectedValue, ddlSubject.SelectedValue, ddlSession.SelectedValue,ddlSemester.SelectedValue, ddlStatus.SelectedValue, "");
        ...
        protected void gvDetail_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {                
                ...
                t_Anchor.Attributes.Add("onclick", "TakeAction('', '', '" + e.Row.Cells[1].Text + "')");
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            if (ddlStatus.SelectedIndex == 0)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alertPopup('Mandatory Selection','Please select Exam Session, Semester, Department, Course, Program & Subject!');", true);
                return;
            }
                    ...
                    foreach (GridViewRow rows in gvDetail.Rows)
                    {
                        ...
                        if (chkenroll != null)
                        {
                            ...
                            if (chkenroll.Checked)//if (chk_RowID == t_RowIDArr[i])
                            {
                                ...
                                objNominateFaculty_TB.ProfileID = rows.Cells[cellCount - 3].Text;
                                objNominateFaculty_TB.FacultyID = rows.Cells[10].Text;
