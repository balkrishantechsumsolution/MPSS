<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="ElectiveSubjectMulti.aspx.cs" 
    Inherits="CitizenPortal.WebApp.Faculty.ElectiveSubjectMulti" %>
                    ...
                    <div class="col-md-12 box-container">
                        ...
                        <div class="box-body box-body-open">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5 text-right">
                                <div class="form-group">
                                    <label class="" for="">
                                        &nbsp;</label><asp:Button ID="btn_Submit" runat="server" CausesValidation="True" ValidationGroup="S" CommandName="Insert" CssClass="btn btn-success" Text="Update Subject" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <div class="box-body box-body-open">
                                    ...
                                    <div class="col-md-12 box-container">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow-y: auto;">
                                            ...
                                            <asp:GridView ID="gvDetail" runat="server" Width="99%" CssClass="table table-striped table-bordered" OnRowDataBound="gvDetail_RowDataBound"
                                                >
                                                <Columns>
