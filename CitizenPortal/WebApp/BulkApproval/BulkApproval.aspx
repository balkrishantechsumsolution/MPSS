<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="BulkApproval.aspx.cs" Inherits="CitizenPortal.WebApp.BulkApproval.BulkApproval" %>
                ...
                <div class="row">
                        ...
                        <div class="box-body box-body-open">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3" style="display: none">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlServices" runat="server" CssClass="form-control">
                                        ...
                                        <asp:ListItem Value="1499" Selected="True">Nominate Faculty</asp:ListItem>
                                        <asp:ListItem Value="1498">Enrollment Form Approval</asp:ListItem>
                                        <asp:ListItem Value="1497">Exam Form Approval</asp:ListItem>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" InitialValue="" ControlToValidate="ddlProgram" Display="Dynamic"
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" InitialValue="0" ControlToValidate="ddlSubProgram" Display="Dynamic"
                                        ErrorMessage="Please select Branch" ValidationGroup="A" ForeColor="Red" SetFocusOnError="true" EnableClientScript="true" />
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator29" runat="server" InitialValue="0" ControlToValidate="ddlCourse" Display="Dynamic"
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlStatus" runat="server" AppendDataBoundItems="True"
                                        ...
                                        <asp:ListItem Value="P">Pending for Nomination</asp:ListItem>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2" style="display: none">
                                <div class="form-group">
                                    <label class="" for="txtAppID">Faculty ID</label>
                    ...
                    <div class="col-md-12 box-container">
                        <div class="box-body box-body-open" style="text-align: center;">
                            <asp:Button ID="btnSearch" runat="server" CausesValidation="true" CssClass="btn btn-success" ValidationGroup="A"
