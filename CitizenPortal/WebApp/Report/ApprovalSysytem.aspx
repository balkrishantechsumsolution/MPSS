<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="ApprovalSysytem.aspx.cs" Inherits="CitizenPortal.WebApp.Report.ApprovalSysytem" %>
            ...
            <div class="row" id="div1" runat="server">
                <div class="row">
                    <div class="col-lg-12 cscPgehd">
                        <h2 class="form-heading">Scrunity of Application</h2>
                    </div>
                </div>
                <%---Start of Filter----%>
                <div class="row">
                        ...
                        <div class="box-body box-body-open">                            
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlServices" runat="server" Width="100%" CssClass="form-control" onchange="fnReportType();">
									...
									<asp:ListItem Value="1468" Text="Scrunity of Examination Form"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlExamType" InitialValue="0" Display="Dynamic"
                                    ErrorMessage="Please select exam type." ValidationGroup="A" ForeColor="Red" />
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox runat="server" ID="txtRollNo" class="form-control" placeholder="Application No" name="txtRollNo" MaxLength="20" onkeypress="return isNumberKey(event);"
