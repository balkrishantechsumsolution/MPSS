<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="UniversityReport.aspx.cs" Inherits="CitizenPortal.WebApp.Report.UniversityReport" %>
            ...
            <div class="row" id="div1" runat="server">
                <div class="row">
                    <div class="col-lg-12 cscPgehd">
                        <h2 class="form-heading">UNIVERSITY REPORTS</h2>
                    </div>
                </div>
                <%---Start of Filter----%>
                <div class="row">
                        ...
                        <div class="box-body box-body-open">                            
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlServices" runat="server" Width="100%" CssClass="form-control">
                                    ...
                                    <asp:ListItem Value="UR001" Text="Student Detail"></asp:ListItem>                                     
                                </asp:DropDownList>
                            </div>
                        </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
