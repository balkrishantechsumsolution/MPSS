...
{
    public partial class EnrollmentData : AdminBasePage
    {
        ...
        {            
            ...
            try
            {
                ...
                t_DT = m_FacultyModuleBLL.GetEnrollmentData(LoginID, ddlCollege.SelectedValue, ddlDepartment.SelectedValue, ddlCourse.SelectedValue, ddlProgram.SelectedValue,
                    ddlSession.SelectedValue, ddlSemester.SelectedValue, ddlSubject.SelectedValue, Status, txtRollNo.Text.Trim(), ddlServices.SelectedValue, ddlCategory.SelectedValue);
...
/*
        ...
        {
            DataTable dt = new DataTable();
            dt = m_FacultyModuleBLL.GetSemesterCSVTU(ddlCourse.SelectedItem.Text, ddlProgram.SelectedValue);
            if (dt != null && dt.Rows.Count > 0)
            {
