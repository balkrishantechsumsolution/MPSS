<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="CollegeReport.aspx.cs" Inherits="CitizenPortal.WebApp.Report.CollegeReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function TakeAction(p_ServiceID, p_AppID, p_URL) {
            ...
            t_URL = t_URL;
            window.open(t_URL, 'View', 'height=' + screen.height + ',width=1000,titlebar=no,menubar=no,status=yes,toolbar=no,scrollbars=yes,resizable=yes');
            return false;
        }
            ...
            <div class="row" id="div1" runat="server">
                <div class="row">
                    <div class="col-lg-12 cscPgehd">
                        <h2 class="form-heading">REPORTS</h2>
                    </div>
                </div>
                <%---Start of Filter----%>
                <div class="row">
                        ...
                        <div class="box-body box-body-open">                            
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlServices" runat="server" Width="100%" CssClass="form-control">
									...
									<asp:ListItem Value="CR006" Text="Enrollment Student LoginID & Password"></asp:ListItem>
									<asp:ListItem Value="CR007" Text="Elective Subject Summary Report"></asp:ListItem>
									<asp:ListItem Value="CR008" Text="Student Login ID & Password"></asp:ListItem>
                                    <asp:ListItem Value="CR009" Text="Elective Subject Detail (College & Program Wise)"></asp:ListItem>
									<asp:ListItem Value="CR010" Text="Filled Exam-Form Summary Count"></asp:ListItem>
									<asp:ListItem Value="CR011" Text="Student Exam Data (Semester & Subject Wise)"></asp:ListItem>
									<asp:ListItem Value="CR012" Text="Semester Exam Subject Count (Program, Subject, Type Wise)"></asp:ListItem>
									<asp:ListItem Value="CR013" Text="Attendance Summary Report (College Wise)"></asp:ListItem>
									<asp:ListItem Value="CR014" Text="Detail Attendance Report"></asp:ListItem>
                                    <asp:ListItem Value="CR015" Text="Sessional Marks (CT, TA and Practical)"></asp:ListItem> 
                                </asp:DropDownList>
                            </div>
                        </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlAdmission" runat="server" CssClass="form-control">
                                        <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                        <asp:ListItem Value="2021-2020" Text="2021-2020"></asp:ListItem>
                                    </asp:DropDownList>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlStatus" runat="server" AppendDataBoundItems="True"
                                        ...
                                        <asp:ListItem Value="A">Unpaid</asp:ListItem>
