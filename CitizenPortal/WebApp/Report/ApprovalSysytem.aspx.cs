...
{
    public partial class ApprovalSysytem : AdminBasePage
    {
        ...
        {            
            ...
            try
            {
                ...
                t_DT = m_FacultyModuleBLL.ApprovalSyetem(LoginID, ddlCollege.SelectedValue, ddlDepartment.SelectedValue, ddlCourse.SelectedValue, ddlProgram.SelectedValue,
                    ddlSession.SelectedValue, ddlSemester.SelectedValue, ddlSubject.SelectedValue, Status, txtRollNo.Text.Trim(), ddlServices.SelectedValue,ddlExamType.SelectedValue);
        ...
        protected void gvDetail_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (Session["menuRole"].ToString().Contains("Principal") || Session["menuRole"].ToString().Contains("Admin") || Session["menuRole"].ToString().Contains("University") || Session["LoginID"].ToString().Contains("InfoCell"))
                //if (e.Row.Cells[16].Text != "" && e.Row.Cells[16].Text != "&nbsp;")
                {
                    //if(ddlStatus.SelectedValue = "P") { }
                    //t_ViewOutput1.InnerHtml = "Edit";
                    //t_ViewOutput1.Attributes.Add("onclick", "TakeAction('" + e.Row.Cells[e.Row.Cells.Count-2].Text + "', '" + e.Row.Cells[1].Text + "', '" + e.Row.Cells[e.Row.Cells.Count - 3].Text + "')");
                    ...
                    t_ViewOutput.Attributes.Add("onclick", "TakeAction('" + e.Row.Cells[e.Row.Cells.Count - 1].Text + "', '" + e.Row.Cells[1].Text + "', '" + e.Row.Cells[e.Row.Cells.Count - 3].Text + "')");
                    e.Row.Cells[j].Attributes.Add("Title", "Click for Action");
                ...
                else
                {
                    ...
                    t_ViewOutput.Attributes.Add("onclick", "TakeAction('" + e.Row.Cells[e.Row.Cells.Count - 2].Text + "', '" + e.Row.Cells[1].Text + "', '" + e.Row.Cells[e.Row.Cells.Count - 3].Text + "')");
                    e.Row.Cells[k].Attributes.Add("Title", "Click for Acknowledgement");
                    e.Row.Cells[k].Style.Add(HtmlTextWriterStyle.Cursor, "Pointer");
                    e.Row.Cells[k].Controls.Add(t_ViewOutput);
                }
                j++;
                k++;
                ...
                //if (ddlStatus.SelectedValue == "P" && ddlServices.SelectedValue != "1467") {
                //    e.Row.Cells[k].Attributes.Add("style", "display:none");
                //}
            //}
/*
                int i = 0;
        ...
        public void GetSubject()
        {
            ...
            {
                DataTable dt = new DataTable();
                dt = m_FacultyModuleBLL.GetFacultySubjectCSVTU(ddlCourse.SelectedItem.Text, ddlProgram.SelectedValue, ddlSemester.SelectedValue, ddlSession.SelectedValue,"Theory");
                if (dt != null && dt.Rows.Count > 0)
                {
