<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAction.aspx.cs" Inherits="CitizenPortal.WebApp.Report.AdminAction" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <asp:Button ID="Button1" runat="server" Text="Close" CssClass="btn btn-danger" onclick="window.close();"  />
