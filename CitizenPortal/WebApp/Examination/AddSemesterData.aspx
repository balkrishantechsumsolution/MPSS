<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Citizen/Master/Citizen.Master" AutoEventWireup="true"
    CodeBehind="AddSemesterData.aspx.cs" Inherits="CitizenPortal.WebApp.Examination.AddSemesterData" %>
    ...
    <script type="text/javascript">
        function SUDeclaration(chk) {
            ...
            if (chk) {
                ...
                var loginid = $('#lblUser').text();
                //alert(name);
                $("#lblName").text(name);
                $("#lblApplicant").text(loginid);
        ...
        function fnCalSubject(p_RowID) {
            ...
            t_BackTotal = CalculateExamFees(RollNo, $('#ContentPlaceHolder1_ddlExamType option:Selected').text(), t_PaperCount);
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i> Add Data for Semester Exam Form Fill-up</h2>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 box-container">
                    ...
                    <div class="box-body box-body-open">
                        ...
                        <div class="col-xs-12 col-sm-2 col-md-6 col-lg-2" runat="server">
                            <div class="form-group">
                                <label class="" for="txtEnrollment">
                                    Enrollment No.
                                </label>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-1 col-lg-1">
                            <div class="form-group">
                                <label class="" for="ddlScheme">
                                    Scheme
                                </label>
                                <asp:DropDownList ID="ddlSchema" runat="server" CssClass="form-control">
                                    <asp:ListItem Value="" Text="--Select--"></asp:ListItem> 
                                    <asp:ListItem Selected="True" Value="0" Text="New"></asp:ListItem>
                                    <asp:ListItem Value="1"  Text="Old"></asp:ListItem>                                
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-1  text-right">
                            <div class="form-group">
                                <label>
                                    &nbsp;</label>
            ...
            <div id="divSearch" runat="server">
                                            ...
                                            <td style="padding: 5px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left;">
                                                <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; margin: 0;">
                                                    <tr>
                                                        ...
                                                        <td style="padding: 3px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left;"><b>Roll No</b></td>
                                                        <td style="padding: 3px; border: 1px solid #ccc; color: #383E4B; text-align: left;">
                                                            <asp:Label ID="lblRoll" runat="server"></asp:Label></td>
                                                        <td style="padding: 3px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left;" class="auto-style1"><b>Enrol. No.</b></td>
                                                    ...
                                                    <tr>
                                                        <td style="padding: 3px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left;"><b>Student</b></td>
                                                        <td style="padding: 3px; border: 1px solid #ccc; color: #383E4B; text-align: left;">
                                                            <asp:Label ID="FullName" runat="server"></asp:Label></td>
                                                        <td style="padding: 3px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left;"><b>DOB</b></td>
                                                    ...
                                                    <tr>
                                                        <td style="padding: 3px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left;"><b>Course</b></td>
                                                        <td style="padding: 3px; border: 1px solid #ccc; color: #383E4B; text-align: left;">
                                                            <asp:Label ID="lblBrnachName" runat="server"></asp:Label>
                                                        </td>
                                                        <td style="padding: 3px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left;" class="auto-style1"><b>Program</b></td>
                                                        <td style="padding: 3px; border: 1px solid #ccc; color: #383E4B; text-align: left;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 3px; border: 1px solid #ccc; color: #383E4B; text-align: left;">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="EmailID" Display="Dynamic"
                ...
                <div class="row">
                    <div class="col-md-12 box-container">
                        <div class="box-heading">
                            <h4 class="box-title register-num">Select Subject
                            </h4>
                        </div>
                        <div class="box-body box-body-open">
                                ...
                                <div class="form-group">
                                    <table cellpadding="5" cellspacing="0" class="table table-striped table-bordered" style="width: 100%; margin: 0;">
                                        <tr style="font-weight: bold;">
                                            ...
                                            <td style="padding: 5px; border: 1px solid #ccc; color: #383E4B; text-align: center;vertical-align:middle" rowspan="2">Amount</td>
                                        </tr>
                                        <tr style="font-weight: bold;">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="text-danger text-danger-green mt0">
                                    <p class="text-justify">
                                        I <b>  <span id="lblLoginId" style="text-transform: uppercase;"></span>
                                            
                                        </b>, on behalf of <b><span id="lblName" style="text-transform: uppercase;"></span></b>  
                Roll No. <b><span id="lblRollNo" style="text-transform: uppercase;"></span></b>
                                        hereby affirm that the information given by me in the application is complete and true to the best of my knowledge and belief.
                                    </p>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td rowspan="2"><span class="pull-right" style="color: #000;"><span id="lblApplicant" style="text-transform: uppercase; float: right; color: #777; padding-right: 50px;text-align:center"></span>
                                                    <br />
                                                    Principal of the College</span></td>
                                            </tr>
                                            <tr>
