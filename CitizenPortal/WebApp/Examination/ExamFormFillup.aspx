<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="ExamFormFillup.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.BulkPayment.ExamFormFillup" %>
    ...
    <script type="text/javascript">
        ...
        function EnableControls(p_RowID) {
            ...
            if (document.getElementById("ContentPlaceHolder1_DataGridView_chkappid_" + p_ID).checked) {
                ...
                document.getElementById("ContentPlaceHolder1_DataGridView_chkA5_" + p_ID).disabled = false;
                document.getElementById("ContentPlaceHolder1_DataGridView_chkA6_" + p_ID).disabled = false;
                document.getElementById("ContentPlaceHolder1_DataGridView_chkA7_" + p_ID).disabled = false;
            }
            else {
                ...
                document.getElementById("ContentPlaceHolder1_DataGridView_chkA5_" + p_ID).disabled = true;
                document.getElementById("ContentPlaceHolder1_DataGridView_chkA6_" + p_ID).disabled = true;
                document.getElementById("ContentPlaceHolder1_DataGridView_chkA7_" + p_ID).disabled = true;
                ...
                document.getElementById("ContentPlaceHolder1_DataGridView_chkA5_" + p_ID).checked = false;
                document.getElementById("ContentPlaceHolder1_DataGridView_chkA6_" + p_ID).checked = false;
                document.getElementById("ContentPlaceHolder1_DataGridView_chkA7_" + p_ID).checked = false;
        ...
        function fnCalExamFee(p_RowID) {
            ...
            var t_PaperCount = 0;
            var t_PerPaperFee = 100;
            var t_ExamFee = document.getElementById("ContentPlaceHolder1_DataGridView_lblExamFee_" + p_ID).value;
            ...
            var t_PortalFee = 0;//document.getElementById("ContentPlaceHolder1_DataGridView_lblPortalFee_" + p_ID).innerText;
            var t_TotalAmt = 0;
            var t_SubTotal = 0;
            ...
            if (document.getElementById("ContentPlaceHolder1_DataGridView_chkA5_" + p_ID).checked) {
                t_PaperCount = parseInt(t_PaperCount) + 1;
            }

            if (document.getElementById("ContentPlaceHolder1_DataGridView_chkA6_" + p_ID).checked) {
                t_PaperCount = parseInt(t_PaperCount) + 1;
            }

            if (document.getElementById("ContentPlaceHolder1_DataGridView_chkA7_" + p_ID).checked) {
                t_PaperCount = parseInt(t_PaperCount) + 1;
            }
            ...
            /**/
            if (t_PaperCount == 1) {
                t_SubTotal = t_PerPaperFee * 1;
            } else if (t_PaperCount == 2) {
                t_SubTotal = t_PerPaperFee * 2;
            } else if (t_PaperCount == 3) {
                t_SubTotal = t_PerPaperFee * 3;
            } else if (t_PaperCount > 3) {
                t_SubTotal = t_PerPaperFee * 4;
            } else { t_SubTotal = t_PerPaperFee * 0; }
            
            //t_ExamFee = '500.00';
            //alert('Exam Fee ' + t_ExamFee);
            document.getElementById("ContentPlaceHolder1_DataGridView_lblExamFee_" + p_ID).value = t_ExamFee;
            t_TotalAmt = parseInt(t_SubTotal) + parseInt(t_ExamFee) + parseInt(t_OtherCharge) + parseInt(t_LateFee) + parseInt(t_PortalFee);
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading">Semester Form Fill-up List</h2>
                </div>
            </div>
            <%---Start of Filter----%>
            <div class="row" style="">
                    ...
                    <div class="box-body box-body-open">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" InitialValue="0" ControlToValidate="ddlProgram" Display="Dynamic"
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlSemester" runat="server" CssClass="form-control">
                                    <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                    <asp:ListItem Value="Semester 1" Text="1SEM"></asp:ListItem>
                                </asp:DropDownList>
                    ...
                    <div id="divDetails" runat="server"></div>
                        ...
                        <div class="box-body box-body-open">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow-y: auto;">
                                        <asp:GridView ID="DataGridView" runat="server" Width="98%" OnPreRender="DataGridView_PreRender"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Last Exam Session" HeaderText="Last Exam Session" />
                                                <%--<asp:BoundField DataField="seq" HeaderText="No. of Attempts" />--%>

                                                <asp:TemplateField HeaderText="Subject 1">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkA1" runat="server" Enabled="false" onclick="return fnCalExamFee(this);" Text='<%#Eval("Subject1") %>'/>
                                                ...
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkA2" runat="server" Enabled="false" onclick="return fnCalExamFee(this);" Text='<%#Eval("Subject2") %>' style="white-space:nowrap;"/>
                                                ...
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkA3" runat="server" Enabled="false" onclick="return fnCalExamFee(this);" Text='<%#Eval("Subject3") %>'/>
                                                ...
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkA4" runat="server" Enabled="false" onclick="return fnCalExamFee(this);" Text='<%#Eval("Subject4") %>'/>
                                                        <%--<asp:Label ID="lblA4" runat="server" Text='<%#Eval("A4") %>'></asp:Label>--%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Subject 5" >
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkA5" runat="server" Enabled="false" onclick="return fnCalExamFee(this);" Text='<%#Eval("Subject5") %>'/>
                                                        <%--<asp:Label ID="lblA4" runat="server" Text='<%#Eval("A4") %>'></asp:Label>--%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Subject 6" >
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkA6" runat="server" Enabled="false" onclick="return fnCalExamFee(this);" Text='<%#Eval("Subject6") %>'/>
                                                        <%--<asp:Label ID="lblA4" runat="server" Text='<%#Eval("A4") %>'></asp:Label>--%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>  
                                                <asp:TemplateField HeaderText="Subject 7" >
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="chkA7" runat="server" Enabled="false" onclick="return fnCalExamFee(this);" Text='<%#Eval("Subject7") %>'/>
                                                        <%--<asp:Label ID="lblA4" runat="server" Text='<%#Eval("A4") %>'></asp:Label>--%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>  
                                                <asp:TemplateField HeaderText="Paper Count">
                                                <ItemTemplate>
                                                        <asp:TextBox ID="lblPaperCount" runat="server" Text='<%#Eval("PaperCount") %>' Width="50px" onkeydown="return false;" onkeyup="return false;" style="border:none;"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>                                            
                                                <asp:TemplateField HeaderText="Exam Fees">
                                                <ItemTemplate>
                                                        <asp:TextBox ID="lblExamFee" runat="server" Text='<%#Eval("ExamFees") %>' Width="50px" onkeydown="return false;" onkeyup="return false;" style="border:none"></asp:TextBox>
                                                </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Portal Fee" Visible="false">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Total Amount">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="lbltotalamt" runat="server" Text='<%#Eval("TotalAmount") %>' Width="55px" onkeydown="return false;" onkeyup="return false;" style="border:none"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                            ...
                            <div id="DivAmt" class="col-lg-12 text-center">
                                <span class="btn btn-success btn-lg">Total Payable Amount:
                            <label id="tamt"></label>
                                </span>
                            </div>
