<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acknowledgement.aspx.cs" Inherits="CitizenPortal.WebApp.Examination.Acknowledgement" %>
            ...
            <div id="divPrint" style="margin: 0 auto; width: 100%;">
                <div style="width: 850px; margin: 0 auto; height: auto; border: 3px solid #000; padding: 1px; font-family: Arial">
                    ...
                    <div style="text-align: center; font-size: 20px; font-weight: bolder; padding: 5px; background-color: #808080; color: #fff;">
                        <span style="font-size: 20px">Acknowledgement for Semester Form Fill-up</span>
                    </div>
                    ...
                    <div style="margin: 10px 0; width: 100%; height: auto; font-size: 13px;">
                                ...
                                <td style="vertical-align: top;">
                                    <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; margin: 0;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 3px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left; white-space: nowrap">
                        ...
                        <table cellpadding="0" cellspacing="0" width="600" style="margin: 0 auto; width: 98%;" id="Regular" runat="server">
                            <tr>
                                <td style="padding: 5px; border: 1px solid #999; color: #fff; font-size: 14px; text-align: left; background-color: #383E4B; border-bottom: none;"><b>Regular Subject Details</b></td>
                            </tr>
                            <tr style="">
                                    ...
                                    <asp:GridView ID="GridViewSubject" runat="server" Width="100%" AutoGenerateColumns="false" CssClass="table table-striped table-bordered">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="ExamYear">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblExamYear0" runat="server" Text='<%#Eval("ExamYear") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="RollNo" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRollNo0" runat="server" Text='<%#Eval("RollNo") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                        ...
                        <br />
                        <table cellpadding="0" cellspacing="0" width="600" style="margin: 0 auto; width: 98%;" id="Backlog" runat="server">
                            <tr>
                                <td style="padding: 5px; border: 1px solid #999; color: #fff; font-size: 14px; text-align: left; background-color: #383E4B; border-bottom: none;"><b>Backlog Subject Details</b></td>
                            </tr>
                            <tr style="">
                                <td style="padding: 5px; border: 1px solid #999; text-align: left; white-space: nowrap">
                                    <asp:GridView ID="grdBacklog" runat="server" Width="100%" AutoGenerateColumns="false" CssClass="table table-striped table-bordered">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Sl.">
                                                <ItemTemplate>
                                                    <%# Container.DataItemIndex + 1 %>
                                                    <asp:HiddenField ID="HdfAppID0" runat="server" Value='<%#Eval("RowID")%>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Semester">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSemester0" runat="server" Text='<%#Eval("Semester") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Subject Type" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSubjectType0" runat="server" Text='<%#Eval("SubjectType") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Subject Code" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSubjectCode0" runat="server" Text='<%#Eval("SubjectCode") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Subject Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSubjectName0" runat="server" Text='<%#Eval("SubjectName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="ExamYear">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblExamYear1" runat="server" Text='<%#Eval("ExamYear") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Exam Type">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblExamType0" runat="server" Text='<%#Eval("ExamType") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="RollNo" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRollNo1" runat="server" Text='<%#Eval("RollNo") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="EnrollmentNo" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblEnrollmentNo0" runat="server" Text='<%#Eval("EnrollmentNo") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                        ...
                        <br />
                        <table cellpadding="0" cellspacing="0" width="600" style="margin: 0 auto; width: 98%;" id="Aggregate" runat="server">
                            <tr>
                                <td style="padding: 5px; border: 1px solid #999; color: #fff; font-size: 14px; text-align: left; background-color: #383E4B; border-bottom: none;"><b>Aggregate Fail Subject Details</b></td>
                            </tr>
                            <tr style="">
                                <td style="padding: 5px; border: 1px solid #999; text-align: left; white-space: nowrap">
                                    <asp:GridView ID="grdAgg" runat="server" Width="100%" AutoGenerateColumns="false" CssClass="table table-striped table-bordered">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Sl.">
                                                <ItemTemplate>
                                                    <%# Container.DataItemIndex + 1 %>
                                                    <asp:HiddenField ID="HdfAppID1" runat="server" Value='<%#Eval("RowID")%>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Semester">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSemester1" runat="server" Text='<%#Eval("Semester") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <%--<asp:TemplateField HeaderText="Theory" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Subject Type" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSubjectType1" runat="server" Text='<%#Eval("SubjectType") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Subject Code" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSubjectCode1" runat="server" Text='<%#Eval("SubjectCode") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Subject Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSubjectName1" runat="server" Text='<%#Eval("SubjectName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="ExamYear">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblExamYear2" runat="server" Text='<%#Eval("ExamYear") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Exam Type">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblExamType1" runat="server" Text='<%#Eval("ExamType") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="RollNo" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRollNo2" runat="server" Text='<%#Eval("RollNo") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="EnrollmentNo" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblEnrollmentNo1" runat="server" Text='<%#Eval("EnrollmentNo") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                        ...
                        <table cellpadding="0" cellspacing="0" width="600" style="margin: 0 auto; width: 98%;" id="Table1" runat="server">
                            <tr>
                                <td style="padding: 5px; border: 1px solid #999; color: #fff; font-size: 14px; text-align: left; background-color: #383E4B; border-bottom: none;"><b>Subject Selection Details</b></td>
                            ...
                            <tr style="">
                                <td style="padding: 5px; border: 1px solid #999; text-align: left; white-space: nowrap">
                                    <table cellpadding="5" cellspacing="0" class="table table-striped table-bordered" style="width: 25%; margin: 0;">
