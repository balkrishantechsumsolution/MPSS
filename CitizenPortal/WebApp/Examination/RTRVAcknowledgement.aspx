<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RTRVAcknowledgement.aspx.cs" Inherits="CitizenPortal.WebApp.Examination.RTRVAcknowledgement" %>
            ...
            <div id="divPrint" style="margin: 0 auto; width: 100%;">
                <div style="width: 850px; margin: 0 auto; height: auto; border: 3px solid #000; padding: 1px; font-family: Arial">
                    ...
                    <div style="text-align: center; font-size: 20px; font-weight: bolder; padding: 5px; background-color: #808080; color: #fff;">
                        <asp:Label ID="lblAppName" style="font-size: 20px" runat="server" Text="Acknowledgement for RTRV"></asp:Label>
                    </div>
                    ...
                    <div style="margin: 10px 0; width: 100%; height: auto; font-size: 13px;">
                        ...
                        <table cellpadding="0" cellspacing="0" width="600" style="margin: 0 auto; width: 98%;" id="Regular" runat="server">
                            <tr>
                                <td style="padding: 5px; border: 1px solid #999; color: #fff; font-size: 14px; text-align: left; background-color: #383E4B; border-bottom: none;"><b>Subject Details</b></td>
                            </tr>
                            <tr style="">
                                <td style="padding: 5px; border: 1px solid #999; text-align: left;">
                                    <asp:GridView ID="GridViewSubject" runat="server" Width="100%" CssClass="table table-striped table-bordered">                                       
                                    </asp:GridView>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table cellpadding="0" cellspacing="0" width="600" style="margin: 0 auto; width: 98%;" id="Table1" runat="server">
                            <tr>
                                <td style="padding: 5px; border: 1px solid #999; color: #fff; font-size: 14px; text-align: left; background-color: #383E4B; border-bottom: none;"><b>Selected Subject Count</b></td>
                                ...
                                <td style="padding: 5px; border: 1px solid #999; text-align: left; white-space: nowrap">
                                    <table cellpadding="5" cellspacing="0" class="table table-striped table-bordered" style="width: 100%; margin: 0;">
                                        <tr style="font-weight: bold;">
                                            <td style="padding: 5px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left;vertical-align:middle">Particulars</td>
                                            <td style="padding: 5px; border: 1px solid #ccc; color: #383E4B; text-align: center;">Select Subject</td>
                                        </tr>
