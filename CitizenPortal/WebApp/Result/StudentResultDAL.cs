...
namespace CitizenPortalLib.DAL
{
    internal class StudentResultDAL : DALBase
    {
        ...
        internal DataSet ResultStudent(string rollNo, string semester, string examType, string examYear)
        {
            ...
            {
                DbCommand selectCommand;
                selectCommand = m_DataBase.GetStoredProcCommand("GetStudentResultDetails");
                selectCommand.CommandTimeout = m_TimeOut;
                m_DataBase.AddInParameter(selectCommand, "@RollNo", DbType.AnsiString, rollNo);
                m_DataBase.AddInParameter(selectCommand, "@Semester", DbType.AnsiString, semester);
                m_DataBase.AddInParameter(selectCommand, "@ExamYear", DbType.AnsiString, examYear);
        ...
        internal DataSet GetAttendentSheetDetails(string m_coursecode, string m_CollegeCode, string m_Semester, string m_ExamType, string m_ExamYear,  string Range, string m_RollNo,string nextset, string m_program)
        {
            DataSet oDataTable = new DataSet();
            IDataReader Reader = null;
            m_DataBase = Factory.Create(this.ConnectionString);
            ...
            try
            {
                ...
                m_DataBase.AddInParameter(selectCommand, "@ProgramCode", DbType.AnsiString, m_program);
        ...
        internal DataSet GetTotalSemestersObtSP_Transcript(string m_RollNo,string m_semester)
        {
            DataSet oDataTable = new DataSet();
            IDataReader Reader = null;
            m_DataBase = Factory.Create(this.ConnectionString);
            ...
            {
                DbCommand selectCommand;
                selectCommand = m_DataBase.GetStoredProcCommand("GetTotalSemestersObtSP_Transcript");
                selectCommand.CommandTimeout = m_TimeOut;
                m_DataBase.AddInParameter(selectCommand, "@rollno", DbType.AnsiString, m_RollNo);
                m_DataBase.AddInParameter(selectCommand, "@Semester", DbType.AnsiString, m_semester);
                // selectCommand.CommandTimeout = m_TimeOut;
        ...
        internal DataSet GetStudentDetailsBulk(string m_coursecode, string m_CollegeCode, string m_Semester, string m_ExamType, string m_ExamYear, string Range, string m_RollNo, string nextset)
        {
            DataSet oDataTable = new DataSet();
            IDataReader Reader = null;
            m_DataBase = Factory.Create(this.ConnectionString);
            ...
            {
                DbCommand selectCommand;
                selectCommand = m_DataBase.GetStoredProcCommand("GetStudentDetailsEligibleTR_MarksheetSP");
                m_DataBase.AddInParameter(selectCommand, "@CourseCode", DbType.AnsiString, m_coursecode);
                m_DataBase.AddInParameter(selectCommand, "@CollegeCode", DbType.AnsiString, m_CollegeCode);
                m_DataBase.AddInParameter(selectCommand, "@Semester", DbType.AnsiString, m_Semester);
                m_DataBase.AddInParameter(selectCommand, "@ExamYear", DbType.AnsiString, m_ExamType);
        ...
        internal DataSet GetQRCode(string m_RollNo, string m_Semester, string m_ExamType, string m_ExamYear)
        {
            ...
            try
            {
                ...
                Reader = m_DataBase.ExecuteReader(selectCommand);
                if (Reader != null)
                    oDataTable.Load(Reader, LoadOption.OverwriteChanges, new string[] { "StudentResult" , "SubjectMark"});
                return oDataTable;
            }
            finally
            {
        ...
        internal DataSet GetTrAggData(string m_RollNo, string m_semester, string m_ExamType,string m_ExamYear)
        {
            DataSet oDataTable = new DataSet();
            IDataReader Reader = null;
            m_DataBase = Factory.Create(this.ConnectionString);
            ...
            {
                DbCommand selectCommand;
                selectCommand = m_DataBase.GetStoredProcCommand("TRAggregateDetails");
                m_DataBase.AddInParameter(selectCommand, "@rollno", DbType.AnsiString, m_RollNo);
                m_DataBase.AddInParameter(selectCommand, "@Semester", DbType.AnsiString, m_semester);
                m_DataBase.AddInParameter(selectCommand, "@Examtype", DbType.AnsiString, m_ExamType);
                m_DataBase.AddInParameter(selectCommand, "@ExamYear", DbType.AnsiString, m_ExamYear);
        ...
        internal DataSet GetTranscriptData(string m_RollNo, string m_Semester, string m_ExamType, string m_ExamYear)
        {
            DataSet oDataTable = new DataSet();
            IDataReader Reader = null;
            m_DataBase = Factory.Create(this.ConnectionString);
            ...
            {
                DbCommand selectCommand;
                selectCommand = m_DataBase.GetStoredProcCommand("Get_TranscriptDetails");
                m_DataBase.AddInParameter(selectCommand, "@rollno", DbType.AnsiString, m_RollNo);
                m_DataBase.AddInParameter(selectCommand, "@Semester", DbType.AnsiString, m_Semester);
                m_DataBase.AddInParameter(selectCommand, "@ExamYear", DbType.AnsiString, m_ExamYear);
                m_DataBase.AddInParameter(selectCommand, "@ExamType", DbType.AnsiString, m_ExamType);
        ...
        internal DataSet GetResultDataTranscript(string m_RollNo, string m_Semester, string m_ExamType, string m_ExamYear)
        {
            DataSet oDataTable = new DataSet();
            IDataReader Reader = null;
            m_DataBase = Factory.Create(this.ConnectionString);
            ...
            {
                DbCommand selectCommand;
                selectCommand = m_DataBase.GetStoredProcCommand("GetResultData_Transcript");
                m_DataBase.AddInParameter(selectCommand, "@rollno", DbType.AnsiString, m_RollNo);
                m_DataBase.AddInParameter(selectCommand, "@Semester", DbType.AnsiString, m_Semester);
                m_DataBase.AddInParameter(selectCommand, "@ExamYear", DbType.AnsiString, m_ExamType);
                m_DataBase.AddInParameter(selectCommand, "@ExamType", DbType.AnsiString, m_ExamYear);
