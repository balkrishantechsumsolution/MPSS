<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintMarksheet.aspx.cs" Inherits="CitizenPortal.WebApp.Result.PrintMarksheet" %>
...
<head runat="server">
    <title>Bulk Mark Sheet Printing</title>
            ...
            <div class="row">
                <div class="col-md-12 box-container mTop15">
                    <div class="box-heading">
                        <h4 class="box-title" style="text-align: center;">Download Marksheet in Bulk</h4>
                    </div>
                                            ...
                                            <asp:DataList ID="grdAttendanceSheet" runat="server" Width="805px" RepeatColumns="1" RepeatDirection="Horizontal" OnItemDataBound="grdAttendanceSheet_ItemDataBound">
                                                <ItemTemplate>
                                                    <div style="margin: 0 auto; width: 800px /* margin-left: 212px; */; margin-top: -10px;">
                                                        <asp:Label runat="server" ID="Sno" Style="float: right; margin-right: 13px; font-weight: 600; margin-right: 100px;"></asp:Label>
                                                        <div style="margin: 0 auto 50px; width: 794px; min-height: 158px; height: 100%; position: relative; border: none; padding: 1px; font-family: Arial, Helvetica, sans-serif;">
                                                        </div>
                                                        ...
                                                        <table style="width: 100%; font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin-top: -75px;" cell-padding="0" cell-spacing="0">
                                                            <tr>
                                                                <td style="text-align: right">
                                                                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("ExamYear").ToString() %>' Style="font-weight: bold; font-size: 15px"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <table style="width: 100%; font-family: Arial, Helvetica, sans-serif; font-size: 11px;" cell-padding="0" cell-spacing="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: center;height: 68px;" rowspan="5">
                                                                                <div style="margin-left: -34px; font-size: 1.8px; color: #000000; font-weight: bold; letter-spacing: 0px; position: absolute; -ms-transform: rotate(90deg); transform: rotate(90deg);">
                                                                                    CSVTU CSVTU CSVTU CSVTU CSVTU CSVTU CSVTU CSVTU CSVTU CSVTU CSVTU
                                                                                </div>
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                <td style="vertical-align: top; padding-bottom: 36px; border-collapse: separate;">
                                                                    <div style="margin-top: 10px; display: block; vertical-align: top; height: 300px">
                                                                        <asp:GridView runat="server" ID="GrdRslt" AutoGenerateColumns="false" Font-Bold="true"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundField DataField="SubjectName" HeaderText="Code" ItemStyle-Width="245px"></asp:BoundField>
                                                                                <asp:BoundField DataField="maxese" HeaderText="MAX" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="38px"></asp:BoundField>
                                                                                <asp:BoundField DataField="maxesetimes" HeaderText="OBT" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="25px"></asp:BoundField>
                                                                                <asp:BoundField DataField="maxct" HeaderText="MAX" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="25px"></asp:BoundField>
                                                                                <asp:BoundField DataField="max_ctobt" HeaderText="OBT" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="25px"></asp:BoundField>
                                                                                <asp:BoundField DataField="maxta" HeaderText="MAX" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="30px"></asp:BoundField>
                                                                                <asp:BoundField DataField="max_taobt" HeaderText="OBT" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="28px"></asp:BoundField>
                                                                                <asp:BoundField DataField="total" HeaderText="MAX" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="40px"></asp:BoundField>
                                                                                <asp:BoundField DataField="totalobt" HeaderText="OBT" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="35px"></asp:BoundField>
                                                                                ...
                                                                                <asp:BoundField DataField="LetterGrade" HeaderText="Letter Grade" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="30px">
                                                                                    <%--<ItemStyle HorizontalAlign="Center" />--%>
                                                                                </asp:BoundField>

                                                                                <asp:BoundField DataField="gradepoint" HeaderText="Grade Point" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="30px"></asp:BoundField>
                                                                                <asp:BoundField DataField="CreditPoint" HeaderText="Credit Point" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="70px"></asp:BoundField>
                                                                            </Columns>
                                                                        </asp:GridView>
                                                                    </div>
                                                                </td>
                                                                            ...
                                                                            <td style="width: 150px; height: 27px;">
                                                                                <div>
                                                                                    Result : <b style="font-family: Arial, Helvetica, sans-serif;">
                                                                                        <asp:Label ID="lblResult" runat="server" Style="text-transform: uppercase;"></asp:Label>
                                                                                    </b>
                                                                                </div>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td style="vertical-align: top">
                                                                                <table style="border: 1px solid black; border-collapse: collapse; font-size: 12px;" cell-padding="5">
                                                                                    <tr>
                                                                                        <td colspan="2" style="text-align: center; padding: 5px 10px; border: 1px solid black;">Grace Marks
                                                                                        </td>
                                                                                        <td colspan="2" style="text-align: center; padding: 5px 10px; border: 1px solid black;">Semester Total of Marks
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="text-align: center; border: 1px solid black; padding: 5px 10px; border-collapse: collapse;">Subject Code
                                                                                        </td>
                                                                                        <td style="text-align: center; border: 1px solid black; padding: 5px 10px; border-collapse: collapse;">Subject Code
                                                                                        </td>
                                                                                        <td style="text-align: center; border: 1px solid black; padding: 5px 10px; border-collapse: collapse;">Maximum
                                                                                        </td>
                                                                                        <td style="text-align: center; border: 1px solid black; padding: 5px 10px; border-collapse: collapse;">Obtained
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="text-align: center; border: 1px solid black; padding: 5px 10px; border-collapse: collapse;">
                                                                                            <b>
                                                                                        ...
                                                                                        <td style="font-family: Arial, Helvetica, sans-serif; text-align: center; padding: 5px 10px; border: 1px solid black; border-collapse: collapse;">
                                                                                            <b>
                                                                                ...
                                                                                <asp:Panel ID="pnltotal" runat="server">
                                                                                    <table runat="server" id="totalsems" style="border: 1px solid black; border-collapse: collapse; font-size: 12px;" cell-padding="5">
                                                                                        <tr style="border: 1px solid black; border-collapse: collapse; text-align: center;">
                                                                                            <td style="border: 1px solid black; padding: 5px; border-collapse: collapse;">SEM
                                                                                            </td>
                                                                                            <td style="border: 1px solid black; padding: 5px; border-collapse: collapse;">1
                                                                                            </td>
                                                                                            <td style="border: 1px solid black; padding: 5px; border-collapse: collapse;">2
                                                                                            </td>
                                                                                            <td style="border: 1px solid black; padding: 5px; border-collapse: collapse;">3
                                                                                            </td>
                                                                                            <td style="border: 1px solid black; padding: 5px; border-collapse: collapse;">4
                                                                                            </td>
                                                                                            <td style="border: 1px solid black; padding: 5px; border-collapse: collapse;">5
                                                                                            </td>
                                                                                            <td style="border: 1px solid black; padding: 5px; border-collapse: collapse;">6
                                                                                            </td>
                                                                                            <td style="border: 1px solid black; padding: 5px; border-collapse: collapse;">7
                                                                                            </td>
                                                                                            <td style="border: 1px solid black; padding: 5px; border-collapse: collapse;">Final
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr style="border: 1px solid black; padding: 5px; border-collapse: collapse; text-align: center;">
                                                                                            <td style="border: 1px solid black; padding: 5px; border-collapse: collapse;">MARKS
                                                                                            </td>
                                                                                            <td style="font-family: Arial, Helvetica, sans-serif; border: 1px solid black; padding: 5px; border-collapse: collapse;">
                                                                                                <b>
                                                                                        ...
                                                                                        <tr style="border: 1px solid black; border-collapse: collapse; text-align: center;">
                                                                                            <td style="border: 1px solid black; padding: 5px; border-collapse: collapse;">OUT OF
                                                                                            </td>
                                                                                            <td style="font-family: Arial, Helvetica, sans-serif; border: 1px solid black; padding: 5px; border-collapse: collapse;">
                                                                                                <b>
                                                                            ...
                                                                            <td style="text-align: center; vertical-align: bottom; width: 150px">
                                                                                <div style="margin: 0 auto; height: 110px; width: 110px; position: relative; left: 15px">
                                                    ...
                                                    <p style="page-break-before: always; padding: 0; margin: 0"></p>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:DataList>
                                            <br />
