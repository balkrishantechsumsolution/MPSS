<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentResultData.aspx.cs" Inherits="CitizenPortal.WebApp.Result.StudentResultData" %>
            ...
            <div id="page-wrapper" style="min-height: 500px !important;">
                ...
                <div class="row" style="">
                    <div class="col-md-12 box-container">
                        ...
                        <div class="box-heading">
                            <h4 class="box-title">Semester Exam Details
                            </h4>
                        </div>
                        <div class="box-body box-body-open">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow-y: auto;">
                                <div class="form-group">
                                    <asp:GridView ID="grdResult" runat="server" Width="100%" CssClass="table table-striped table-bordered" OnRowDataBound="grdResult_RowDataBound">                                        
                                    </asp:GridView>
                                </div>
                            </div>
