...
namespace CitizenPortal.WebApp.Entrance.Admin
{
    public partial class PhDAction : System.Web.UI.Page
    {
        ...
        protected void btnApproved_Click(object sender, EventArgs e)
        {
            ...
            t_Result = m_WorkFlowBLL.PhDAdminAction(m_ServiceID, m_AppID, t_ActionID, t_Remarks, Session["LoginID"].ToString(), t_IPAddress);
            ...
            if (t_Result != null && t_Result.Rows.Count > 0)
            {
                ...
                string templateId = t_Result.Rows[0]["TemplateId"].ToString();

                CommonUtility.SendEmailWithAttachment("", "", "", MailID, null, bcc, subject, Mailtext, true, null);

                if (MobileNo != "")
                    test.sendsms(MobileNo, SMSText, templateId);
