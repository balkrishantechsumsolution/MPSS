<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PhDAction.aspx.cs" Inherits="CitizenPortal.WebApp.Entrance.Admin.PhDAction" %>
                ...
                <div class="col-md-12 box-container mTop15">
                    ...
                    <div class="box-body box-body-open">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-6">
                            ...
                            <textarea runat="server" name="txtRemark" rows="2" cols="20" id="txtRemark" placeholder="Enter Remark" class="form-control" onkeyup="javascript:Count(this);" onchange="javascript:Count(this);"></textarea>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                            ...
                            <div class="text-left">
                                <asp:Button ID="btnApproved" runat="server" Text="Approved" CssClass="btn btn-outline btn-danger" OnClick="btnApproved_Click" ValidationGroup="G"/>
