<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="PGPhdProcessbar.aspx.cs" Inherits="CitizenPortal.WebApp.Entrance.PhD.PGPhdProcessbar" %>
            ...
            <div id="divPrint" class="container mtop10 hldshdw" style="padding-right: 0; padding-left: 0; width: 99%;">
                ...
                <div class="wizard_inston text-left">
                    ...
                    <p style="margin-top:10px;">
                        ...
                        3. Make payment against the Application Number.<br />
                        &nbsp;&nbsp;&nbsp; 
                        Payment can be done through Online (Payment Gateway)
                        <br />
                        4. Check your Application status after login through your Login ID (detailed SMS and email)
                        Login ID : <asp:Label ID="lblLoginId" runat="server" Font-Bold="True" Font-Size="20px"></asp:Label><br />
                        Pasword : <asp:Label ID="lblPasword" runat="server" Font-Bold="True" Font-Size="20px"></asp:Label><br />
                    </p>
                </div>
                ...
                <div class="col-md-12 box-container" style="margin-top: 5px;">
                    <div class="box-body box-body-open" style="text-align: center;">
                        <asp:Button ID="btnSubmit" runat="server" CausesValidation="False" CssClass="btn btn-success"
                            Text="Upload Document" OnClick="btnSubmit_Click" />
