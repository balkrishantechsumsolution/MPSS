<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Citizen/Master/Citizen.Master" AutoEventWireup="true" CodeBehind="Provisional.aspx.cs" Inherits="CitizenPortal.WebApp.Provisional.Provisional" %>
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>Application for Provisional Certificate</h2>
                </div>
            </div>
            ...
            <div class="" style="">
                            ...
                            <div class="box-body box-body-open">
                                ...
                                <div class="clearfix"></div>
                                    ...
                                    <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                                        <div class="form-group">
                                            <label style="font-size:33px;color:maroon"><i class="fa fa-info"></i></label>                                            
                                        </div>
                                    </div>
                                ...
                                <div class="clearfix"></div>
                                    <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                                        <div class="form-group">
                                            <label style="font-size:33px;color:maroon"><i class="fa fa-edit"></i></label>
                                        </div>
                                    </div>
                                    <div class="col-xs-11 col-sm-11 col-md-11 col-lg-11">
                                        <div class="form-group">                                            
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 box-container" id="Div3">
                        <div class="box-heading">
                            <h4 class="box-title register-num">Provisional Fees Details
                            </h4>
                        </div>
