<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EnrollmentSteps.ascx.cs" Inherits="CitizenPortal.WebApp.Control.EnrollmentSteps" %>
<style>
    .custom-breadcrumb {
        list-style: none;
        overflow: hidden;
    ...
    <ul class="custom-breadcrumb">
        ...
        <li id="liDP" class="gray-crumb">
            ...
            <div style="float: right; margin: 7px 0px">
                ...
                <span class="stepsubheading">Online Payment of Enrollment fee</span>
            </div>
        </li>
