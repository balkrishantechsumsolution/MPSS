<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewLeftPanel.ascx.cs" Inherits="CitizenPortal.WebApp.Control.NewLeftPanel" %>
<link href="../Common/Styles/style.admin.css" rel="stylesheet" />
<script src="/PortalScripts/Wallet.js" type="text/javascript"></script>
<style type="text/css">
    .navbar-brand > img {
        width: 188px;
        margin-top: -13px;
...
<div class="navbar-default-gray sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse leftpnlbg_grey pleft0" runat="server" ng-app="appmoduleWallet" style="padding: 0;">
