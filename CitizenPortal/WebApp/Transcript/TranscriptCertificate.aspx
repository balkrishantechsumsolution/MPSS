<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TranscriptCertificate.aspx.cs" Inherits="CitizenPortal.WebApp.Transcript.TranscriptCertificate" %>
                                                        ...
                                                        <table style="height:300px; width: 100%; text-align: justify; font-family: 'Monotype Corsiva'; font-size: 25px;">
                                                            <tr>
                                                                <td style="text-align: justify;">
                                                                    ...
                                                                    &nbsp;as Cumulative Performance Index (CPI).
                                                                    <br />
                                                                    <br />
