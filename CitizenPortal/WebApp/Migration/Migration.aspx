<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Citizen/Master/Citizen.Master" AutoEventWireup="true" CodeBehind="Migration.aspx.cs" Inherits="CitizenPortal.WebApp.Migration.Migration" %>
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>Application for Migration Certificate</h2>
                </div>
            </div>
            ...
            <div class="" style="">
                    ...
                    <div class="col-md-9 p0">
                        <div class="col-md-12 box-container">
                            ...
                            <div class="box-body box-body-open">
                                ...
                                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-2" style="display: none">
                                    <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input id="DOB" class="form-control" placeholder="DOB" name="DOB" value="" onkeypress="return ValidateAlpha(event);" maxlength="10" />
                                ...
                                <div class="col-xs-12 col-sm-5 col-md-4 col-lg-3" style="display: none">
                                    <div class="form-group">
                                        <label class="manadatory" for="txtStudentEng">
                                ...
                                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
                                    <div class="form-group">
                                        <label class="manadatory" for="txtTCNo">
                                            Transfer Certificate No.
                                        </label>
                                        <input id="txtTCNo" class="form-control" placeholder="TC No." name="TC No." value="" />

                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
                                    <div class="form-group">
                                        <label class="manadatory" for="txtTCDate">
                                            TC Issue Date 
                                        </label>
                                        <input id="txtTCDate" class="form-control" placeholder="TC Date" name="TCDate" value="" maxlength="10" />
                ...
                <div id="divAddress" class="row" style="display: none">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 box-container mTop15">
                        ...
                        <div class="box-body box-body-open">
                            ...
                            <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
                                <div class="form-group">
                                    <label class="manadatory" for="ddlCertificate">
                                        Certificate Type</label>
                                    <select class="form-control" data-val="true" data-val-number="CertificateType" data-val-required="Please select Certificate Type." id="ddlCertificate" name="Certificate" style="">
                                        <option value="0">Select</option>
                ...
                <div class="row">
                    <div class="col-md-4 box-container" id="Div3">
                        <div class="box-heading">
                            <h4 class="box-title register-num">Migration Fees Details
                            </h4>
                        </div>
                    ...
                    <div class="col-md-8 box-container" id="Div2">
                        <div class="box-heading">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td rowspan="2">
                                                    <span class="pull-right" style="color: #000; padding-right: 50px;">
                                                        <span id="lblApplicant" style="text-transform: uppercase; float: right; color: #000; font-weight: bold;"></span>
                                                        <br />
