<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnrollmentAcknowledgement.aspx.cs" Inherits="CitizenPortal.WebApp.Enrollment.EnrollmentAcknowledgement" %>
                        ...
                        <table style="width: 98%; margin: 0 auto; font-size: 16px">
                            ...
                            <tr>
                                <td style="text-align: center">
                                    <asp:Label ID="lblEnrollment" runat="server" Visible="false" ></asp:Label></td>
                                <td style="text-align: center"></td>
                                <td style="text-align: center">&nbsp;</td>
                                <td style="text-align: center"></td>
