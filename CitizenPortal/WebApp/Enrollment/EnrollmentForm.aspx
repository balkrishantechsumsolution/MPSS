<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="EnrollmentForm.aspx.cs" Inherits="CitizenPortal.WebApp.Enrollment.EnrollmentForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="EnrollmentForm.js?v=<%=CitizenPortal.Common.GlobalValues.JSVersion%>"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="page-wrapper" class="container-fluid home-contentbox" style="min-height: 500px !important;">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="form-heading mtop5"><i class="fa fa-pencil-square-o fa-fw pright10"></i>Enrollment Form for Prat Time Diploma Student into CSVTU </h2>
            </div>
        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <select name="" id="ddlEntryType" class="form-control" disabled="disabled">
                                    ...
                                    <option value="3" selected="selected">UTD Student</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div id="divQuota" class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" data-val="true" data-val-number="Quota" data-val-required="Please select Admitted Quota" id="ddlQuota" name="Quota">
                                    ...
                                    <option value="15" selected="selected">UTD</option>
                    ...
                    <div class="box-body box-body-open">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="FatherName" class="form-control" placeholder="Father's/Husband Name" name="" onchange="return checkLength(this);" onkeypress="return ValidateAlpha(event);" type="text" autofocus="" maxlength="100" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-5 col-md-4 col-lg-4">
                            <div class="form-group">
        ...
        <div class="row">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr id="trClassX">
                                <td style="text-align: center">
                                    <input name="" type="checkbox" id="chkClassX" /></td>
            ...
            <div class="col-md-6 box-container" id="divMark">
                <div class="box-heading">
