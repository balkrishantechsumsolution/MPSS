<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="EditEnrollmentForm.aspx.cs" Inherits="CitizenPortal.WebApp.Enrollment.EditEnrollmentForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="EditEnrollmentForm.js?v=<%=CitizenPortal.Common.GlobalValues.JSVersion%>"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="page-wrapper" class="container-fluid home-contentbox" style="min-height: 500px !important;">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="form-heading mtop5"><i class="fa fa-pencil-square-o fa-fw pright10"></i> Edit Enrollment Form </h2>
            </div>
        </div>
                    ...
                    <div class="box-body box-body-open">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <select name="" id="ddlEntryType" class="form-control" >
                                    <option value="0">-Select-</option>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                            <div class="form-group">
                                <label class="manadatory" for="ddlLateral">Is Lateral</label>
                                <select name="" id="ddlLateral" class="form-control" >
                                    <option value="0">-Select-</option>
                        ...
                        <div id="divQuota" class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" data-val="true" data-val-number="Quota" data-val-required="Please select Admitted Quota" id="ddlQuota" name="Quota">
                                    ...
                                    <option value="10">P.I.O.(person of India origin) Quota</option>
                                    <option value="11">Sponsored quota (MTech)</option>
                                    <option value="12">PhD</option>
                                    <option value="13">University transfer</option>
                                    <option value="14">j&k quota</option>
                                    <option value="15">UTD</option>
                        ...
                        <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                <input id="DOA" class="form-control" placeholder="Date of Admission" name="DOA" maxlength="10" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                            <div class="form-group">
                                <label class="" for="ddlExam">Exam Type</label>
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-3 col-lg-3">
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-4 col-lg-3">
                            <div class="form-group">
                                ...
                                <input id="txtDomicileDate" class="form-control" placeholder="Certificate Issue Date" name="txtDomicileDate" value="" maxlength="10" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-4 col-lg-3">
                            <div class="form-group">
                                ...
                                <input id="txtDomicileNo" class="form-control" placeholder="Certificate No." name="txtDomicileNo" onkeypress="return isNumberKey(event);" value="" maxlength="20" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-4 col-lg-9">
                            <div class="form-group">
                                ...
                                <input id="txtDomicileAuthority" class="form-control" placeholder="Certificate Issuing Authority" name="txtDomicileAuthority" value="" />
                            </div>
                        </div>   
                    <div class="clearfix"></div>
                </div>
                    ...
                    <div class="box-body box-body-open">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-4 col-lg-4">
                            <div class="form-group">
                                <label class="manadatory">
                                    Father's Name</label>
                                <input id="FatherName" class="form-control" placeholder="Father's Name" name="" onchange="return checkLength(this);" onkeypress="return ValidateAlpha(event);" type="text" maxlength="100" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-5 col-md-4 col-lg-4">
                            <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-4 col-lg-2">
                            <div class="form-group">
                                ...
                                <input id="txtCasteDate" class="form-control" placeholder="Certificate Issue Date" name="txtCasteDate" value="" maxlength="10" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="txtCasteNo" class="form-control" placeholder="Certificate No." name="txtCasteNo" value="" maxlength="20"  />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-4 col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="txtAuthority" class="form-control" placeholder="Certificate Issuing Authority" name="txtAuthority" value=""  />
                            </div>
                        </div>
                    </div>
                        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                    ...
                    <div class="box-body box-body-open">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input name="" type="text" id="PAddressLine1" class="form-control" placeholder="First Line Address" maxlength="40" onchange="return checkLength(this);"  />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input name="" type="text" id="txtState" class="form-control" placeholder="Enter State Name" style="display: none;" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input name="" type="text" id="txtDistrict" class="form-control" placeholder="Enter District Name" style="display: none;" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input name="" type="text" id="txtBlock" class="form-control" placeholder="Enter Block Name"  style="display: none;" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input name="" type="text" id="txtPanchayat" class="form-control" placeholder="Enter Panchayat Name" style="display: none;" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input name="" type="text" id="PPinCode" class="form-control" placeholder="PIN" maxlength="6" onkeypress="return isNumberKey(event);" />
                            </div>
                        </div>
                        <div class="clearfix">
                        </div>
                    ...
                    <div class="box-body box-body-open">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="CtxtDistrict" class="form-control" placeholder="Current District" name="Current District" value="" maxlength="30" style="display: none;" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="CtxtTaluka" class="form-control" placeholder="Current Block" name="Current Block" value="" maxlength="30" style="display: none;" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="CtxtVillage" class="form-control" placeholder="Current Panchayat" name="Current Panchayat" value="" maxlength="30" style="display: none;" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input name="" type="text" id="CPinCode" class="form-control" onchange="return PresentPinCode();" placeholder="PIN" maxlength="6" onkeypress="return isNumberKey(event);" />
                            </div>
                        </div>
                        <div class="clearfix">
                        </div>
                            ...
                            <table class="table1 table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input id="txtTotalMarks" class="form-control" placeholder="Total Marks" name="txtTotalMarks" type="text" value="" maxlength="4" onkeypress="return isNumberKeyDecimal(event); " />
                                        </td>
                                        <td>
                                            <input id="txtMarkSecure" class="form-control" placeholder="Marks Secure" name="txtMarkSecure" type="text" value="" maxlength="4" onkeypress="return isNumberKeyDecimal(event);" onchange="calculatepercentage();" />
                                        </td>
                                        <td>
        ...
        <div class="row" style="">
                        ...
                        <div class="table-responsive col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <table class="table1 table-bordered" style="width:100%;margin:auto 0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <input id="txtPhySubject" class="form-control" placeholder="Subject Name" name="txtPhySubject" type="text" value="" /></td>
                                        <td>
                                            <input id="txtPhyTotalMarks" class="form-control" placeholder="Total Marks" name="txtPhyTotalMarks" type="text" value="" maxlength="4" onkeypress="return isNumberKeyDecimal(event); " />
                                        </td>
                                        <td>
                                            <input id="txtPhyMarkSecure" class="form-control" placeholder="Marks Secure" name="txtPhyMarkSecure" type="text" value="" maxlength="4" onkeypress="return isNumberKeyDecimal(event);" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input id="txtCheSubject" class="form-control" placeholder="Subject Name" name="txtPhySubject0" type="text" value="" /></td>
                                        <td>
                                            <input id="txtCheTotalMarks" class="form-control" placeholder="Total Marks" name="txtCheTotalMarks" type="text" value="" maxlength="4" onkeypress="return isNumberKeyDecimal(event); " />
                                        </td>
                                        <td>
                                            <input id="txtCheMarkSecure" class="form-control" placeholder="Marks Secure" name="txtCheMarkSecure" type="text" value="" maxlength="4" onkeypress="return isNumberKeyDecimal(event);" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input id="txtMatSubject" class="form-control" placeholder="Subject Name" name="txtPhySubject1" type="text" value="" /></td>
                                        <td>
                                            <input id="txtMatTotalMarks" class="form-control" placeholder="Total Marks" name="txtMatTotalMarks" type="text" value="" maxlength="4" onkeypress="return isNumberKeyDecimal(event); " />
                                        </td>
                                        <td>
                                            <input id="txtMatMarkSecure" class="form-control" placeholder="Marks Secure" name="txtMatMarkSecure" type="text" value="" maxlength="4" onkeypress="return isNumberKeyDecimal(event);" />
                                        </td>
                                        <td>
            ...
            <div class="col-md-6 box-container" style="display:none">
                <div class="box-heading">
        ...
        <div id="divBtn" class="row">
            <div class="col-md-12 box-container" style="margin-top: 5px;">
                <div class="box-body box-body-open" style="text-align: center;">
                    <input type="button" id="btnSubmit" class="btn btn-success" value="Update Detail" title="Click to Update Data" onclick="SubmitData();" />
                    <input type="submit" name="" value="Cancel" id="Button1" title="Refresh the page" class="btn btn-danger" onclick="window.close();" />
        ...
        <asp:HiddenField ID="HFServiceID" runat="server" Value="1467" ClientIDMode="Static" />
		...
		<asp:HiddenField ID="hdfAppID" runat="server" ClientIDMode="Static" />
