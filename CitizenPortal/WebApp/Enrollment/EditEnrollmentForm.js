    ...
    */
    ...
    $.when(
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: '/WebApp/Enrollment/EditEnrollmentForm.aspx/UpdateEnrollmentData',
            ...
            if (AppID == "" || AppID == null) {
                ...
                if (status == "Success") {
                    $("#progressbar").hide();
                    alertPopup("Enrollment Form!", obj.message);//+ " Please Make Payment against the Application Number."
                    ...
                    window.location.href = '/WebApp/Enrollment/Acknowledgement.aspx?SvcID=1467&AppID=' + obj.AppID;
                }
...
function ValidateForm() {
    ...
    var Lateral = $("#ddlLateral")
    if (Lateral.val() == '' || Lateral.val() == '0') {
        text += "<BR>" + " \u002A" + " Please Select Is Lateral Type. ";
        Lateral.attr('style', 'border:1px solid #d03100 !important;');
        Lateral.css({ "background-color": "#fff2ee" });
        opt = 1;
    } else {
        Lateral.attr('style', 'border:1px solid #cdcdcd !important;');
        Lateral.css({ "background-color": "#ffffff" });
...
function fnFetchUserDetails(AppID) {
    ...
    $.when(
      $.ajax({
          type: "POST",
          contentType: "application/json; charset=utf-8",
          url: '/WebApp/Enrollment/EditEnrollmentForm.aspx/GetEnrollmentDetails',
          data: '{"AppID":"' + AppID + '"}',
          processData: false,
          dataType: "json",
          success: function (response) {
          ...
          error: function (a, b, c) {
           ...
           var obj = jQuery.parseJSON(data.d);
           var AppID = obj.ApplicationTB[0].AppID;
           var arr = eval(obj.ApplicationTB);
           var arrAge = eval(obj.AgeTB);
           var arrPhotograph = eval(obj.PhotographTB);
           var html = "";
           var RegdNo = arr[0].RegdNo;
           var RollNo = arr[0].RollNo
           var Name = arr[0].StudentName;
           ...
           var AdmittedQuota = arr[0].AdmittedQuota;
           $('#hdfCourseCode').val(CourseCode);
           $('#hdfProgramCode').val(ProgrammCode);
           $('hdfAppID').val(AppID);
           var Photograph = arrPhotograph[0].Photograph;
           var Signature = arrPhotograph[0].Signature;
           var DOA = arr[0].DOA;
           var EntryType = arr[0].EntryType;
           var ExamType = arr[0].ExamType;
           var Handicap = arr[0].Handicap;
           var CSVTUEnrollmentNo = arr[0].CSVTUEnrollmentNo;
           var MobileNo = arr[0].MobileNo;
           var EmailId = arr[0].EmailId;
           var BloodGroup = arr[0].BloodGroup;
           var Lateral = arr[0].IsLateral;
           var EducationGap = arr[0].EducationGap;
           var GapFromYear = arr[0].GapFromYear;
           var GapToYear = arr[0].GapToYear;
           var HasMigration = arr[0].HasMigration;
           var MigrationNo = arr[0].MigrationNo;
           var MigrationDate = arr[0].MigrationDate;
           var IsScore = arr[0].IsScore;
           var ScoreCard = arr[0].ScoreCard;

           var EntranceRollNo = arr[0].EntranceRollNo;
           var EntranceMarks = arr[0].EntranceMarks;
           var CasteCertificate = arr[0].CasteCertificate;
           var CasteCertificateNo = arr[0].CasteCertificateNo;
           var CasteCertificateDate = arr[0].CasteCertificateDate;
           var CasteIssuingAuthority = arr[0].CasteIssuingAuthority;
           var DomicileState = arr[0].DomicileState;
           var DomicileDistrict = arr[0].DomicileDistrict;
           var DomicileTehsil = arr[0].DomicileTehsil;
           var DomicileNo = arr[0].DomicileNo;
           var DomicileDate = arr[0].DomicileDate;
           var DomicleAuthority = arr[0].DomicleAuthority;

           var MarkSheetXDoc = arr[0].MarkSheetXDoc;
           var MarkSheetXIIDoc = arr[0].MarkSheetXIIDoc;
           var DiplomaCerificateDoc = arr[0].DiplomaCerificateDoc;
           var UGMarkSheetDoc = arr[0].UGMarkSheetDoc;
           var PGMarkSheetDoc = arr[0].PGMarkSheetDoc;
           var CasteCertificateDoc = arr[0].CasteCertificateDoc;
           var DomicileCertificateDoc = arr[0].DomicileCertificateDoc;
           var MigrationCertificateDoc = arr[0].MigrationCertificateDoc;
           var GapCertificateDoc = arr[0].GapCertificateDoc;
           var ScoreCardDoc = arr[0].ScoreCardDoc;
           var OtherDoc = arr[0].OtherDoc;

           var PhysicsTM = arr[0].PhysicsTM;
           var PhysicsMO = arr[0].PhysicsMO;
           var PhysicsPR = arr[0].PhysicsPR;
           var ChemistryTM = arr[0].ChemistryTM;
           var ChemistryMO = arr[0].ChemistryMO;
           var ChemistryPR = arr[0].ChemistryPR;
           var MathematicsTM = arr[0].MathematicsTM;
           var MathematicsMO = arr[0].MathematicsMO;
           var MathematicsPR = arr[0].MathematicsPR;
           var PhysicsSubject = arr[0].PhysicsSubject;
           var ChemistrySubject = arr[0].ChemistrySubject;
           var MathematicsSubject = arr[0].MathematicsSubject;

           if (CSVTUEnrollmentNo != null && CSVTUEnrollmentNo != "") {
               $('#divEnroll').show();
               $("#rbtEnrollY").prop("checked", true);
               $("#rbtEnrollN").prop("checked", false);
               $('#txtCSVTURegdNo').val(CSVTUEnrollmentNo);
           }
           else {
               $('#divEnroll').hide(); $('#txtCSVTURegdNo').val(); $("#rbtEnrollY").prop("checked", false);
               $("#rbtEnrollN").prop("checked", true);
           }
           if (CollegeCode != null && CollegeCode != "") {
               //$('#CollegeName').val(CollegeCode);
               selectByVal("CollegeName", CollegeCode);
           ...
           if (EntryType != null && EntryType != "") {
               selectByVal("ddlEntryType", EntryType);
               //$('#ddlAdmittedCategory').prop('disabled', true);

           }
           if (ExamType != null && ExamType != "") {
               selectByVal("ddlExam", ExamType);
               //$('#ddlAdmittedCategory').prop('disabled', true);

           }
           
           if (AdmittedQuota != null && AdmittedQuota != "") {
               selectByText("ddlQuota", AdmittedQuota);
               //$('#ddlAdmittedCategory').prop('disabled', true);
           }
           ...
           //if (Handicap != null && Handicap != "") {
               if (Handicap == true)
               { Handicap = "Yes"; } else { Handicap = "No"; }
               selectByVal("ddlHandicap", Handicap);
           //}
           ...
           if (Lateral != null && Lateral != "") {
               $('#ddlLateral').val(Lateral);
               //$('#ddlLateral').prop('disabled', true);
           }
           ...
           if(EducationGap == 1){              
               $("#rbtGapY").prop("checked", true);
               $("#rbtGapN").prop("checked", false);
               $('#divGap').show();
               $('#FromGap').val(GapFromYear);	
               $('#ToGap').val(GapToYear);
           }
           else {
               $("#rbtGapY").prop("checked", false);
               $("#rbtGapN").prop("checked", true);
               $('#divGap').hide();
               $('#FromGap').val();
               $('#ToGap').val();
           }
           ...
           if (HasMigration == 1) {
               $("#rbtMigrationY").prop("checked", true);
               $("#rbtMigrationN").prop("checked", false);
               $('#divMigration').show();
               $('#MigrationNo').val(MigrationNo);
               $('#MigrationIssue').val(MigrationDate);
           }
           else {
               $("#rbtMigrationY").prop("checked", false);
               $("#rbtMigrationN").prop("checked", true);
               $('#divMigration').hide();
               $('#MigrationNo').val();
               $('#MigrationIssue').val();
           }
           ...
           if (IsScore == 1) {
               $("#rbtScoureCardY").prop("checked", true);
               $("#rbtScoureCardN").prop("checked", false);
               $('#divScoureCard').show();
               $('#txtCompRollNo').val(EntranceRollNo);
               $('#txtCompName').val(ScoreCard);
               $('#txtScoreCard').val(EntranceMarks);
           }
           else {
               $("#rbtScoureCardY").prop("checked", false);
               $("#rbtScoureCardN").prop("checked", true);
               $('#divScoureCard').hide();
               $('#txtCompRollNo').val();
               $('#txtCompName').val();
               $('#txtScoreCard').val();               
           ...
           if (Category != "UR") {
               $('#lblCategory').show();
               $('#txtCasteDate').val(CasteCertificateDate);
               $('#txtCasteNo').val(CasteCertificateNo);
               $('#txtAuthority').val(CasteIssuingAuthority);              
           }
           else {
               $('#lblCategory').hide();
               $('#txtCasteDate').val();
        ...
        $('#ddlDomicileState').val(DomicileState);	
        $('#ddlDomicileDistrict').val(DomicileDistrict);
        $('#ddlDomicileTehsil').val(DomicileTehsil);	
        $('#txtDomicileNo').val(DomicileNo);
        $('#txtDomicileDate').val(DomicileDate);
        $('#txtDomicileAuthority').val(DomicleAuthority);

        GetStateDomisile(DomicileState,DomicileDistrict,DomicileTehsil);

        if (MarkSheetXDoc == "Yes")
        {$("#chkClassX").prop("checked", true);}
        if (MarkSheetXIIDoc == "Yes")
        { $("#chkClassXII").prop("checked", true); }
        if (DiplomaCerificateDoc == "Yes")
        { $("#chkDiploma").prop("checked", true); }
        if (UGMarkSheetDoc == "Yes")
        { $("#chkUG").prop("checked", true); }
        if (PGMarkSheetDoc == "Yes")
        { $("#chkPG").prop("checked", true); }
        if (CasteCertificateDoc == "Yes")
        { $("#chkCaste").prop("checked", true); }
        if (DomicileCertificateDoc == "Yes")
        { $("#chkDomicile").prop("checked", true); }
        if (MigrationCertificateDoc == "Yes")
        { $("#chkMig").prop("checked", true); }
        if (GapCertificateDoc == "Yes")
        { $("#chkGap").prop("checked", true); }
        if (ScoreCardDoc == "Yes")
        { $("#chkScore").prop("checked", true); }
        if (OtherDoc == "Yes")
        { $("#chkOtherDoc").prop("checked", true); }
 
        $('#txtPhyPercentage').val(PhysicsPR);
        $('#txtPhyTotalMarks').val(PhysicsTM);
        $('#txtPhyMarkSecure').val(PhysicsMO);

        $('#txtCheTotalMarks').val(ChemistryTM);	
        $('#txtCheMarkSecure').val(ChemistryMO);
        $('#txtChePercentage').val(ChemistryPR);
        $('#txtMatTotalMarks').val(MathematicsTM);
        $('#txtMatMarkSecure').val(MathematicsMO);
        $('#txtMatPercentage').val(MathematicsPR);
        $('#txtPhySubject').val(PhysicsSubject);
        $('#txtCheSubject').val(ChemistrySubject);
        $('#txtMatSubject').val(MathematicsSubject);
...
function GetStateDomisile(DomicileState, DomicileDistrict, DomicileTehsil) {
    debugger;
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (DomicileState != null && DomicileState != '') {
                selectByVal("ddlDomicileState", DomicileState);
                GetDomosileDistrict(DomicileDistrict, DomicileTehsil);
            }
        },
        error: function (a, b, c) {
            alert("2." + a.responseText);
...
function GetDomosileDistrict(DomicileDistrict, DomicileTehsil) {
    var SelState = $('#ddlDomicileState').val();
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        ...
        success: function (response) {
            ...
            if (DomicileDistrict != null && DomicileDistrict != '') {
                selectByVal("ddlDomicileDistrict", DomicileDistrict);
                GetDomosileBlock(DomicileTehsil);
            }
        },
        error: function (a, b, c) {
            alert("2." + a.responseText);
...
function GetDomosileBlock(DomicileTehsil) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            selectByVal("ddlDomicileTehsil", DomicileTehsil);
        },
        error: function (a, b, c) {
            alert("2." + a.responseText);
        }
