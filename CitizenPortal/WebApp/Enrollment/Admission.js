...
function SubmitData() {
    ...
    $.when(
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: '/WebApp/Enrollment/StudentForm.aspx/InsertEnrollmentData',
            ...
            result = true;
            if (AppID == "" || AppID == null) {
                //alertPopup("Form Validation Failed", "Error While Saving Application., <BR> Your Mobile Number is already registered.");
                $("#progressbar").hide();
