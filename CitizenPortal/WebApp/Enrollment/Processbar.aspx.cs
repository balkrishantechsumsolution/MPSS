...
{
    public partial class Processbar : CitizenPortalLib.BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (t_DT.Rows.Count > 0) {
                ...
                lblPassword.Text = t_DT.Rows[0]["Password"].ToString();
            }
            ...
            if (Session["UserType"].ToString() == "CITIZEN")
            {
                ...
                {
                    Session["HomePage"] = "/WebApp/Citizen/Dashboard.aspx?UID=" + ProfileID;
                }
            }
