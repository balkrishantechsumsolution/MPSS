    ...
    public partial class Dashboard : BasePage
    {
        ...
        protected void grdService_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                t_Anchor.InnerHtml = e.Row.Cells[i-1].Text;

                t_Anchor.Attributes.Add("onclick", "TakePrint('" + e.Row.Cells[1].Text + "', '" + e.Row.Cells[3].Text + "', '" + e.Row.Cells[i-1].Text + "', '" + e.Row.Cells[i].Text + "')");

                t_Anchor.Attributes.Add("style", "cursor:pointer;font-size:10pt;font-family:Arial;color:Firebrick;text-decoration:none;");
                e.Row.Cells[i-1].Controls.Add(t_Anchor);
                e.Row.Cells[i-1].Attributes.Add("Title", e.Row.Cells[i - 1].Text);
        ...
        protected void grdView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                t_Anchor.Attributes.Add("onclick", "ServiceAction('" + e.Row.Cells[i].Text + "', 'GUEST')");

                t_Anchor.Attributes.Add("style", "cursor:pointer;font-size:10pt;font-family:Arial;color:Firebrick;text-decoration:none;");
                e.Row.Cells[i].Controls.Add(t_Anchor);
                e.Row.Cells[i].Attributes.Add("Title", e.Row.Cells[i-1].Text);
                e.Row.Cells[i].Style.Add(HtmlTextWriterStyle.Cursor, "Pointer");
                t_Anchor = null;
            }
