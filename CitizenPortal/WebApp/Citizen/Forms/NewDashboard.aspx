<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Citizen/Master/Citizen.Master" ClientIDMode="Static" AutoEventWireup="true" CodeBehind="NewDashboard.aspx.cs" Inherits="CitizenPortal.WebApp.Citizen.Forms.NewDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function TakePrint(p_ServiceID, p_UID, p_RollNo, p_AckURL) {
            //var t_URL = ResolveUrl(p_URL);
            var t_URL = "/WebApp/Kiosk/Forms/AppRedirect.aspx";
        ...
        <div class="modal-dialog" style="width: 80%;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-newspaper-o fa-fw" style="font-size: 0.9em; vertical-align: middle;"></i>Notice
                    </h4>
                </div>
                        ...
                        <table cellpadding="0" cellspacing="0" class="table table-bordered" style="height: 250px; overflow: scroll;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Dear Student,<br />
                                        You are requested, to check all the details Subject, if any correction please inform your college DEO
                                    </td>
                                </tr>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-lg-8" style="font-size: 1.4em;">
                                        <i class="fa fa-tasks fa-fw"></i>Active Services
                                    </div>
                                </div>
                            </div>
                            <!-- /.panel-heading -->
