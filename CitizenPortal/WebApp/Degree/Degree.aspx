<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Citizen/Master/Citizen.Master" AutoEventWireup="true" CodeBehind="Degree.aspx.cs" Inherits="CitizenPortal.WebApp.Degree.Degree" %>
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>Application for Degree Certificate</h2>
                </div>
            </div>
            ...
            <div class="" style="">
                    ...
                    <div class="col-md-9 p0">
                        <div class="col-md-12 box-container">
                            ...
                            <div class="box-body box-body-open">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                                    <div class="form-group">
                                        <label class="manadatory" for="ddlYear">Passing Year</label>
                                        <select name="" id="ddlPassing" class="form-control">
                                            <option value="0">-Select-</option>
                                            <option value="2020-2021">2020-2021</option>
                                            <option value="2019-2020">2019-2020</option>
                                            <option value="2018-2019">2018-2019</option>
                                ...
                                <div class="clearfix"></div>
                                    ...
                                    <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                                        <div class="form-group">
                                            <label style="font-size:23px;color:maroon"><i class="fa fa-info"></i></label>                                            
                                        </div>
                                    </div>
                                ...
                                <div class="clearfix"></div>
                                    <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                                        <div class="form-group">
                                            <label style="font-size:23px;color:maroon"><i class="fa fa-edit"></i></label>
                                        </div>
                                    </div>
                                    <div class="col-xs-11 col-sm-11 col-md-11 col-lg-11">
                                        <div class="form-group">                                            
                                            <label style="color:red">For Hindi typing, please visit <b><a href="https://www.easyhindityping.com/english-to-hindi-typing" target="_blank" style="color:blue" >https://www.easyhindityping.com/english-to-hindi-typing</a></b> and type your Name in Hindi and copy & paste it in <b>Student Name in Hindi textbox</b></label>
                                        </div>
                                    </div>
                ...
                <div id="divAddress" class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 box-container mTop15">
                        ...
                        <div class="box-body box-body-open">
                            <div class="col-xs-12 col-sm-2 col-md-3 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" data-val="true" data-val-required="Please select Deliver Mode" id="ddlMode" name="Deliver Mode" style="">
                                        <option value="0">Select</option>
                                        <option selected="selected" value="Offline by Post">Offline by Post</option>
                            ...
                            <div class="col-xs-12 col-sm-2 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label class="manadatory" for="ddlApply">
                                        Applying in For</label>
                                    <select class="form-control" data-val="true" data-val-required="Please select Applying for." id="ddlApply" name="Applying" style="">
                                        <option value="0">Select</option>
                                        <option value="Original">Original (First Time)</option>
                                        <option value="Duplicate">Duplicate (Second Time)</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-2 col-md-3 col-lg-2">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <div class="form-group">
                                    <label class="manadatory" for="RoadStreetName">
                                        Address Line-2 (Road/Street/Locality)
                                    </label>
                ...
                <div class="row">
                    <div class="col-md-6 box-container" id="Div3">
                        <div class="box-heading">
                            <h4 class="box-title register-num">Degree Fees Details
                            </h4>
                        </div>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-12">
                                <div>
                                    <table class=" table table-bordered table-hover table-condensed">
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td>Original & Normal Degree</td>
                                            <td>Rs.500</td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>Original & Urgent Degree</td>
                                            <td>Rs.2000</td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            <td>Duplicate & Normal Degree</td>
                                            <td>Rs.1000</td>
                                        </tr>
                                        <tr>
                                            <td>4</td>
                                            <td>Duplicate & Urgent Degree</td>
                                            <td>Rs.3000</td>
                                        </tr>                                        
                                    </table>
                                </div>
                    ...
                    <div class="col-md-6 box-container" id="Div2">
                        <div class="box-heading">
