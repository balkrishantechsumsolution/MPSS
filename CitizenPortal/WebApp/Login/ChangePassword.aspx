<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="CitizenPortal.WebApp.Login.ChangePassword" %>
                    ...
                    <div class="form-group mbtm50">
                        ...
                        <div class="col-xs-12 pright0 pleft0">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtcurrentpass" runat="server" TextMode="Password" CssClass="form-control" ClientIDMode="Static" OnChange="GetCitizenLoginCount();"></asp:TextBox>
                            </div>
