<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="EditStudentInfo.aspx.cs" Inherits="CitizenPortal.WebApp.Profile.EditStudentInfo" %>
...
<head runat="server">
    ...
    <script src="/WebApp/profile/Script/EditStudentInfo.js?v=<%=CitizenPortal.Common.GlobalValues.JSVersion%>"></script>
                        ...
                        <div class="box-body box-body-open">
                            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                                <div class="form-group">
                                    <label class="manadatory" for="ddlEditType">
                                        Gender</label>
                                    <select class="form-control" data-val="true" data-val-number="edittype" data-val-required="Please select gender." id="ddlEditType" name="EditType" style="">
                                        <option value="0">Select</option>
                                        <option value="P">Photo & Signature Change</option>
                                        <option value="T">College Transfer</option>
                                        <option value="C">Profile Correction</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input id="txtEnroll" type="text" class="form-control" placeholder="Enrollment" disabled />
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-2">
                                <div class="form-group">
