...
{
    public partial class Migration3 : System.Web.UI.Page
    {
        ...
        public static string InsertNewMigration(string prefix, string Data)
        {
            ...
            NewMigration_DT viewModel = ToObjectFromJSON<NewMigration_DT>(noNewLines);
            string URL = "";
            URL = m_ServiceURL;
            string text;
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertNewMigration(viewModel);
                }
            }
            return text;
        }
        ...
        [WebMethod]
        public static string GetMigrationData(string regno, string AdmisionYr)
        {
            string URL = "";
        ...
        public static string GetRollNoDetails(string AppIDRollNo)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("GetConstableDataSP", con))
                {
                    con.Open();
