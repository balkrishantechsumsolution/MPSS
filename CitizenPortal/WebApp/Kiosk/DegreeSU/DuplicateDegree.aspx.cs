...
{
    public partial class DuplicateDegree : System.Web.UI.Page// BasePage
    {
        ...
        [WebMethod]
        public static string InsertDuplicateDegree(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            DuplicateDegree_DT viewModel = ToObjectFromJSON<DuplicateDegree_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertDuplicateDegree(viewModel);
