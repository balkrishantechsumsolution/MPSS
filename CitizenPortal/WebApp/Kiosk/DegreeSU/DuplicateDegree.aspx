<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="DuplicateDegree.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.DegreeSU.DuplicateDegree" %>
    ...
    <div id="intrnlContent" ng-app="appmodule">
        <div ng-controller="ctrl">
            <div id="page-wrapper" style="min-height: 500px !important;">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <select name="ddlBranch" id="ddlPrograme" class="form-control" data-val="true" data-val-number="" data-val-required="Please select Trade Name">
                                        ...
                                        <option value="1">B.A (Hons.)</option>
                                        <option value="2">B.A (Pass.)</option>
                                        <option value="1">B.Com (Hons.)</option>
                                        <option value="2">B.Com (Pass.)</option>
                                        <option value="1">B.Sc (Hons.)</option>
                                        <option value="2">B.Sc (Pass.)</option>
                                        <option value="1">B.B.A (Hons.)</option>
                                        <option value="2">B.B.A (Pass.)</option>
                ...
                <%----Start of Subject-----%>
                <div class="row">
                    <div class="col-md-12 box-container" id="divSubject">
                        <div class="box-heading">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    <label for="txtSubject1">
                                        Subject 1</label>
                                    <input id="txtSubject1" class="form-control" placeholder="Name of Subject" name=" txtSubject1" type="text" value=""
                                        maxlength="100" onkeypress="return ValidateAlpha(event)" autofocus />
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    <label for="txtSubject2">
                                        Subject 2</label>
                                    <input id="txtSubject2" class="form-control" placeholder="Name of Subject" name=" txtSubject2" type="text" value=""
                                        maxlength="100" onkeypress="return ValidateAlpha(event)" autofocus />
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    <label for="txtSubject3">
                                        Subject 3</label>
                                    <input id="txtSubject3" class="form-control" placeholder="Name of Subject" name=" txtSubject3" type="text" value=""
                                        maxlength="100" onkeypress="return ValidateAlpha(event)" autofocus />
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    <label for="txtSubject4">
                                        Subject 4</label>
                                    <input id="txtSubject4" class="form-control" placeholder="Name of Subject" name=" txtSubject4" type="text" value=""
                                        maxlength="100" onkeypress="return ValidateAlpha(event)" autofocus />
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label class="" for="txReason">
                                        Reason of Issuing of Duplicate Degree Certificate</label>
