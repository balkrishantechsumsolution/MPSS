...
namespace CitizenPortal.WebApp.Kiosk.ProvisionalSU
{
    public partial class Provisional : System.Web.UI.Page// BasePage
    {
        ...
        [WebMethod]
        public static string InsertProvisional(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            ProvisionalCertificate_DT viewModel = ToObjectFromJSON<ProvisionalCertificate_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertProvisionalCertificate(viewModel);
