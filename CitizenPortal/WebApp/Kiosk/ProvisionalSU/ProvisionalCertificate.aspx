<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProvisionalCertificate.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.ProvisionalSU.ProvisionalCertificate" %>
                                    ...
                                    <td style="vertical-align: top; height: 924px;">
                                        <div style="margin: 10px auto; width: 708px; font-size: 13px;">
                                            ...
                                            <table style="width: 100%">
                                                ...
                                                <tr>
                                                    <td colspan="3" style="text-align: center">
                                                        <asp:Label ID="Label3" runat="server" Font-Bold="False" Font-Names="Arial Black" Font-Size="25px" Text="DUPLICATE DEGREE CERTIFICATE"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3" style="">
                                                        <table style="height:300px; width: 100%; text-align: justify; font-family: 'Monotype Corsiva'; font-size: 25px;">
                                                            <tr>
                                                                <td style="text-align: justify;">
                                                                    ...
                                                                    &nbsp;&nbsp;&nbsp;&nbsp; has passed the&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                    <asp:Label ID="lblDiploma" runat="server" Font-Names="Arial" Font-Size="20px" Font-Bold="True" Font-Italic="True">Degree</asp:Label>
                                                                    &nbsp;&nbsp;&nbsp;&nbsp; in&nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            <table style="width: 100%;">
                                                ...
                                                <tr>
                                                    <td style="text-align: center;">
                                                        <asp:Label ID="Label13" runat="server" style="font-weight:bold" Text="REGISTRAR"></asp:Label>
                                                    </td>
                                                    <td style="text-align: center;">
                                                        <asp:Label ID="Label14" runat="server" style="font-weight:bold" Text="CONTROLLER OF EXINATION"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="text-align: center; width: 200px;">
                                                        <asp:Label ID="Label11" runat="server" Text="Chhattisgarh Swami Vivekanad Technical University, Rai[ur"></asp:Label>
                                                    </td>
                                                    <td style="text-align: center; width: 200px;">
