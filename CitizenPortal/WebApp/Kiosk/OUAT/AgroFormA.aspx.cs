...
{
    public partial class AgroFormA : BasePage
    {
        ...
        public static string InsertData(string prefix, string Data)
        {
            ...
            OUATAgroFormA_DT viewModel = ToObjectFromJSON<OUATAgroFormA_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(binding))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertOUATAgroFormA(viewModel);
                }
            }
        ...
        [WebMethod]
        public static string GetAgroCourse(string prefix)
        {
            string URL = "";
