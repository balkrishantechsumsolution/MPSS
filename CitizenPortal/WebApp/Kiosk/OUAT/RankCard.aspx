<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RankCard.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OUAT.RankCard" %>
                                ...
                                <table style="width: 100%; vertical-align: middle; text-align: center;">
                                    <tr>
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                            ...
                                            <br />
                                            <asp:Label runat="server">Counselling for Admission into UG Courses for the Year, 2017-18 </asp:Label>
                                        </td>
                                        <td>
                            ...
                            <div style="margin: 5px auto; width: 770px; font-size: 12px;">
                                <table cellpadding="5" cellspacing="0" class="" style="width: 100%; border: 0;font-size:11px;">
                                    <tr>
                                        ...
                                        <td rowspan="4" style="padding: 0; border: 1px solid #999; text-align: center; vertical-align: top;width: 70px;">
                                ...
                                <table cellpadding="5" cellspacing="0" class="" style="width: 100%; border: none; font-family: Arial; font-size: 11px;">
                                    ...
                                    <tr style="font-weight: bold;">
                                        ...
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblRankGen" runat="server">26492</asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblRankST" runat="server">26492</asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblRankSC" runat="server">26492</asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblRankGCH" runat="server">26492</asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblRankPH" runat="server">26492</asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblRankWOSC" runat="server">26492</asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblRankWOST" runat="server">26492</asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblRankWOGCH" runat="server">26492</asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblRankWOGen" runat="server">26492</asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblRankOE" runat="server">26492</asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblRankNRI" runat="server">26492</asp:Label>
                                            </td>
                                    </tr>
                                    <tr style="font-weight: bold;">
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;" class="auto-style1" rowspan="2">Counseling Date &amp; Time</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblDateGen" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblDateST" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblDateSC" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblDateGCH" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblDatePH" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblDateWOSC" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblDateWOST" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblDateWOGCH" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblDateWO" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblDateOE" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblDateNRI" runat="server"></asp:Label>
                                            </td>
                                    </tr>
                                    <tr style="font-weight: bold;">
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                        ...
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblTimeST" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblTimeSC" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblTimeGCH" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblTimePH" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblTimeWOSC" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblTimeWOST" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblTimeWOGCH" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblTimeWOGen" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblTimeOE" runat="server"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">
                                            <asp:Label ID="lblTimeNRI" runat="server"></asp:Label>
                                            </td>
                                    </tr>
                                    <tr style="font-weight: bold;">
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;">Venue</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;" colspan="11">
                                ...
                                <table cellspacing="0" class="" style="width: 100%; border: none; font-family: Arial; font-size: 11px;">
                                    ...
                                    <tr style="font-weight: bold;">
                                        ...
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center; " colspan="2">GENERAL</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center; " colspan="2">COST SHARING</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center; " colspan="2">NRI</td>
                                    </tr>
                                    <tr style="font-weight: bold;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 2px; border: 1px solid #999; text-align: right;">2115/-</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: right;">61,900/-</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: right;">2115/-</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;">B.TECH. (AG.ENGG.)
                                        </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: right;" rowspan="4">2079/-</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: right;" rowspan="4">40,700/-</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: right;" rowspan="4">2079/-</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;">B.Sc. (AG.) / B.Sc. (HORTICULTURE) </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;">5.</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;">B.Sc. (FISHERY)</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;">6.</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;">B.Sc.  (HOME SCIENCE)</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: right;">2079/-</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: right;">16,400/-</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">--</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">--</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">--</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: center;">--</td>
                                ...
                                <div>
                                    ...
                                    <table style="font-size: 11px; width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: top; text-align: left;">Migration Certificate.</td>
                                        </tr>
                                        <tr>
