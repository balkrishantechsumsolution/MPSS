<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" CodeBehind="OUATDiplomaProcessbar.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OUAT.OUATDiplomaProcessbar" %>
        ...
        <div class="row">
            <div id="divPrint" class="container mtop10 hldshdw" style="padding-right: 0; padding-left: 0; width: 99%;">
                ...
                <div class="col-lg-12 wizard_hd">
                    <b style="font-size: 20px;">SUBMISSION OF OUAT POLYTECHNIC DIPLOMA PROGRAM OF OUAT 2017-18 </b>
                </div>
