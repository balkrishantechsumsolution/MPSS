<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="OUATPGHome.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OUAT.OUATPGHome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ViewApplication() {
            ...
            var p_URL = "";
            if (SvcID == "419") {
                p_URL = "/WebApp/Kiosk/OUAT/AcknowledgementForDoctoralMaster.aspx?SvcID=419";
            }
            window.open(p_URL + "&UID=" + UID + "&AppID=" + AppID,
                           ' scrollbars=1,resizable=1,width=800, height=600, top= 50, left=300');
        }
        ...
        function DownloadPass() {
            ...
            var AppID = qs["AppID"];
            var SvcID = qs["SvcID"];
            var p_URL = "/WebApp/Kiosk/OUAT/OUATPGAdmitCard.aspx?SvcID=" + SvcID;
            window.open(p_URL + "&UID=" + UID + "&AppID=" + AppID,
                           ' scrollbars=1,resizable=1,width=800, height=600, top= 50, left=300');
        }
        ...
        function UploadDocument() {
            ...
            var SvcID = qs["SvcID"];
            var FormBAppID = $("#HFFormBAppID").val();
            var p_URL = "/WebApp/Kiosk/Forms/Attachment.aspx?SvcID=419";
            window.open(p_URL + "&UID=" + UID + "&AppID=" + AppID,
                           ' scrollbars=1,resizable=1,width=800, height=600, top= 50, left=300');
        }
        ...
        function RankCard() {            
            ...
            var SvcID = qs["SvcID"];
            var FormBAppID = $("#HFFormBAppID").val();
            var p_URL = "/WebApp/Kiosk/OUAT/OUATPGRankCard.aspx?SvcID=419";
            window.open(p_URL + "&UID=" + UID + "&AppID=" + AppID,
                           ' scrollbars=1,resizable=1,width=800, height=600, top= 50, left=300');
        }
            ...
            <div class="resp-tabs-container ver_1">
                <div style="margin-top: 20px;">
                    <div style="min-height: 4.66em; z-index: -760;" class="SrvDiv" id="101">
                        <a href="#" onclick="javascript:return RedirectToService('/WebApp/Kiosk/OUAT/AcknowledgementForDoctoralMaster.aspx?SvcID=419');">
                    ...
                    <div runat="server" id="divPayment" style="display:none;">
                        <div style="min-height: 4.66em; z-index: -760;" class="SrvDiv" id="103">
                            ...
                            </a><a href="#" onclick="javascript:return ConfirmPayment();">MAKE PAYMENT (till 09-07-2017)</a>
                            <br />
                    ...
                    <div runat="server" id="divPass" style="min-height: 4.66em; z-index: -760;" class="SrvDiv">
                        ...
                        <br />
                        <span>Download / Print Admit Card PG/MSc COURSE PROGRAMME</span>
                    ...
                    <div runat="server" id="divDoc" style="min-height: 4.66em; z-index: -760;display:none" class="SrvDiv" visible="false">
                        ...
                        <br />
                        <span>Upload and View the attached Document (link open till 17-07-2017)</span>
                    </div>

                    <div runat="server" id="divRankCard" style="min-height: 4.66em; z-index: -760;" visible="false" class="SrvDiv">
                        <a href="#" onclick="javascript:return RankCard();">
                            <img src="/webapp/kiosk/Images/odisalogo_1.png" alt="" align="left" style="height: 70px;" />
                        </a><a href="#" onclick="javascript:return RankCard();">Rank cum Intimation Card</a>
                        <br />
                        <span>Download Rank-cum-Intimation Card for OUAT PG/PhD Admission</span>
                    </div>
