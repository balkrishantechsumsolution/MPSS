...
{
    public partial class ProvisionalMark : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet dt = m_OUATBLL.OUATGetProvisionalMarks(m_ServiceID, m_AppID);
            DataTable dtApp = dt.Tables[0];
            DataTable dtProvisionalMark = dt.Tables[1];
            DataTable dtRank = dt.Tables[2];
            if (dtApp.Rows.Count != 0)
            {
                ...
                lblWEG10.Text = dtProvisionalMark.Rows[0]["25% of 10th Percentage"].ToString();

                lblTM12.Text = dtProvisionalMark.Rows[0]["PCM_PCBTotalMarks"].ToString();
                lblMO12.Text = dtProvisionalMark.Rows[0]["PCM_PCBMarksObtained"].ToString();
                lblPCMB.Text = dtProvisionalMark.Rows[0]["PCM_PCBMarksText"].ToString();
                lblPER12.Text = dtProvisionalMark.Rows[0]["PCM_PCBMarks"].ToString();
                lblWEG12.Text = dtProvisionalMark.Rows[0]["25% of PCM/PCB Percentage"].ToString();

                lblTMEE.Text = dtProvisionalMark.Rows[0]["EETotalMark"].ToString();
                lblMOEE.Text = dtProvisionalMark.Rows[0]["Marks in Written"].ToString();
                lblPEREE.Text = dtProvisionalMark.Rows[0]["Provisional Weight-age"].ToString();
                lblWEGEE.Text = dtProvisionalMark.Rows[0]["50% of Written Marks"].ToString();
            ...
            {
                string m_Message = @"Sorry! Your Provisional Weightage and Rank as been not awared";
