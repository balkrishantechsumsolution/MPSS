<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="DoctoralMastersAdmissionForm16-17.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OUAT.DoctoralMastersAdmissionForm16_17" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="/WebApp/Kiosk/OUAT/DoctoralMasters.js?v=<%=CitizenPortal.Common.GlobalValues.JSVersion%>"></script>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="form-heading">
                            <span class="col-lg-12 p0" style="font-size: 23px;"><i class="fa fa-pencil-square-o"></i>Application form for Admission into OUAT Master's & Doctoral Program-2017 (Agriculture & Allied Subjects)</span>
                        ...
                        <div class="box-body box-body-open">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-4">
                                        <input class="form-control" placeholder="Enter 12 digit Aadhaar Number" name="txtAadhaar" type="text" value="" id="UID" maxlength="12" onkeypress="return isNumberKey(event);" onchange="GetOUATAadhaarCount();" />
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12 othrinfohd">
                                        <div class="col-md-9 pleft0">
                                            <p><span><span class="fom-Numbx"><i class="fa fa-hand-o-right"></i></span><b>Have you passed the qualifying examination from Universities Recognized by State / Central Government </b></span></p>
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-12 othrinfosubhd2">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="">
                                                        <p class=""><i class="fa fa-info-circle pright5" style="color: #000;"></i>Handicapped Candidate need to upload <b>Physical Challenged certificate from Competent Medical Authority</b> in attachment page. <span style="color: red;"></span></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="divWO">
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-12 othrinfosubhd2">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="">
                                                        <p class=""><i class="fa fa-info-circle pright5" style="color: #000;"></i>Other State candidate need to upload <b>Permanent Residential Certificate </b>in attachment page. Please refer <b>Clause 4.2(f) of OUAT PG Prospectus - 2017-2018</b> <span style="color: red;">*</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" id="divHoriculture" style="display: none">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <div class="col-lg-12 othrinfosubhd2">
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="">
                                                            <p class=""><i class="fa fa-info-circle pright5" style="color: #000;"></i>Please Upload the respective required document as per clause 7.4.4 of OUAT PG prospectus 2017-2018<span style="color: red;">*</span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="box-body box-body-open">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div id="RecptHasMedal" class="form-group" style="display: block;">
                                            <div class="col-lg-12 othrinfosubhd2">
                                                <div class="col-md-9 pleft0">
                                                    <p class="ptop5 pleft27"><i class="fa fa-arrow-right pright5"></i>Please submit relevant document from competent authority as per clause 7.5(a) of OUAT PG Prospectus 2017-2018.</p>
                                                </div>
                                        ...
                                        <div class="form-group mtop5">
                                            <div class="col-lg-12 othrinfohd">
                                                <div class="col-md-9 pleft0">
                                                    <p><span id="Emp"><span class="fom-Numbx">2.</span> Are you employed?</span></p>
                                                </div>
                                                <div class="col-md-3 pleft0 pright0">
                                                    <div class="col-xs-6 pleft0">
                                        ...
                                        <div id="SpecialClaim" style="display: none">
                                            <div class="form-group mtop5">
                                                <div class="col-lg-12 othrinfohd">
                                                    <div class="col-md-9 pleft0">
                                                        <p><span id="SplClmOpt"><span class="fom-Numbx">3.</span>Do you want any special claims?</span></p>
                                                    </div>
                                                    <div class="col-md-3 pleft0 pright0">
                                                        <div class="col-xs-6 pleft0">
                                            ...
                                            <div class="form-group" id="divSpecialClaim" style="display: none">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <div class="col-lg-12 othrinfosubhd2">
                                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="">
                                                                <p class=""><i class="fa fa-info-circle pright5" style="color: #000;"></i>Please Upload the respective required document details as per clause 7.6.1 of OUAT PG prospectus 2017 for Sports/NCC/NSS <span style="color: red;">*</span></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p0">
                                            <div class="form-group" style="margin-bottom: 0;">
                                                <div class="table-responsive">
                                                    <table style="width: 99%; margin: 8px auto;" class="table-striped table-bordered table">
                                                        <tr>
                                                            <td colspan="6" style="background-color: #415670; color: #fff; font-size: 15px;">Educational Qualification of B.Sc (Ag)/B.sc.(Hort)B.V.Sc.& A.H/B.Tech (Ag.Engg.)/B.F.Sc/B.Sc(H.Sc)/B.Sc(Forestry)</td>
                                                        </tr>
                                                        <tbody>
                                                            <tr>
                                                                <th style="width: 25%;">
                                                                ...
                                                                <th style="width: 8%;">
                                                                    <label class="manadatory" id="lblBscTotalMarks">Total Marks</label>
                                                                </th>
                                                                <th style="width: 8%;">
                                                                    <label class="manadatory" id="lblBscMarksGot">Marks Scored</label>
                                                                </th>
                                                                <th style="width: 8%;">
                                                                    <label class="manadatory">Percentage of Marks</label>
                                                                </th>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p0" id="divMsc">
                                            <div class="form-group" style="margin-bottom: 0;">
                                                <div class="table-responsive">
                                                    <table style="width: 99%; margin: 8px auto;" class="table-striped table-bordered table">
                                                        <tr>
                                                            <td colspan="6" style="background-color: #415670; color: #fff; font-size: 15px;">Educational Qualification of M.Sc.(Ag.)/M.V. Sc./M.Tech (Agril,Engg.) M.F.Sc./Equivalent</td>
                                                        </tr>
                                                        <tbody>
                                                            <tr>
                                                                <th style="width: 25%;">
                                                                ...
                                                                <th style="width: 8%;">
                                                                    <label class="manadatory" id="lblMscTotalMarks">Total Marks</label>
                                                                </th>
                                                                <th style="width: 8%;">
                                                                    <label class="manadatory" id="lblMscMarksGot">Marks Scored</label>
                                                                </th>
                                                                <th style="width: 8%;">
                                                                    <label class="manadatory">Percentage of Marks</label>
                                                                </th>
