...
{
    public partial class OUATDiplomaProcessbar : CitizenPortalLib.BasePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("/WebApp/Kiosk/OUAT/OUATDiplomaHome.aspx?SvcID=" + m_ServiceID + "&AppID=" + m_AppID);
