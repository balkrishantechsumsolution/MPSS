<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="OUATPGPage.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OUAT.OUATPGPage" %>
        ...
        <div class="w95" style="min-height: 500px;">
            ...
            <div class="col-lg-2 mtop20 pleft0">
                <div class="text" style="overflow: hidden; line-height: 22px; text-align: left; background-color: #E6F2FF; border-right: 1px solid #337AB7; border-bottom: 1px solid #337AB7; border-left: 1px solid #337AB7;">
                    ...
                    <div class="text-left" style="padding-top: 5px; display: flex;"><i class="fa fa-hand-o-up" style="padding: 0 5px 0 5px; color: #337ab7;"></i><a href="/g2c/PDF/Advt.Notice_OUAT_PG_Course_2017.pdf" target="_blank">Advertisement Notice for OUAT PG Prospectus: 2017-18</a> <span class="blink_text">New</span></div>
                    <div class="text-left" style="padding-top: 5px;"><i class="fa fa-hand-o-up" style="padding: 0 5px 0 5px; color: #337ab7;"></i><a href="/g2c/PDF/PG_Prospectus_2017_18.pdf" target="_blank">OUAT PG Prospectus: 2017-18</a></div>
                    <%--<div class="text-left"><i class="fa fa-hand-o-up" style="padding: 0 5px 0 5px; color: #337ab7;"></i><a href="/g2c/pdf/OUAT_UG_Admission_Notice_2017-18.pdf" target="_blank">Admission Notice</a></div>--%>
                ...
                <div class="text" style="overflow: hidden; line-height: 22px; text-align: left; background-color: #E6F2FF; color: #777; border-right: 1px solid #337AB7; border-bottom: 1px solid #337AB7; border-left: 1px solid #337AB7; line-height: 26px; padding: 0px 0 5px 0;">
                    ...
                    <i class="fa fa-hand-o-right" style="padding: 0 5px 0 5px; color: #337ab7;"></i>Last Date for Upload Document till:-	 17.07.2017
                    <br />
                    <i class="fa fa-hand-o-right" style="padding: 0 5px 0 5px; color: #337ab7;"></i>Submission of Application online		:-  09.07.2017
                    <br />
            ...
            <div class="col-lg-10">
                ...
                <h2 class="form-heading">
                    <span class="col-lg-10 p0"><i class="fa fa-pencil-square-o"></i>ONLINE APPLICATION FOR MASTER'S & DOCTORAL PROGRAM - 2017 FOR OUAT
                    </span>

                    <span class="clearfix"></span>
                </h2>
                <div style="padding:15px; font-family:Arial, Helvetica, sans-serif; background-color:#d32f2f; font-size:14px; text-shadow: 2px 2px 14px #000000; letter-spacing:0.15em; color:#fff; text-align:center;"><i class="fa fa-hand-o-right fa-fw"></i>The Last date of submission of application is over.</div>
                <div class="">
                    <div class="resp-tabs-container ver_1">
                        <div style="margin-top: 20px;">
                            ...
                            <div class="SrvDiv" id="101" style="min-height: 4.66em; z-index: -760;">
                                ...
                                <span>For Application of PG Courses OUAT (Uploading Documents)</span>
                            </div>
                            ...
                            <div style="min-height: 4.66em; min-width: 99%; z-index: -760;" class="SrvDiv" id="102">
                                <a href="/WebApp/Citizen/Forms/Geustuser.aspx?SvcID=419&Mode=C">
                                    <img src="/webapp/kiosk/Images/OUAT.png" alt="" align="left" style="height: 70px;" />
                                </a><a href="/WebApp/Citizen/Forms/Geustuser.aspx?SvcID=419&Mode=D" onclick="javascript:return RedirectToService('/WebApp/Citizen/Forms/Geustuser.aspx?SvcID=419&Mode=D');">Submission of Online Application For Master's & Doctoral Programme – 2017 In Agriculture & Allied Subjects</a>
                                <br />
                                <span style="font-size: 12px !important; font-weight: bold !important; color: black !important;">OUAT PG Courses – 2017 (In Agriculture & Allied Subjects)</span><br />
                                <span>OUAT PG & Ph.D Courses – 2017 (In Agriculture & Allied Subjects)</span>
                            </div>
                        </div>
                    </div>
                </div>
