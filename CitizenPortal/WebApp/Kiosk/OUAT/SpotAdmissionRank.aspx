<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpotAdmissionRank.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OUAT.SpotAdmissionRank" %>
        ...
        <div>
            <div class="box-body box-body-open">
                ...
                <div id="divPrint" style="margin: 0 auto; width: 800px;margin-bottom:60px; /*height: 1080px; height: 1220px; overflow: auto; */">
                    <div style="margin: 0 auto; height: 1133px; width: 794px; padding: 2px; border: 3px solid #000; padding: 1px; font-family: Arial">
                        <div style="margin: 0 auto; height: 1125px; width: 785px; border: 1px solid #000; background-image: url('../images/ouatlogobg.png'); background-size: 400px; background-repeat: no-repeat; background-position: center center;">
                                ...
                                <table style="width: 100%; vertical-align: middle; text-align: center;">
                                    <tr>
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                            ...
                                            <span style="text-align: center; font-size: 20px; font-weight: bold; color: #d43300;">Spot Counselling & Admission  for UG Courses - 2017</span><br />
                            ...
                            <div style="margin: 5px auto; width: 770px; font-size: 12px;">
                                <table cellpadding="5" cellspacing="0" class="" style="width: 100%; border: 0;font-size:11px;">
                                    <tr>
                                        ...
                                        <td rowspan="7" style="padding: 0; border: 1px solid #999; text-align: center; vertical-align: top;width: 70px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;">General Rank</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left; ">
                                    ...
                                    <tr>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left; white-space: nowrap;">
                                            Provisional Spot Rank</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left; width: 250px;">
                                            <asp:Label ID="lblSpotRank" runat="server" Font-Bold="True"></asp:Label>
                                            </td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;">Spot Payment Status</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left; ">
                                    ...
                                    <tr>
                                        <td style="border: none;color:maroon;font-size:13px;font-weight:bold;text-align:center;" colspan="5">
                                            <asp:Label ID="lblStatusMsg" runat="server"></asp:Label></td>
                                    </tr>
                                </table>
                                <table style="clear: both; padding: 0; width: 100%; font-size: 11px">
                                    <tr>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: left;" colspan="3"><b>COLLEGE &amp; COURSE PREFERENCE</b></td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: left;">
                                            <label class="manadatory" for="ddlCenter">
                                                First Preference</label></td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: left;">
                                ...
                                <table cellpadding="5" cellspacing="0" class="" style="width: 100%; border: none; font-family: Arial; font-size: 11px;">
                                    <tr style="font-weight: bold;">
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;" colspan="2">
                                            <b style="text-transform: capitalize">COUNSELLING DETAILS</b></td>
                                    </tr>
                                    <tr style="font-weight: bold;">
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;">Date &amp; Time</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;">
                                            Saturday, 19th August 2017 at 9:30 AM</td>
                                    </tr>
                                    <tr style="font-weight: bold;">
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;">Venue</td>
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left;">
                                            <asp:Label ID="lblVenue" runat="server" style="font-size:11px;font-weight:bold" Text="Dr. M.S. Swaminathan Conference Hall, 2nd Floor, OUAT Administrative Building, Bhubaneswar-3"></asp:Label>
                                ...
                                <table cellspacing="0" class="" style="width: 100%; border: none; font-family: Arial; font-size: 11px;">
                                    <tr>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: left;" colspan="7">
                                            <b>FEE STRUCTURE AND MODE OF PAYMENT DETAILS (in Rupees)</b></td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: left;">&nbsp;</td>
                                    </tr>
                                    <tr style="font-weight: bold;">
                                        <td style="padding: 1px; border: 1px solid #999; text-align: left; "  rowspan="3">SL.</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: left;" rowspan="3">Course Nmae</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center; " colspan="2" class="auto-style1">SEATS</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center; " colspan="4">FEE STRUCTURE</td>
                                    </tr>
                                    <tr style="font-weight: bold;">
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center; " class="auto-style1" rowspan="2">General</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center; " class="auto-style1" rowspan="2">Cost
                                            <br />
                                            Sharing</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center; " colspan="2">GENERAL</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center; " colspan="2">COST SHARING</td>
                                    </tr>
                                    <tr style="font-weight: bold;">
                                    ...
                                    <tr>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center;">1.</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: left;">B.Sc. (HORTICULTURE) <br />
                                            College of Horticulture, Chiplima</td>
                                        ...
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center;">--</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center;">--</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center;">2,079/-</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center;">90,700/-</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: left;">2.</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: left;">B.Sc. (FORESTRY)<br />
                                            College of Forestry, Bhubaneswar</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center;">--</td>
                                    ...
                                    <tr>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center;">3.</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: left;">B.Sc. (COMMUNITY SCIENCE)<br />
                                            College of Community Science, Bhubaneswar</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center;">22</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center;">--</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center;">2,079/-</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center;">16,400/-</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center;">--</td>
                                        <td style="padding: 1px; border: 1px solid #999; text-align: center;">--</td>
                                    </tr>
                                </table>
                                ...
                                <div>
                                    ...
                                    <table style="font-size: 11px; width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: top; text-align: left;">Candidates for Admission into B.Sc. (Forestry) courses shall attend the endurance test on 18th August 2017 with a medical fitness certificate (Annexure-VII) from CDMO / equivalent rank issued within 30 days prior to counseling. They have to report at 5.30 A.M. on the date of endurance test at College of Agriculture, Assembly Hall, OUAT, Bhubaneswar.</td>
                                        </tr>
                                        <tr>
...
<%--                                        <tr>
                                    ...
                                    <table style="font-size: 11px; width: 100%;">
                                        ...
                                        <tr>
                                            <td style="vertical-align: top; text-align: left;">2.</td>
                                            <td style="vertical-align: top; text-align: left;font-weight: bold;"><u>The Admission Board reserves the right to deny admission to any candidate who has submitted wrong information in Form-B to enhance weightage and Rank.</u></td>
                                        </tr>
                                        <tr>
                                            <td style="vertical-align: top; text-align: left;">3.</td>
