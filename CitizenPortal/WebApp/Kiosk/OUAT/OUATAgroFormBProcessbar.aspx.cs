...
{
    public partial class OUATAgroFormBProcessbar : CitizenPortalLib.BasePage
    {
        private string m_AppID, m_ServiceID, FormA_AppID;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            FormA_AppID = Request.QueryString["FormA_AppID"].ToString();
            m_AppID = Request.QueryString["AppID"].ToString();
            m_ServiceID = Request.QueryString["SvcID"].ToString();

            lblAppID.Text = FormA_AppID;
