<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="OUATPGProcessbar.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OUAT.OUATPGProcessbar" %>
        ...
        <div class="row">
            <div id="divPrint" class="container mtop10 hldshdw" style="padding-right: 0; padding-left: 0; width: 99%;">
                ...
                <div class="col-lg-12 wizard_hd">
                    <b style="font-size: 20px;">Application form for appearing in the Entrance Examination Ph.D. Programme, 2021 
 </b>
                </div>
                ...
                <div>
                    ...
                    <p style="color: maroon !important; width: 90%; margin: 0 auto; font-family: Arial; text-align: center; font-size: 20px;">
                        ...
                        <br />
                        CSVTU Portal - <b style="font-size: 25px; color: maroon !important;">www.CSVTUN.in </b>
                    </p>
                </div>
