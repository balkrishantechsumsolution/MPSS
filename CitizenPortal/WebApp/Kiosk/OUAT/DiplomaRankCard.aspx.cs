...
{
    public partial class DiplomaRankCard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet dt = m_OUATBLL.OUATDiplomaRankCard(m_ServiceID, m_AppID);
            ...
            if (dtApp.Rows.Count != 0)
            {
                ...
                lblWeightage.Text = dtRank.Rows[0]["TotalWeightage"].ToString();
