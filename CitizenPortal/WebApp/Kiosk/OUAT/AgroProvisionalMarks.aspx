<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgroProvisionalMarks.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.OUAT.AgroProvisionalMarks" %>
        ...
        <div>
            <div class="box-body box-body-open">
                ...
                <div id="divPrint" style="margin: 0 auto; width: 800px; /*height: 1080px; height: 1220px; overflow: auto; */">
                    <div style="margin: 0 auto; height: 750px; width: 794px; padding: 3px; border: 3px solid #000; padding: 1px; font-family: Arial;margin-bottom: 100px;">
                        <div style="margin: 0 auto; height: 742px; width: 785px; border: 1px solid #000; background-image: url('../images/ouatlogobg.png'); background-size: 400px; background-repeat: no-repeat; background-position: center center;">
                            ...
                            <div style="display: block; text-align: center; overflow: auto; font-size: 20px; font-weight: bolder; padding: 5px; text-transform: uppercase; background-color: #808080; color: #fff;">
                                <div style="float: left; text-align: center; width: 500px;">
                                    <span style="text-align: center; font-size: 22px; font-weight: bold; color: #fff;">PROVISIONAL WEITAGE CUM RANK</span>&nbsp;
                                </div>
                            ...
                            <div style="margin: 5px auto; width: 770px; font-size: 13px;">
                                <table cellpadding="5" cellspacing="0" class="" style="width: 100%; border: 0;">
                                    <tr>
                                        ...
                                        <td style="padding: 0; border: 1px solid #999; text-align: center; vertical-align: top;" class="auto-style2" rowspan="5">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; white-space: nowrap;" colspan="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;" colspan="2">Mobile No.</td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 175px;">
                                    ...
                                    <tr style="display:none;">
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;" colspan="7">
                                            <b class="text-uppercase">Correspondance Address</b><asp:Label ID="lblEmail0" runat="server" Visible="false">Agro Polytechnic Center : </asp:Label>
                                ...
                                <table cellpadding="5" cellspacing="0" class="" style="width: 100%; border: none; font-family: Arial; font-size: 12px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 3px; border: 1px solid #999; text-align: left;">10% of the 10th Percentage</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 3px; border: 1px solid #999; text-align: left;">B</td>
                                        <td style="padding: 3px; border: 1px solid #999; text-align: left;">+2 Science</td>
                                        <td style="padding: 3px; border: 1px solid #999; text-align: left;">
                                        ...
                                        <td style="padding: 3px; border: 1px solid #999; text-align: left;">10% of the +2 Sc</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 3px; border: 1px solid #999; text-align: left;">C</td>
                                        <td style="padding: 3px; border: 1px solid #999; text-align: left;">Diploma </td>
                                        <td style="padding: 3px; border: 1px solid #999; text-align: left;">
                                            <asp:Label ID="lblTM13" runat="server"></asp:Label>

                                        </td>
                                        <td style="padding: 3px; border: 1px solid #999; text-align: left;">
                                            <asp:Label ID="lblMO13" runat="server"></asp:Label>

                                        </td>
                                        <td style="padding: 3px; border: 1px solid #999; text-align: left;">
                                            <asp:Label ID="lblPER13" runat="server"></asp:Label>

                                        </td>
                                        <td style="padding: 3px; border: 1px solid #999; text-align: left;">
                                            <asp:Label ID="lblWEG13" runat="server"></asp:Label>

                                        </td>
                                        <td style="padding: 3px; border: 1px solid #999; text-align: left;">30% of the Diploma</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="padding: 3px; border: 1px solid #999; text-align: left;">E</td>
                                ...
                                <table cellpadding="5" cellspacing="0" class="" style="width: 100%; border: none; font-family: Arial; font-size: 11px;">
                                    ...
                                    <tr style="font-weight: bold;">
                                        <td style="padding: 2px; border: 1px solid #999; text-align: left; width: 100px">Provisional Rank</td>
                                ...
                                <table cellpadding="5" cellspacing="0" class="" style="width: 100%; border: none; font-family: Arial; font-size: 12px;display:none;">
                                    <tr>
                                        <td style=""></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr style="font-weight: bold;">
                                        <td style="border: 1px solid #999; padding: 0;">
                                            <div style="clear: both; margin: 0; padding: 0; width: 100%">
                                                <table cellpadding="5" cellspacing="0" class="" style="width: 100%; border: 0;display:none"">
                                                    <tr>
