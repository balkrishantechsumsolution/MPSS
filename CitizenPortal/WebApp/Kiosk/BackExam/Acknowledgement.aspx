<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acknowledgement.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.BackExam.Acknowledgement" %>
...
<body>
    <form id="form1" runat="server">
        <div id="divPrint" style="margin: 0 auto; width: 800px;">
            <div style="width: 794px; height: 1120px;  font-family: Arial; font-size: 11px; border: 3px solid #212121; padding: 2px; margin: 0 auto;">
                <div style="width: 792px; height: 1118px;  font-size: 11px; border: 1px solid #000; background-image: url('../images/Sambalpur_UniversityLogo.png'); background-size: 590px; background-repeat: no-repeat; background-position: center center; -webkit-print-color-adjust: exact;">
                    ...
                    <div style="text-align: center; font-size: 20px; font-weight: bolder; padding: 5px; text-transform: uppercase; background-color: #6C4B3C; color: #fff;">
                        ...
                        <span style="font-size: 20px">ACKNOWLEDGEMENT FOR +3 <asp:Label ID="LblSem" runat="server"></asp:Label>SEMESTER BACK  EXAMINATION ENROLLMENT, 2017-18</span>
                    </div>
                    <%----------End title section ---------%>
