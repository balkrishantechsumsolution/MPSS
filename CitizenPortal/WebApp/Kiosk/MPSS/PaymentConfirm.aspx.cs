...
namespace CitizenPortal.WebApp.Kiosk.Forms
{
    public partial class PaymentConfirm : System.Web.UI.Page
    {
            ...
            void SkipPaymentPay()
            {
                ...
                objTransaction_DT.CreatedBy = GetKioskIDPay();// HttpContext.Current.Session["KioskID"].ToString();
                ...
                string t_URL = "~/WebApp/Kiosk/MPSS/AcknowledgementMPBOC.aspx?SvcID=" + m_ServiceID + "&AppID=" + m_AppID + "&Status=Y";
            ...
            protected void btnSubmit_Click_old(object sender, EventArgs e)
            {
                ...
                try
                {
                    ...
                    if (m_UserType.ToUpper() == "CITIZEN")
                    {
                        ...
                        if (m_ServiceID == "388" && rbtSBIPay.Checked == true)
                        {
                            //lblSbi.Visible = true;
                            //if (rbtSBIPay.Checked == true)
                            {
                        ...
                        else if (rbtPGPay.Checked == true && !m_SkipPayment)
                        {
                            string result = "";
                            string[] AFields = {
                "ServiceID"
            ...
            private void SafeXPaymentGatewayPay()
            {
                string amount = "";
                string cust_name = "";
                string email_id = "";
                ...
                string m_ProfileID = "402.Bala";// Session["ProfileID"].ToString();
                string t_AppID = "";
                ...
                string udf_3 = "/WebApp/Kiosk/MPSS/AcknowledgementMPBOC.aspx";
                ...
                ObjRequest_DT.createdby = m_ProfileId;
