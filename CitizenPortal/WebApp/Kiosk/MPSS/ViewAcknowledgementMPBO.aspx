<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAcknowledgementMPBO.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.MPSS.ViewAcknowledgementMPBO" %>
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            ...
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>Acknowledgement Viewer</h2>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 box-container" runat="server" id="divCollege">
                    <div class="box-heading">
                        <h4 class="box-title register-num">Acknowledgement Filters
                        </h4>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 box-container">
                    ...
                    <div class="box-heading">
                        ...
                        <h4 class="box-title">Acknowledgement Data</h4>
                    </div>
                    <div class="box-body box-body-open">
