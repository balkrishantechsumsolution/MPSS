...
namespace CitizenPortal.WebApp.Kiosk.MenialStaff
{
    public partial class GroupD : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string InsertMenialData(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            MenialStaffProfile_DT viewModel = ToObjectFromJSON<MenialStaffProfile_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(binding))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertMenialData(viewModel);
                }
            }
        ...
        [WebMethod]
        public static string GetBatallionList(string prefix, string CategoryCode)
        {
            string URL = "";
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.GetBatallionList(CategoryCode);
