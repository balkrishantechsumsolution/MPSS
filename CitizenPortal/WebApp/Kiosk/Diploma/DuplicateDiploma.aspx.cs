...
{
    public partial class DuplicateDiploma : BasePage
    {
        ...
        [WebMethod]
        public static string InsertDuplicateDiploma(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            DuplicateDiploma_DT viewModel = ToObjectFromJSON<DuplicateDiploma_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertDuplicateDiploma(viewModel);
