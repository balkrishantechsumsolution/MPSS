...
{
    public partial class DiplomaMarkSheet : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt.Tables[0].Rows.Count != 0)
            {
                ...
                DataSet t_DS = m_DocumentVerification.DuplicateSemseterMarkSheet(RegNo, t_Semester, t_Year + t_Session);
                //DataSet t_DS = m_DocumentVerification.DuplicateSemseterMarkSheet("L14141004009", "02", "201605");
                ...
                if (t_DS.Tables[0].Rows.Count != 0)
                {
                    ...
                    //if (t_DS.Tables[0].Rows[0]["Status"].ToString() != "Wrong Input")
                    if (t_DS.Tables[0].Rows[0][0].ToString() != null && t_DS.Tables[0].Rows[0][0].ToString() != "" && t_DS.Tables[0].Rows[0][0].ToString() != "No Record Found")
                    {
                        DataTable t_Dt = t_DS.Tables[0];
                        DataTable t_Detail = t_DS.Tables[1];
                        ...
                        if (t_Dt.Rows.Count != 0)
                        {
                            ...
                            lblCenter.Text = t_Detail.Rows[0]["ExamCenterName"].ToString().ToUpper();
                            lblInstitute.Text = t_Detail.Rows[0]["InstituteName"].ToString().ToUpper();
                            lblSemester.Text = t_Detail.Rows[0]["Semester"].ToString().ToUpper();
                            lblBranch.Text = t_Detail.Rows[0]["Branch"].ToString().ToUpper();
                            lblName.Text = t_Detail.Rows[0]["StudentName"].ToString().ToUpper();
                            lblRegistration.Text = t_Detail.Rows[0]["RegistrationNumber"].ToString().ToUpper();
                            ...
                            if (t_Dt.Rows.Count != 0)
                            {
                                ...
                                {
                                    pnlGrid.Controls.Add(new LiteralControl("<tr>"));
                                    pnlGrid.Controls.Add(new LiteralControl("<td style='border-right:1px solid #000; border-bottom:1px solid #000; border-left:1px solid #000; padding:0 0 0 5px;'>" + t_Dt.Rows[i]["pcode"].ToString() + "</td>"));
                                    ...
                                    pnlGrid.Controls.Add(new LiteralControl("<td style='border-right:1px solid #000; border-bottom:1px solid #000; padding:0 5px 0 5px;text-align:right;'>" + t_Dt.Rows[i]["SemFullMark"].ToString() + "</td>"));
                                    pnlGrid.Controls.Add(new LiteralControl("<td style='border-right:1px solid #000; border-bottom:1px solid #000; padding:0 5px 0 5px;text-align:right;'>" + t_Dt.Rows[i]["InternalFullMark"].ToString() + "</td>"));
                                    pnlGrid.Controls.Add(new LiteralControl("<td style='border-right:1px solid #000; border-bottom:1px solid #000; padding:0 5px 0 5px;text-align:right;'>" + t_Dt.Rows[i]["TotalFullMark"].ToString() + "</td>"));
                                    pnlGrid.Controls.Add(new LiteralControl("<td style='border-right:1px solid #000; border-bottom:1px solid #000; padding:0 5px 0 5px;text-align:center;'>" + t_Dt.Rows[i]["TotalPassMark"].ToString() + "</td>"));
                                    pnlGrid.Controls.Add(new LiteralControl("<td style='border-right:1px solid #000; border-bottom:1px solid #000; padding:0 5px 0 5px;text-align:right;'>" + t_Dt.Rows[i]["SecuredMark"].ToString() + "</td>"));
                                    pnlGrid.Controls.Add(new LiteralControl("<td style='border-right:1px solid #000; border-bottom:1px solid #000; padding:0 5px 0 5px;text-align:right;'>" + t_Dt.Rows[i]["InternalSecured"].ToString() + "</td>"));
                                    pnlGrid.Controls.Add(new LiteralControl("<td style='border-right:1px solid #000; border-bottom:1px solid #000; padding:0 5px 0 5px;text-align:right;font-weight:bold;'>" + t_Dt.Rows[i]["Total"].ToString() + "</td>"));
                    ...
                    else { ChechInLegacyData(RegNo, t_Semester.Replace("0", ""), t_Year); }
                }
                else
                {
