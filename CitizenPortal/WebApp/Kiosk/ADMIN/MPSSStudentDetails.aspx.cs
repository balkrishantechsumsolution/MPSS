        ...
        void lb_Command(object sender, CommandEventArgs e)
        {
            if (e.CommandName == "Attachment")
            {
                ...
                if (i >= 0)
                {
                    ...
                    string newWin = "";
                    newWin = "window.open(\"/WebApp/Kiosk/MPSS/MPSSAttachmentShows.aspx?ID=" + ID + "&AppID=" + AppID + "&SvcID=1466&TypeID=2\", \"_blank\", \"WIDTH=1080,HEIGHT=790,scrollbars=no, menubar=no,resizable=yes,directories=no,location=no\");";
