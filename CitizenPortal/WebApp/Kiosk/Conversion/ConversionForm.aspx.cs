...
{
    public partial class ConversionForm : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            HFServiceID.Value = "165";
            ngServiceID.Value = "165";
        }
        ...
        [WebMethod]
        public static string InsertConversion(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            Conversion_DT viewModel = ToObjectFromJSON<Conversion_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertConversion(viewModel);
