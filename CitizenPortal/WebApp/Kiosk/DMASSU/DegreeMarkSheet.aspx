<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DegreeMarkSheet.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.DMASSU.DiplomaMarkSheet" %>
                                    ...
                                    <td style="vertical-align: top">
                                        <table cellpadding="0" cellspacing="0" style="width: 100%">
                                            ...
                                            <tr id="trFile" runat="server">
                                                <td style="">Download Semester Mark Sheet : <a href="#" id="lblDownload" runat="server"><asp:Label ID="lblfile" runat="server" Text="Click to download file"></asp:Label></a></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td>&nbsp;</td>
