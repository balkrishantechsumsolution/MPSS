...
{
    public partial class DMAS : System.Web.UI.Page //BasePage
    {
        string m_ServiceID = "";
        ...
        [WebMethod]
        public static string InsertDivisionalCertificate(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            DivisionalCertificate_DT viewModel = ToObjectFromJSON<DivisionalCertificate_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertDivisionalCertificate(viewModel);
