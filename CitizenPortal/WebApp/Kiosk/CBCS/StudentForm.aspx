<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="StudentForm.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.CBCS.StudentForm" %>
                    ...
                    <div class="box-body box-body-open">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-4">
                                    <input class="form-control" placeholder="Enter 12 digit Aadhaar Number" name="txtAadhaar" type="text" value="" id="UID" maxlength="16" onkeypress="return isNumberKey(event);" autofocus="" />
                                </div>
                        ...
                        <div class="form-group">
                            <table style="width: 100%; margin: 0;" class="table-striped table-bordered table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <input id="txtBoardRollNo" class="form-control" placeholder="Roll No" name="txtBoardRollNo" type="text" maxlength="10" onkeypress="return AlphaNumericHypenNSlash(event);" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <select name="ddlPassYr" id="txtPssngYr" class="form-control" data-val="true" data-val-number="Board" data-val-required="Please select." style="width: 70px">
                            ...
                            <table style="width: 100%; margin: 0;" class="table-striped table-bordered table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="txtBoardRollNo2" class="form-control" placeholder="Roll No" name="txtBoardRollNo2" type="text" maxlength="10" onkeypress="return AlphaNumericHypenNSlash(event);" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <select name="txtPssngYr2" id="txtPssngYr2" class="form-control" data-val="true" data-val-number="Board" data-val-required="Please select." style="width: 70px" >
                                                <option value="0">Select Year</option>
                                                <option value="1994">1994</option>
                                                <option value="1995">1995</option>
                                                <option value="1996">1996</option>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="col-xs-3 pleft0" id="DivCore1">
                                ...
                                <select id="ddlAP" class="form-control" style="display: none;">
                                    <option value="0">Select</option>
                                </select>
                                <input id="txtAP" type="text" class="form-control" disabled="disabled" />
                            </div>
                            <div class="col-xs-3" id="DivCore2">
                                <label class="manadatory" id="lblAP1">
                                </label>
                                <select id="ddlAP1" class="form-control" style="display: none;">
                                    <option value="0">Select</option>
                                </select>
                                <input id="txtAP1" type="text" class="form-control" disabled="disabled" />
                            </div>
                            <div class="col-xs-3" id="DivCore3">
                                <label class="manadatory" id="lblAP2">
                                    Choose Any one</label>
                                <select id="ddlAP2" class="form-control" style="display: none;">
                                    <option value="0">Select</option>
                                </select>
                                <input id="txtAP2" type="text" class="form-control" disabled="disabled" />
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3" id="DivGE">
                        <div class="form-group">
                            <label class="manadatory" id="lblGE">
                                GE</label>
                            <select id="ddlGE" name="GES" class="form-control" style="display: none;">
                                <option value="0">Select</option>
                            </select>
                            <input id="txtGE" type="text" class="form-control" disabled="disabled" />
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3" id="DivGEII">
                        <div class="form-group">
                            <label class="" id="lblGEII">
                                GE-II</label>
                            <select id="ddlGEII" name="GES" class="form-control" style="display: none;">
                                <option value="0">Select</option>
                            </select>
                            <input id="txtGEII" type="text" class="form-control" disabled="disabled" />
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-5 col-lg-3" id="DivMIL">
                        <div class="form-group">
                            <label class="manadatory" id="lblMIL">
                                MIL</label>
                            <select id="ddlMIL" class="form-control" style="display: none;">
                                <option value="0">Select</option>
                            </select>
                            <input id="txtMIL" type="text" class="form-control" disabled="disabled" />
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3" id="DivAECC">
                        <div class="form-group">
                            <label class="manadatory" id="AECC">
                                AECC</label>
                            <select id="ddlAECC" class="form-control" style="display: none;">
                                <option value="0">Select</option>
                            </select>
                            <input id="txtAECC" type="text" class="form-control" disabled="disabled" />
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3" id="DivSEC">
                        <div class="form-group">
                            <label class="manadatory" id="lblSEC">
                                SEC</label>
                            <select id="ddlSECB" class="form-control" style="display: none;">
                                <option value="0">Select</option>
                            </select>
                            <input id="txtSECB" type="text" class="form-control" disabled="disabled" />
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
        ...
        <div id="divBtn" class="row">
            <div class="col-md-12 box-container" style="margin-top: 5px;">
                <div class="box-body box-body-open" style="text-align: center;">
                    <input type="button" id="btnSubmit" class="btn btn-success" value="Register &amp; Proceed" title="Proceed to Upload Necessary Document" disabled="" onclick="SubmitDataByStudent();" />
