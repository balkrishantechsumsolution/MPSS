...
namespace CitizenPortal.WebApp.Kiosk.CBCS
{
    public partial class AdmissionProcessBar : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("/WebApp/Kiosk/Forms/Attachment.aspx?SvcID=" + m_ServiceID + "&AppID=" + m_AppID+ "&UID=" + Session["UID"], false);
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["UserType"].ToString() == "CITIZEN")
            {
                ...
                //Session["HomePage"] = "/WebApp/Kiosk/Forms/Attachment.aspx?SvcID=" + m_ServiceID + "&AppID=" + m_AppID;
