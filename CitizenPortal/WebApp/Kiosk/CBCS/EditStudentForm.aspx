<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="EditStudentForm.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.CBCS.EditStudentForm" %>
...
<head runat="server">
    ...
    <script src="/WebApp/Kiosk/CBCS/EditStudent.js?v=<%=CitizenPortal.Common.GlobalValues.JSVersion%>"></script>
            ...
            <div id="divBtn" class="row">
                <div class="col-md-12 box-container" style="margin-top: 5px;">
                    <div class="box-body box-body-open" style="text-align: center;">
                        <input type="button" id="btnSubmit" class="btn btn-success" value="Update" title="Update the Student details" disabled="" onclick="EditStudentData();" />
