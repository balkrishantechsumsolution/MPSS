...
function EditStudentData() {
    ...
    $.when(
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: '/WebApp/Kiosk/CBCS/EditStudentForm.aspx/EditStudentDatas',
            data: $.stringify(obj, null, 4),
            processData: false,
            dataType: "json",
            success: function (response) {
            ...
            if (AppID == "" || AppID == null) {
                ...
                if (status == "Success") {
                    ...
                    window.location.href = '/WebApp/Kiosk/CBCS/Acknowledgement.aspx?SvcID=449&AppID=' + obj.AppID;
...
function fnFetchUserDetails(AppID) {
    ...
    $.when(
      $.ajax({
          type: "POST",
          contentType: "application/json; charset=utf-8",
          url: '/WebApp/Kiosk/CBCS/EditStudentForm.aspx/GetApplicationDetails',
          data: '{"AppID":"' + AppID + '"}',
          processData: false,
          dataType: "json",
          success: function (response) {
