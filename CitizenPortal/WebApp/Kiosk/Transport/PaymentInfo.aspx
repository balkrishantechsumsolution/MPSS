<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="PaymentInfo.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.Transport.PaymentInfo" %>
        ...
        <div class="row">
            <div id="divPrint" class="container mtop10 hldshdw" style="padding-right: 0; padding-left: 0; width: 99%;">
                <div class="col-lg-12 wizard_hd">
                    <b style="font-size: 20px;">PAYMENT INFORMATION : ROAD TAX </b>
                </div>
