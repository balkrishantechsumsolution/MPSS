...
{
    public partial class Registration : System.Web.UI.Page// BasePage
    {
        ...
        [WebMethod]
        public static string InsertRegistrationReceipt(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            RegistrationReceipt_DT viewModel = ToObjectFromJSON<RegistrationReceipt_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertRegistrationReceipt(viewModel);
        ...
        [WebMethod]
        public static string GetSUBranchMaster(string prefix)
        {
            string URL = "";
