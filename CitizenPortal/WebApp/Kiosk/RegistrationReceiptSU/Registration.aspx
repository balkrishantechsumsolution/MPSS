<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.RegistrationReceiptSU.Registration" %>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                <div class="form-group">
                                    <label class="manadatory" for="ddlPrograme">
                                        Branch</label>
                                    <select name="ddlPrograme" id="ddlPrograme" class="form-control" data-val="true" data-val-number="">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label class="" for="txReason">
                                            Reason of Issuing of Registration Receipt</label>
