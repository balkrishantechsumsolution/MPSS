...
{
    public partial class FinancingAssistanceForm1 : BasePage
    {
        ...
        [WebMethod]
        public static string InsertFinancialAssistance(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            FinancialAssistance_DT viewModel = ToObjectFromJSON<FinancialAssistance_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                {  
                    ...
                    text = proxy.InsertFinancialAssistance(viewModel);
                }
            }
            return text;
        }
        ...
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static string InsertFinancialAssistance3(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            FinancialAssistance3_DT viewModel = ToObjectFromJSON<FinancialAssistance3_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertFinancialAssistance3(viewModel);
                }
            }
            return text;
        }
        ...
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        [WebMethod]
        public static string InsertFinancialAssistance4(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            FinancialAssistance4_DT viewModel = ToObjectFromJSON<FinancialAssistance4_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertFinancialAssistance4(viewModel);
                }
            }
            return text;
        }
