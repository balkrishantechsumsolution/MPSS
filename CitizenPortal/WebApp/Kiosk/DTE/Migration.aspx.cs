...
{
    public partial class Migration : BasePage
    {
        ...
        [WebMethod]
        public static string InsertMigration(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            Migration_DT viewModel = ToObjectFromJSON<Migration_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertMigration(viewModel);
        ...
        [WebMethod]
        public static string GetSemester(string prefix, string SvcID)
        {
            string URL = "";
