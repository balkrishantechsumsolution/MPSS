<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertificateVerification.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.VerificationSU.CertificateVerification" %>
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        <table class="nav-justified">
                                                            <tr>
                                                                <td>
                                                                    <img alt="Logo" src="/WebApp/Kiosk/Images/sambalpur-university-logo.png" style="width: 80px;" />
                                                                </td>
                                                                <td style="width: 100px;">&nbsp;</td>
                                                                <td colspan="3">
                                                                    <div style="vertical-align: top; text-align: center; font-size: 30px; font-weight: bold; color: #000435;">
                                                                        CHHATTISGARH SWAMI VIVEKANAD TECHNICAL UNIVERSITY
                                                                    </div>
                                                                    <div style="vertical-align: top; text-align: center; font-size: 20px; font-weight: bold; color: #000435;">
                                                                        Raipur, Chhattisgarh
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p>With reference to your Application No.
                                                                        ...
                                                                        on the subject cited above, I am to say that, on verification of records
                                                                        <asp:Label ID="lblStatus" runat="server" Font-Bold="True">available / not available</asp:Label>
                                                                        &nbsp;in this Council, the documnt(s) submited in respect of the folowing student has been verified found
                                                                        <asp:Label ID="lblGenuine" runat="server" Font-Bold="True">genuine / not genuine</asp:Label>
                                                                        .</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
