...
{
    public partial class DocumnetVerification : System.Web.UI.Page //BasePage
    {
        ...
        [WebMethod]
        public static string InsertDocumnetVerification(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            DocumentVerification_DT viewModel = ToObjectFromJSON<DocumentVerification_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertDocumnetVerification(viewModel);
