...
{
    public partial class CMRF : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            HFServiceID.Value = "112";
            ngServiceID.Value = "112";
        }
        ...
        [WebMethod]
        public static string InsertCMRF(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            CMRF_DT viewModel = ToObjectFromJSON<CMRF_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertCMRF(viewModel);
