<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertificateVerification.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.ITITranscript.CertificateVerification" %>
                                    ...
                                    <td style="vertical-align: top; height: 924px;">
                                        <div style="margin: 10px auto; width: 708px; font-size: 13px;">
                                            ...
                                            <table style="width: 100%">
                                                ...
                                                <tr>
                                                    <td colspan="3" style="text-align: center; font-size: 20px; font-weight: bold; color: #000000;">DOCUMENT VERIFICATION (ITI STUDENT)</td>
                                                </tr>
                                                <tr>
