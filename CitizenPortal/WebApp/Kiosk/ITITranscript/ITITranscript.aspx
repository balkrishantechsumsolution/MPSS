<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="ITITranscript.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.ITITranscript.ITITranscript" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="ITITramscript.js"></script>
    <style>
        .ui-widget-header {
            color: #333 !important;
