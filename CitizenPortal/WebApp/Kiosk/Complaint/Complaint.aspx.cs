...
namespace CitizenPortal.WebApp.Kiosk.Complaint
{
    public partial class Complaint : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string InsertComplaintRegistration(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            ComplaintRegistration_DT viewModel = ToObjectFromJSON<ComplaintRegistration_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertComplaintRegistration(viewModel);
