<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferCertificateSU.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.CTCSU.TransferCertificateSU" %>
                                    ...
                                    <td style="vertical-align: top; height: 924px;">
                                        <div style="margin: 10px auto; width: 708px; font-size: 13px;">
                                            ...
                                            <table style="width: 100%">
                                                ...
                                                <tr>
                                                    <td style="text-align: center; font-size: 32px; font-weight: bold; color: #000435;" colspan="3">CHHATTISGARH SWAMI VIVEKANAD TECHNICAL UNIVERSITY</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3">
                                                        <br />
                                                ...
                                                <tr>
                                                    <td colspan="3" style="text-align: center; font-size: 20px; font-weight: bold; color: #000000;">Raipur, Chhatisgarh</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="3" style="font-size: 20px; font-weight: bold;text-align: center">
                                                        <br />
                                                        <asp:Label ID="Label3" runat="server" Text="COLLEGE TRANSFER CERTIFICATE"></asp:Label>
                                                        <br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                        ...
                                                        <table style="line-height: 50px; width: 100%; text-align: justify; font-family: 'Monotype Corsiva'; font-size: 25px;">
                                                            <tr>
                                                                <td style="text-align: justify; vertical-align: middle;">
                                                                    ...
                                                                    ,&nbsp;&nbsp;
                                                                    <asp:Label ID="lblClass" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Arial" Font-Size="20px"></asp:Label>
                                                                    &nbsp;&nbsp; is informed that College / University has no objection to his / her transfer&nbsp;&nbsp; to&nbsp;&nbsp; any&nbsp;&nbsp; other&nbsp;&nbsp; College&nbsp;&nbsp; of&nbsp;&nbsp; the&nbsp;&nbsp;&nbsp;University&nbsp;&nbsp;&nbsp; for&nbsp;&nbsp;&nbsp; further&nbsp;&nbsp;&nbsp; studies.</td>
                                                            </tr>
                                                            <tr>
                                                                <td style="text-align: justify;line-height: 30px; vertical-align: middle;">&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td style="text-align: justify; vertical-align: middle;">During&nbsp;&nbsp; his / her&nbsp;&nbsp; admission&nbsp;&nbsp; he / she&nbsp;&nbsp; was&nbsp; offered&nbsp;&nbsp; following&nbsp;&nbsp; subjects&nbsp;&nbsp; &nbsp;
                                                                    <asp:Label ID="lblsubjects" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Arial" Font-Size="20px"></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" style="float: right;line-height:22px;">
                                                        <tr>
                                                            <td style="text-align: center; white-space: nowrap">
                                                                <img alt="Logo" src="/WebApp/Kiosk/Images/SECRETARYSCTEVT.png" style="width: 120px;" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="text-align: center;">
                                                                <asp:Label ID="Label16" runat="server" Style="font-weight: bold;" Text="PRINCIPAL"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="text-align: center;">
                                                                <asp:Label ID="lblCollege" runat="server" Text="CollegeName"></asp:Label>
                                                                <br />
                                                                <asp:Label ID="Label12" runat="server" Text="Chhattisgarh Swami Vivekanad Technical University, Raipur"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table></td>
                                                <td style="width: 40px;">&nbsp;</td>
