...
namespace CitizenPortal.WebApp.Kiosk.CTCSU
{
    public partial class Acknowledgement : CommonBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet dt = m_TransferSUBLL.GetCollegeTransferSU(m_ServiceID, m_AppID);
            ...
            if (dt.Tables[0].Rows.Count != 0)
            {
                ...
                lblJoiningCollege.Text = dtApp.Rows[0]["JoiningCollege"].ToString();
                ...
                lblJoiningProg.Text = dtApp.Rows[0]["JoiningProgram"].ToString();
                lblJoiningClass.Text = dtApp.Rows[0]["JoiningClass"].ToString();
