<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acknowledgement.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.Enrolement.Acknowledgement" %>
...
<body>
    <form id="form1" runat="server">
        <div id="divPrint" style="margin: 0 auto; width: 800px;">
            <div style="width: 794px; font-family: Arial; font-size: 11px; border: 3px solid #212121; padding: 2px; margin: 0 auto;">
                <div style="width: 792px; font-size: 11px; border: 1px solid #000; background-image: url('/WebApp/Kiosk/images/Sambalpur_UniversityLogo.png'); background-size: 590px; background-repeat: no-repeat; background-position: center center; -webkit-print-color-adjust: exact;">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="text-align: left; padding: 3px 5px;">
                                            <img src="/Sambalpur/img/sambalpur-university-logo.png" alt="Chhattisgarh Swami Vivekanad Technical University,Odisha" style="width: 105px; height: 90px;" /></td>
                    ...
                    <div style="text-align: center; font-size: 20px; font-weight: bolder; padding: 5px; text-transform: uppercase; background-color: #6C4B3C; color: #fff;">
                        ...
                        <span style="font-size: 20px">ACKNOWLEDGEMENT FOR ENROLLMENT OF BATCH - 2016-17</span>
                    </div>
                    <%----------End title section ---------%>
                    ...
                    <div style="margin: 0; width: 100%; height: auto; font-size: 12px;">
                                ...
                                <td style="vertical-align: top;">
                                    <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; margin: 0;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left; font-size: 11px; font-weight: bold">Roll No.</td>
                                            <td style="padding: 5px; border: 1px solid #ccc; text-align: left; font-size: 11px;">
                                                <asp:Label ID="lblRollNo" runat="server"></asp:Label>
                                            </td>

                                           
                                             <td style=" display:none;padding: 5px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left; font-size: 11px;" class="auto-style1"><b>Aadhaar Number</b></td>
                                            <td style="display:none;padding: 5px; border: 1px solid #ccc; color: #383E4B; text-align: left; font-size: 11px;">
                        ...
                        <table width="600" id="tblSubjectList" cellpadding="5" cellspacing="0" class="table-bordered" style="width: 98%; border: 1px solid #ccc; margin: 0 auto;" runat="server">
                            <tr>
        ...
        <div style="color: maroon; font-size: 20px; text-align: center; margin: 10px 10px;">
            Please take a printout of this Acknowledgement along with the documents and submit it to your college to complete the Enrollment process.        
        </div>
        <br />
