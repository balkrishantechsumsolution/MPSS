<%@ Page Title="" Language="C#" MasterPageFile="~/Sambalpur/master/Home.Master" AutoEventWireup="true" CodeBehind="AdmissionProcessBar.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.Enrolement.AdmissionProcessBar" %>
            ...
            <div id="divPrint" class="container mtop10 hldshdw" style="padding-right: 0; padding-left: 0; width: 99%;">
                ...
                <div>
                    <div class="wizard_inston text-left">
                        ...
                        <br />
                            3. Make payment against the Application Number
                    ...
                    <p style="color: maroon !important; width: 90%; margin: 0 auto; font-family: Arial; text-align: center; font-size: 20px;">
                        ...
                        <br />
                        CAP Portal - <b style="font-size: 25px; color: maroon !important;">www.sambalpur.lokaseba-odisha.in </b>
                    </p>
                </div>
