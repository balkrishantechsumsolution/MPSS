...
{
    public partial class AdmissionProcessBar : System.Web.UI.Page
    {
        string m_AppID, m_ServiceID, UID = "";
        string m_UserType;
        ...
        {
            Response.Redirect("/WebApp/Kiosk/Forms/Attachment.aspx?SvcID=" + m_ServiceID + "&AppID=" + m_AppID, false);
        }
