...
namespace CitizenPortal.WebApp.Kiosk.ITIMigration
{
    public partial class MigrationITI : BasePage
    {
        ...
        [WebMethod]
        public static string InsertMigrationITI(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            MigrationITI_DT viewModel = ToObjectFromJSON<MigrationITI_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertMigrationITI(viewModel);
