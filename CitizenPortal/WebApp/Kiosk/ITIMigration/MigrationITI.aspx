<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="MigrationITI.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.ITIMigration.MigrationITI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="MigrationITI.js"></script>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    <label class="manadatory" for="ddlBranch">
                                        Trade Name</label>
                                    <select name="ddlBranch" id="ddlBranch" class="form-control" data-val="true" data-val-number="" data-val-required="Please select Trade Name">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" data-val="true" data-val-number="ddlReason"
                                        ...
                                        <option value="Passed Diploma">ITI Passed</option>
                                        <option value="102">ITI Discontinue</option>
