...
{
    public partial class AcknowledgementFarmerReg : System.Web.UI.Page
    {
        FarmerRegistrationBLL m_FarmerRegistrationBLL = new FarmerRegistrationBLL();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet dt = m_FarmerRegistrationBLL.GetFarmerRegistration(m_ServiceID, m_AppID);
            ...
            if (dt.Tables[0].Rows.Count != 0)
            {
                ...
                TokenNo.Text = dtApp.Rows[0]["AppID"].ToString();
                ...
                lblFather.Text = dtApp.Rows[0]["FatherName"].ToString();
                lbldistrict.Text = dtApp.Rows[0]["PDistrictCode"].ToString();
                lblblock.Text = dtApp.Rows[0]["PBlockCode"].ToString();
                lblGramPanchayat.Text = dtApp.Rows[0]["PGramPanchayat"].ToString();
                lblPVillageCode.Text = dtApp.Rows[0]["PVillageCode"].ToString();
                lblapplicant_address.Text = dtApp.Rows[0]["FullAddress"].ToString();

                lblNameofhof.Text = dtApp.Rows[0]["NameofHOF"].ToString();
                lblFather.Text = dtApp.Rows[0]["FatherName"].ToString();
                lblDOB.Text = Convert.ToDateTime(dtApp.Rows[0]["DOB"]).ToString("dd/MM/yyyy");
                lblage.Text = dtApp.Rows[0]["Age"].ToString();
                lblGender.Text = dtApp.Rows[0]["Gender"].ToString();
                lblrelationwithhof.Text = dtApp.Rows[0]["RelationwithHOF"].ToString();
                lblvoterid.Text = dtApp.Rows[0]["VoterIDCardNo"].ToString();
                lblCategory.Text = dtApp.Rows[0]["Category"].ToString();
                lbldist.Text = dtApp.Rows[0]["DDistrict"].ToString();
                lbltaluka.Text = dtApp.Rows[0]["DTaluka"].ToString();
                lblvillage.Text = dtApp.Rows[0]["DVillage"].ToString();
