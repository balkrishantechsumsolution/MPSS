...
{
    public partial class PensionForm : BasePage
    {
        string UID = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            HiddenAge.Value = dt.Rows[0]["dateOfBirth"].ToString();
            Hiddengender.Value = dt.Rows[0]["gender"].ToString();


            Session["CurrentCulture"] = culture;
            HFServiceID.Value = "106";
            ngServiceID.Value = "106";
        ...
        [WebMethod]
        public static string InsertMBPY(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            MBPY_DT viewModel = ToObjectFromJSON< MBPY_DT >(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertMBPY(viewModel);
