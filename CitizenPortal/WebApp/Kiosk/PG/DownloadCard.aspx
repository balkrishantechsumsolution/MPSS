<%@ Page Title="" Language="C#" MasterPageFile="~/Sambalpur/master/Home.Master" AutoEventWireup="true" CodeBehind="DownloadCard.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.PG.DownloadCard" %>
            ...
            <div id="page-wrapper" style="min-height: 311px; width: 80%; margin: 0 auto;">
                ...
                <div class="clearfix">
                    ...
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>
                        Access Admit Card of SU PG &amp; M.Tech Course - 2018
                    </h2>
                </div>
                <div class="row" id="divCitizenProfile">
                    <div id="" class="col-md-12">
                        ...
                        <div runat="server" class="danger error bg-warning" id="divErr">
                            Please enter Date of Birth, Mobile Number (Mandatory) and any one of Roll Number or Application Number or Old Roll Number fields to access Admit Card.
                        </div>
                        <div class="row">
                                ...
                                <div class="box-body box-body-open">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox runat="server" ID="txtBirthDate" CssClass="form-control" placeholder="DD/MM/YYYY" name="txtBirthDate" value="" MaxLength="10" AutoCompleteType="Disabled"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <label class="manadatory" for="txtMobile">
                                                Mobile Number</label>
                                            <asp:TextBox runat="server" ID="txtMobile" class="form-control" placeholder="Registered mobile no" name="txtMobile" value="" MaxLength="10" onkeypress="return isNumberKey(event);" AutoCompleteType="Disabled"></asp:TextBox>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <label class="" for="txtRollNO">
                                                Roll Number</label>
                                            <asp:TextBox runat="server" ID="txtRollNO" CssClass="form-control" placeholder="Enter Roll No" name="txtRollNO" value="" MaxLength="14"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <label class="" for="txtLogin">
                                                Old Roll Number</label>
                                            <asp:TextBox runat="server" ID="txtLogin" class="form-control" placeholder="Enter Old Roll Number (Previous Year Applicant)" name="txtLogin" value="" MaxLength="14"></asp:TextBox>
