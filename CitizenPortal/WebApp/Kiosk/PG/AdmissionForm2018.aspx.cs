...
{
    public partial class AdmissionForm2018 : BasePage
    {
        ...
        [WebMethod]
        public static string GetSUCollege(string SelCollege)
        {
            string URL = "";
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.GetSUCollegeList();
                }
            }
            return text;
        }
        [WebMethod]
        public static string GetSUDepartmentList(string CollegeCode)
        {
            string URL = "";
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.GetSUDepartmentList(CollegeCode);
                }
            }
            return text;
        }
        ...
        [WebMethod]
        public static string GetSUSubjectList(string DepartmentCode)
        {
            string URL = "";
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.GetSUSubjectList(DepartmentCode);
                }
            }
            return text;
        }
        ...
        public static string InsertData(string prefix, string Data)
        {
            ...
            SUPGAdmission_DT viewModel = ToObjectFromJSON<SUPGAdmission_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(binding))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertPGAdmissionFormData(viewModel);
                }
            }
        ...
        [WebMethod]
        public static string GetProgramList(string DepartmentCode,string CourseType)
        {
            string URL = "";
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.GetProgramList(DepartmentCode, CourseType);
                }
            }
            return text;
        }
        [WebMethod]
        public static string GetEligibilityCriterea(string ProgramId)
        {
            string URL = "";
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.GetEligibilityCriterea(ProgramId);
                }
            }
            return text;
        }
