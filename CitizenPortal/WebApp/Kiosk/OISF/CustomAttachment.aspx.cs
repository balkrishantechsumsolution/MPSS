...
{
    public partial class CustomAttachment : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            btnHome.PostBackUrl = "/WebApp/Kiosk/OISF/OISFHome.aspx?" + Request.QueryString.ToString();
        ...
        public void fnFillUploadedDocumentCustom()
        {

            DocumentBriefcaseBLL t_DocumentBriefcaseBLL = new DocumentBriefcaseBLL();
            DataTable dtDoc = t_DocumentBriefcaseBLL.GetSavedDocumentDetailsCustom(m_ProfileID, "", m_ServiceID, m_AppID);
        ...
        protected void btnNext_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Response.Redirect("/WebApp/Kiosk/OISF/OISFHome.aspx?" + Request.QueryString.ToString());
                }
            }
            catch (Exception ex)
            {
