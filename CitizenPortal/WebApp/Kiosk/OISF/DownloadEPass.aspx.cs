...
{
    public partial class DownloadEPass : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                string m_Message = "Please enter Applicant Date of Birth, Registered Mobile Number to download E-Pass.";
            ...
            if (txtRollNO.Text == "" && txtLogin.Text == "" && txtBirthDate.Text == "" && txtAppID.Text == "" && txtMobile.Text == "") {
                string m_Message = "Please enter at least three fields to Download E-Pass";
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('" + m_Message + "');", true);
                return;
            }
            ...
            if (captcha.Text == "")
            {
                string m_Message = "Please enter captcha to download E-Pass";
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('" + m_Message + "');", true);
                return;
            }
            ...
            {
                string m_Message = "Invalid Captcha. Please Refresh the Page to download E-Pass";
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('" + m_Message + "');", true);
                return;
            }
            ...
            try
            {
                ...
                if (t_Result != null && t_Result.Rows.Count > 0)
                {
                    if (t_Result.Rows[0]["Result"].ToString() != "")
                    {
                        ...
                        Response.Redirect("/WebApp/Kiosk/OISF/PhysicalPass.aspx?SvcID=" + m_ServiceID + "&AppID=" + m_AppID);
                    }
                    else
                    {                        
                        string m_Message = "Sorry! Your E-Pass not announced. You will be informed about the Examination Date and Venus through SMS and Email";
                ...
                {
                    string m_Message = "No record found againt the data entered. Please enter correct information to Download E-Pass.";
                    divErr.InnerHtml = m_Message;
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('" + m_Message + "');", true);
                }
            }
