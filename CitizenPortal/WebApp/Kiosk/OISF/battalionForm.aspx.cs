...
{
    public partial class battalion : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string svc = Request.QueryString["SvcID"].ToString();
        ...
        public static string InsertData(string prefix, string Data)
        {
            ...
            OISFProfile_DT viewModel = ToObjectFromJSON<OISFProfile_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(binding))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertOISFProfileDataOffLine(viewModel);
        ...
        [WebMethod]
        public static string GetRTOList(string prefix, string DistrictCode)
        {
            string URL = "";
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.GetRTOList("", DistrictCode);
                }
            }
        ...
        [WebMethod]
        public static string GetPoliceStation(string prefix, string StateCode, string DistrictCode)
        {
            string URL = "";
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.GetPoliceStation("", StateCode, DistrictCode);
                }
            }
            return text;
        }
