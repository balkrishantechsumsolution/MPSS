...
namespace CitizenPortal.WebApp.Kiosk.OISF
{
    public partial class ScoreSheet : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                t_Result = m_OISFBLL.GetOISFGradeSheet(txtLogin.Text, BirthDate, txtAppID.Text, txtMobile.Text, txtRollNO.Text);
                ...
                if (t_Result != null && t_Result.Rows.Count > 0)
                {
                    if (t_Result.Rows[0]["Result"].ToString() != "")
                    {
                        ...
                        Response.Redirect("/WebApp/Kiosk/OISF/MarkSheet.aspx?SvcID=" + m_ServiceID + "&AppID=" + m_AppID);
                    }
                    else
                    {                        
