...
{
    public partial class Constable : System.Web.UI.Page
    {
        string UID = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            HFAge.Value = dt.Rows[0]["dateOfBirth"].ToString();
        ...
        [WebMethod]
        public static string InsertConstable(string prefix, string Data)
        {
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertConstableData(viewModel);
                }
            }
