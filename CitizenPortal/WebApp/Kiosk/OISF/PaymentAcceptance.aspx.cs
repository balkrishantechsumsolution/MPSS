...
{
    public partial class PaymentAcceptance : BasePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                t_Result = m_OISFBLL.SubmitPayment(m_ServiceID, m_AppID, Session["CitizenID"].ToString(), "Citizen", txtSBIRef.Value);
