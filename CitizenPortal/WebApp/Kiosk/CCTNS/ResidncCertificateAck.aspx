<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResidncCertificateAck.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.CCTNS.ResidncCertificateAck" %>
                    ...
                    <div style="margin: 0 auto; height: auto; width: 794px; border: 3px solid #000; padding: 1px; font-family: Arial">
                        <div style="margin: 0 auto; height: auto; width: 785px; border: 1px solid #000; background-image: url('../images/bgLogo.png'); background-image: url('../images/bgLogo.png'); background-size: 590px; background-repeat: no-repeat; background-position: center center;">
                            ...
                            <div style="text-align: center; font-size: 20px; font-weight: bolder; padding: 5px; text-transform: uppercase; background-color: #808080; color: #fff;">
                                <asp:Label runat="server" ID="lblCertificateName" Style="font-size: 20px; font-weight: bolder; text-transform: uppercase;">Residence Application Acknowledgement</asp:Label>
                                <br />
                            ...
                            <div style="margin: 10px auto; width: 708px; font-size: 13px;">
                                ...
                                <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; border: 0;">
                                    ...
                                    <tr>
                                        <%--<td style="padding: 5px; border: 1px solid #999; text-align: left; width: 135px; white-space: nowrap">
                                            <asp:Label ID="Label5" runat="server" Text="Application Number"></asp:Label>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 135px; word-wrap: break-word;">
                                            <b>
                                        ...
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 120px; word-wrap: break-word;">
                                            <b>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 120px;">
                                            <b>
                                                <asp:Label ID="lblFather1" runat="server">Marital Status</asp:Label></b>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; word-wrap: break-word;">
                                    ...
                                    <tr>
                                        ...
                                        <td  style="padding: 5px; border: 1px solid #999; text-align: left; width: 150px; word-wrap: break-word;">
                                        ...
                                        <td colspan="2" style="padding: 5px; border: 1px solid #999; text-align: left; width: 150px; word-wrap: break-word;">
                                            <asp:Label ID="lblPurpose" runat="server"></asp:Label>
                                        </td>

                                    </tr>
                                    <tr id="trSpose" runat="server">
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 120px;">
                                            <b>
                                                <asp:Label ID="Label13" runat="server" Text="Spouse Name"></asp:Label></b>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 150px; word-wrap: break-word;">
                                        ...
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 120px;">
                                            <b>
                                                <asp:Label ID="Label15" runat="server" Text="Relation with Beneficiary"></asp:Label></b>
                                        </td>
                                        <td colspan="2" style="padding: 5px; border: 1px solid #999; text-align: left; width: 150px; word-wrap: break-word;">
                                            <asp:Label ID="lblRelSpouse" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                ...
                                <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; border: 0;">
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 70%;">
                                            <b>
                                                <asp:Label ID="Label6" runat="server" Text="Applicant is able to read,write & speak in Oriya?"></asp:Label></b>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;">
                                            <asp:Label ID="lblOdiya" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 120px;">
                                            <b>
                                                <asp:Label ID="Label14" runat="server" Text="Applicant has passed Oriya up to M.E. Standard?"></asp:Label></b>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 150px;">
                                            <asp:Label ID="lblME" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 120px;">
                                            <b>
                                                <asp:Label ID="Label8" runat="server" Text="Number of years the applicant is residing in the on provided Address."></asp:Label></b>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 150px;">
                                            <asp:Label ID="lblAddrY" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                                <br />
                                <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; border: 0;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 75px;">
                                            <b>
                                                <asp:Label ID="Label17" runat="server">Tehsil</asp:Label></b>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;">
                                            <asp:Label ID="lblTehsil" runat="server" Font-Size="15px"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 75px;">
                                            <b>
                                                <asp:Label ID="Label30" runat="server">RI</asp:Label></b>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;">
                                            <asp:Label ID="lblRI" runat="server" Font-Size="15px"></asp:Label>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 75px;">
                                            <b>
                                                <asp:Label ID="Label32" runat="server">Block</asp:Label></b>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;">
                                    ...
                                    <tr>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; width: 75px;">
                                            <b>
                                                <asp:Label ID="Label18" runat="server">Area</asp:Label></b>
                                        </td>
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left;">
                                ...
                                <table id="tblPlotDtl" runat="server" cellpadding="0" cellspacing="0" width="100%" style="padding-top: 10px; margin-top: 20px">
                                    <tr style="width: 100%; border: 0; background-color: #c1c1c1">
                                        <td style="padding: 5px; border: 1px solid #999; text-align: left; border-bottom: none;" colspan="3"><b>Plot Details</b></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:GridView runat="server" ID="grdPlotDtl" AllowPaging="true" PageSize="10" AutoGenerateColumns="false" Width="100%" CssClass="p5">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="PlotNo" HeaderText="Plot No." ItemStyle-Width="30%" />
                                                    <asp:BoundField DataField="AreaAcre" HeaderText="Area (In Acre)" ItemStyle-Width="20%" />
                                                    <asp:BoundField DataField="Kisam" HeaderText="Kisam" ItemStyle-Width="30%" />
                                                </Columns>
                                            </asp:GridView>
                                        </td>
                                    </tr>
