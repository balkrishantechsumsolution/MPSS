...
namespace CitizenPortal.WebApp.Kiosk.MigrationSU
{
    public partial class Acknowledgement : CommonBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet dt = m_MigrationSUBLL.GetMigrationSU(m_ServiceID, m_AppID);
            ...
            if (dt.Tables[0].Rows.Count != 0)
            {
                ...
                lblJoiningUniv.Text = dtApp.Rows[0]["JoiningUniversity"].ToString();
                ...
                mySign.Src = dtApp.Rows[0]["ImageSign"].ToString();
