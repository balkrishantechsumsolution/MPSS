<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MigrationCertificateSU.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.MigrationSU.MigrationCertificateSU" %>
                                    ...
                                    <td style="vertical-align: top; height: 924px;">
                                        <div style="margin: 10px auto; width: 708px; font-size: 13px;">
                                            ...
                                            <table style="width: 100%">
                                                ...
                                                <tr>
                                                    <td style="text-align: center; " colspan="3" class="auto-style1">SAMBALPUR UNIVERSITY</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3">
                                                        <br />
                                                        ...
                                                        <table style="line-height: 50px; width: 100%; text-align: justify; font-family: 'Monotype Corsiva'; font-size: 25px;">
                                                            <tr>
                                                                <td style="text-align: justify; vertical-align: middle;">
                                                                    ...
                                                                    &nbsp;&nbsp;&nbsp;&nbsp; is informed that College / University has no objection to his/her migration to any other State Board / Council / University for further higher studies.</td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" style="float: right;line-height:22px;">
                                                        <tr>
                                                            <td style="text-align: center; white-space: nowrap">
                                                                <img alt="Logo" src="/WebApp/Kiosk/Images/AssControler.png" style="width: 120px;" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="text-align: center;">
                                                                <asp:Label ID="Label16" runat="server" Style="font-weight: bold;" Text="Asst. Controler of Examination"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="text-align: center;">
                                                                <asp:Label ID="Label12" runat="server" Text="Sambalpur University
&lt;br/&gt;Jyoti Vihar, Burla,&lt;br/&gt;Sambalpur, Odisha "></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table></td>
                                                <td style="width: 40px;">&nbsp;</td>
