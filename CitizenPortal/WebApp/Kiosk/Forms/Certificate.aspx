<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/Kiosk/Master/KioskMaster.Master" AutoEventWireup="true" CodeBehind="Certificate.aspx.cs" Inherits="CitizenPortal.WebApp.Kiosk.Forms.Certificate" %>
        ...
        <div class="row" style="margin-top: 25px;">
            <div class="col-md-12 box-container mTop15">
                <div class="box-heading">
                    <h4 class="box-title register-num" runat="server" id="SvcName">Certificate
                    </h4>
                </div>
