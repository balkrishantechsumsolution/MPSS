...
{
    public partial class CBAReport : AdminBasePage
    {
        ...
        {            
            ...
            try
            {
                ...
                t_DT = m_FacultyModuleBLL.GetCBAReport(Session["LoginID"].ToString(), ddlCollege.SelectedValue,ddlCourse.SelectedValue, ddlProgram.SelectedValue,
