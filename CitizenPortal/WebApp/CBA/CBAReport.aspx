<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="CBAReport.aspx.cs" Inherits="CitizenPortal.WebApp.CBA.CBAReport " %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    ({
        ...
        function TakeAction(p_ServiceID, p_AppID, p_URL) {
            ...
            t_URL = t_URL;
            window.open(t_URL, 'View', 'height=' + screen.height + ',width=1500,titlebar=no,menubar=no,status=yes,toolbar=no,scrollbars=yes,resizable=yes');
            return false;
        }
            ...
            <div class="row" id="div1" runat="server">
                <div class="row">
                    <div class="col-lg-12 cscPgehd">
                        <h2 class="form-heading"> Counter Based Application</h2>
                    </div>
                </div>
                <%---Start of Filter----%>
                <div class="row">
