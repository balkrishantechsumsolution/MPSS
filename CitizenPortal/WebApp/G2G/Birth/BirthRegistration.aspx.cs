...
namespace CitizenPortal.WebApp.G2G.Birth
{
    public partial class BirthRegistration : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            HFServiceID.Value = "993";
        }
        ...
        [WebMethod]
        public static string InsertBirthRegistration(string prefix, string Data)
        {
            string noNewLines = Data.Replace("\n", "");
            BirthRegistration_DT viewModel = ToObjectFromJSON<BirthRegistration_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(new BasicHttpBinding()))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.InsertBirthRegistration(viewModel);
