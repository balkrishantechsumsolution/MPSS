<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="BulkPayPendingPaper.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.BulkPayment.BulkPayPendingPaper" %>
                        ...
                        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlExamType" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem Value="2" Text="Back" Selected="True"></asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlPayStatus" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem Value="N" Text="UnPaid" Selected="True"></asp:ListItem>
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="HdfPendingPaperCnt" runat="server" Value='<%#Eval("PendingPaperCnt") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField DataField="PendingPaperCnt" HeaderText="Fail Paper Count" />
                                            <asp:BoundField DataField="AmountPaid" HeaderText="Amount Paid" />
                                            <asp:BoundField DataField="TotalAmount" HeaderText="Pending Amt. To Be Paid" />
                                            ...
                                            <asp:TemplateField HeaderText="View">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="View" runat="server" NavigateUrl='<%# "/WebApp/G2G/Bulkpayment/Acknowledgement.aspx?AppID=" + Eval("CurrentAppID") + "&SvcID=1453"+"&StatusFlag="+Eval("CurrentStatus") %>' Text="Receipt"
