...
{
    public partial class frmPMEventEntry : System.Web.UI.Page
    {
...

        {
            ...
            DataSet ds = obj.GetOISFAppDetails("OP15", drpCenter.SelectedValue.ToString(), drpday.SelectedValue.ToString(), drpRange.SelectedValue, "", drpEventType.SelectedValue, "", "", "", "", "");
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj.GetOISFAppDetails("OP17", drpCenter.SelectedValue, drpday.SelectedValue, drpRange.SelectedValue, txtSearch.Text, drpEventType.SelectedValue, "", "", "", "", "");
        ...
        protected void grdDriving_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                int ActualRowIndex = (pagesize * pageindex) + e.Row.RowIndex;
                DropDownList drpDrivingvalue = (DropDownList)e.Row.FindControl("drpDriving");
                drpDrivingvalue.SelectedValue = dtGlobal.Rows[ActualRowIndex]["DLValue"].ToString();
            }
        ...
        protected void btnDisqualifyBulk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (drpEventType.SelectedValue == "1")
                {
                    foreach (GridViewRow grd in grdBioMetric.Rows)
                    {
                        CheckBox chkSelectValue = (CheckBox)grd.FindControl("ChkSelect");
                        if (chkSelectValue.Checked)
                        {


                            selectAny = true;
                            HiddenField hdnAppNo = (HiddenField)grd.FindControl("hdnAppNo");
                            DropDownList drpBioMetrixvalue = (DropDownList)grd.FindControl("drpBioMetrix");
                            TextBox txtRemarksvalue = (TextBox)grd.FindControl("txtRemarks");
                            Label lblRollNumberValue = (Label)grd.FindControl("lblRollNumber");
                ...
                else if (drpEventType.SelectedValue == "2")
                {
                    ...
                    foreach (GridViewRow grd in grdReport.Rows)
                    {
                        CheckBox chkSelectValue = (CheckBox)grd.FindControl("ChkSelect");
                        if (chkSelectValue.Checked)
                        {
                            selectAny = true;
                            HiddenField hdnAppNo = (HiddenField)grd.FindControl("hdnAppNo");
                            TextBox txtHeightValue = (TextBox)grd.FindControl("txtHeight");
                            TextBox txtWeightValue = (TextBox)grd.FindControl("txtWeight");
                            TextBox txtChestExpValue = (TextBox)grd.FindControl("txtChestExp");
                            TextBox txtChestUnExpValue = (TextBox)grd.FindControl("txtChestUnExp");
                            TextBox txtRemarksValue = (TextBox)grd.FindControl("txtRemarks");
                ...
                else if (drpEventType.SelectedValue == "3")
                {
                    ...
                    foreach (GridViewRow grd in grdMedical.Rows)
                    {
                        CheckBox chkSelectValue = (CheckBox)grd.FindControl("ChkSelect");
                        if (chkSelectValue.Checked)
                        {
                            ...
                            HiddenField hdnAppNo = (HiddenField)grd.FindControl("hdnAppNo");
                            DropDownList drpFitnessvalue = (DropDownList)grd.FindControl("drpFitness");
                            TextBox txtRemarksvalue = (TextBox)grd.FindControl("txtRemarks");
                ...
                else if (drpEventType.SelectedValue == "4")
                {
                    ...
                    foreach (GridViewRow grd in grdHighJump.Rows)
                    {
                        CheckBox chkSelectValue = (CheckBox)grd.FindControl("ChkSelect");
                        if (chkSelectValue.Checked)
                        {
                            ...
                            HiddenField hdnAppNo = (HiddenField)grd.FindControl("hdnAppNo");
                            DropDownList drpHighjump1value = (DropDownList)grd.FindControl("drpHighjump1");
                            DropDownList drpHighjump2value = (DropDownList)grd.FindControl("drpHighjump2");
                            DropDownList drpHighjump3value = (DropDownList)grd.FindControl("drpHighjump3");
                            TextBox txtRemarksvalue = (TextBox)grd.FindControl("txtRemarks");
                            Label lblRollNumberValue = (Label)grd.FindControl("lblRollNumber");
                ...
                else if (drpEventType.SelectedValue == "5")
                {
                    ...
                    foreach (GridViewRow grd in grdBroadJump.Rows)
                    {
                        CheckBox chkSelectValue = (CheckBox)grd.FindControl("ChkSelect");
                        ...
                        if (chkSelectValue.Checked)
                        {
                            ...
                            HiddenField hdnAppNo = (HiddenField)grd.FindControl("hdnAppNo");
                            DropDownList drpdrpBroadjump1value = (DropDownList)grd.FindControl("drpBroadjump1");
                            DropDownList drpdrpBroadjump2value = (DropDownList)grd.FindControl("drpBroadjump2");
                            DropDownList drpdrpBroadjump3value = (DropDownList)grd.FindControl("drpBroadjump3");
                            DropDownList drpdrpBroadjump4value = (DropDownList)grd.FindControl("drpBroadjump4");
                            TextBox txtRemarksvalue = (TextBox)grd.FindControl("txtRemarks");
                            Label lblRollNumberValue = (Label)grd.FindControl("lblRollNumber");
                ...
                else if (drpEventType.SelectedValue == "6")
                {
                    ...
                    foreach (GridViewRow grd in grdRopeClimbing.Rows)
                    {
                        CheckBox chkSelectValue = (CheckBox)grd.FindControl("ChkSelect");
                        ...
                        if (chkSelectValue.Checked)
                        {
                            ...
                            HiddenField hdnAppNo = (HiddenField)grd.FindControl("hdnAppNo");
                            DropDownList drpRopeClimbingvalue = (DropDownList)grd.FindControl("drpRopeClimbing");
                ...
                else if (drpEventType.SelectedValue == "7")
                {
                    ...
                    foreach (GridViewRow grd in grdRunning.Rows)
                    {
                        CheckBox chkSelectValue = (CheckBox)grd.FindControl("ChkSelect");


                        HiddenField hdnAppNo = (HiddenField)grd.FindControl("hdnAppNo");
                        DropDownList drpRunningvalue = (DropDownList)grd.FindControl("drpRunning");
                ...
                else if (drpEventType.SelectedValue == "8")
                {
                    ...
                    foreach (GridViewRow grd in grdCrossCountry.Rows)
                    {
                        CheckBox chkSelectValue = (CheckBox)grd.FindControl("ChkSelect");
                        if (chkSelectValue.Checked)
                        {
                            ...
                            HiddenField hdnAppNo = (HiddenField)grd.FindControl("hdnAppNo");
                            DropDownList drpCrossCountryvalue = (DropDownList)grd.FindControl("drpCrossCountry");
                ...
                else if (drpEventType.SelectedValue == "9")
                {
                    ...
                    foreach (GridViewRow grd in grdSwimming.Rows)
                    {
                        CheckBox chkSelectValue = (CheckBox)grd.FindControl("ChkSelect");
                        if (chkSelectValue.Checked)
                        {
                            ...
                            HiddenField hdnAppNo = (HiddenField)grd.FindControl("hdnAppNo");
                            DropDownList drpSwimmingvalue = (DropDownList)grd.FindControl("drpSwimming");
                ...
                else if (drpEventType.SelectedValue == "10")
                {
                    ...
                    foreach (GridViewRow grd in grdDriving.Rows)
                    {
                        CheckBox chkSelectValue = (CheckBox)grd.FindControl("ChkSelect");
                        if (chkSelectValue.Checked)
                        {
                            ...
                            HiddenField hdnAppNo = (HiddenField)grd.FindControl("hdnAppNo");
                            DropDownList drpDrivingvalue = (DropDownList)grd.FindControl("drpDriving");
                ...
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "alert", "alert('No Record Selected !!!')", true);
                    LoadGridData();
