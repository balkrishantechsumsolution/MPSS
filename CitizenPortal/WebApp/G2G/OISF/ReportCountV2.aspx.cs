...
{
    public partial class ReportCountV2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet ds = obj.GetOISFAppDetailsV2("OP01", "", "", "", "", "", "", "", "", "", "");
                ...
                ChartCSC.DataSource = ds.Tables[2];
                ChartCSC.Series["Series1"].XValueMember = "Category";
                ChartCSC.Series["Series1"].YValueMembers = "Total";
                ChartCSC.DataBind();
