...
{
    public partial class ITIReport : System.Web.UI.Page
    {
        ...
        private void BindService(string departmentcode)
        {
            ...
            System.Data.DataTable dtServices = t_ServicesBLL.GetDeptITIServices(departmentcode);
        ...
        public void LoadGridData()
        {
            ...
            // DataTable ds = m_G2GDashboardBLL.GetDTEG2GDashboardDetails(LoginID, Department, Service, FromDate, ToDate, District, Status);
            DataTable ds = m_G2GDashboardBLL.GetDTEG2GITIDashboardDetails(LoginID, Department, Service, FromDate, ToDate, District, Status);
