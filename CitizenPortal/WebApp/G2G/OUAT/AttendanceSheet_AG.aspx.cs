...
{
    public partial class AttendanceSheet_AG : System.Web.UI.Page
    {
        ...
        public void Loadgrid()
        {
            ...
            DataSet ds = obj.GetOISFAppDetails("OUA2", drpCenter.SelectedValue.ToString(), txtSearch.Text, "", "", "", "", "", "", "", "");
        ...
        public void Loadgrid2()
        {
            ...
            DataSet ds = obj.GetOISFAppDetails("OUA3", drpCenter.SelectedValue.ToString(), txtSearch.Text, "", "", "", "", "", "", "", "");
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet ds = obj.GetOISFAppDetails("OUA5", drpCenter.SelectedValue.ToString(), "", "", "", "", "", "", "", "", "");
