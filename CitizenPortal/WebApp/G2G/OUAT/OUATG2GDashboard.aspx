    ...
    <div id="page-wrapper" style="min-height: 500px !important;">
                ...
                <div class="box-body box-body-open">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                        <div class="form-group">
                            ...
                            <asp:TextBox runat="server" ID="txtRoll" class="form-control" placeholder="Roll No" name="txtRollNo" MaxLength="10" onkeypress="return isNumberKey(event);"
                                type="text" value=""></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3" style="display: none">
        ...
        <div>
            <div style="">
                ...
                <div style="min-height: 4.66em; z-index: -760;" class="SrvDiv" id="">
                <a href="#" onclick="javascript:return RedirectToService('/WebApp/G2G/OUAT/Diplomadmission.aspx');">
                    <img src="/webapp/kiosk/Images/odisalogo_1.png" alt="" align="left" style="height: 70px;" />
                </a><a href="/WebApp/G2G/OUAT/Diplomadmission.aspx">AgroPolytechnic Diploma</a>
                <br />
                <span>Admission Letter to AgroPolytechic Diploma</span>
            </div>
