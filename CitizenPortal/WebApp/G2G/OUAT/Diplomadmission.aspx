<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="Diplomadmission.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.OUAT.Diplomadmission" %>
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>Issue Admission Letter to OUAT AgroPolytechnic Diploma Candidate</h2>
                </div>
            </div>
            <%---Start of Filter----%>
            <div class="row" style="">
                    ...
                    <div class="box-body box-body-open">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                            <div class="form-group">
                                <label class="" for="txtAppID">Seach Application No.</label>
                                <asp:TextBox runat="server" ID="txtAppID" class="form-control" placeholder="Roll No" name="txtRollNo" MaxLength="12" onkeypress="return isNumberKey(event);"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-7">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlCollege" runat="server" Width="95%" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlCollege_SelectedIndexChanged">
                                        ...
                                        <asp:ListItem Text="Agro-Polytechnic Centre, Mahisapat, Dhenkanal" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="Agro-Polytechnic Centre, Ranital, Bhadrak" Value="2"></asp:ListItem>
                                        <asp:ListItem Text="Agro-Polytechnic Centre, Deogarh" Value="3"></asp:ListItem>
                                        <asp:ListItem Text="Agro-Polytechnic Centre, Boudh" Value="4"></asp:ListItem>
                                        <asp:ListItem Text="Agro-Polytechnic Centre, Rourkela, Panposh" Value="5"></asp:ListItem>
                                        <asp:ListItem Text="Agro-Polytechnic Centre, Bolangir" Value="6"></asp:ListItem>
                                        <asp:ListItem Text="Agro-Polytechnic Centre, Keonjhar" Value="7"></asp:ListItem>
                                        <asp:ListItem Text="Agro-Polytechnic Centre, Semiliguda" Value="8"></asp:ListItem>
                                        <asp:ListItem Text="Agro-Polytechnic Centre, Chiplima" Value="9"></asp:ListItem>
                                        <asp:ListItem Text="Agro-Polytechnic Centre,Rangeilunda, Berhampur" Value="10"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-5">
                                <div class="form-group">
                                    <label id="lblDegree">Select Course</label>
                                    <asp:DropDownList ID="ddlCourse" runat="server" Width="95%" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged">
                                        <asp:ListItem Selected="True" Text="-Select Course-" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Fishery Science" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Agriculture Science" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="Horticulture Science" Value="2"></asp:ListItem>
                                        <asp:ListItem Text="Animal Science" Value="3"></asp:ListItem>
                                            ...
                                            <table style="width: 100%; vertical-align: middle; text-align: center;">
                                                <tr>
                                                    ...
                                                    <td style="text-align: center; vertical-align: middle;">
                                                        ...
                                                        <span style="text-align: center; font-size: 20px; font-weight: bold; color: #d43300;">AgroPolytechnic Diploma Admission Letter - 2017</span>
                                                        <br />
                                            ...
                                            <table cellpadding="5" cellspacing="0" class="" style="width: 100%; border: 0; font-size: 11px;">
                                                <tr>
                                                    ...
                                                    <td rowspan="6" style="padding: 0; border: 1px solid #999; text-align: center; vertical-align: top; width: 70px;">
                                                        ...
                                                        <img runat="server" src="" name="ProfileSig" style="margin-top: 5px; width: 65px; height: 32px;" id="ProfileSign" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 2px; border: 1px solid #999; text-align: left;">
                                                        <asp:Label ID="lblFather0" runat="server">Category</asp:Label>
                                                        </td>
                                                    <td style="padding: 2px; border: 1px solid #999; text-align: left;">
                                                ...
                                                <tr id="trRank" runat="server">
                                                    ...
                                                    <td style="padding: 2px; border: 1px solid #999; text-align: left; width: 250px;">
                                                        <asp:Label ID="lblMarks" runat="server" Font-Bold="True"></asp:Label>
                                                    </td>
