<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="OUATRefundPaymentList.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.OUAT.OUATRefundPaymentList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        #LeftPanel_pnlMenu { display:none;
        }
    </style>
</asp:Content>
     ...
     <div class="w95">
        ...
        <div class="col-lg-12 box-container pright0">
            <div class="box-heading">
                <h4 class="box-title ng-binding">OUAT RefundPayment List :</h4>
            </div>
