...
{
    public partial class OUATG2GDashboard : BasePage
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (txtRoll.Text != null && txtRoll.Text != "")
            {
                ...
                //if (RollNo.Length != 10)
                //{
                //    string m_Message = "Roll Number must be of 10 digit number.";
                //    ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('" + m_Message + "');", true);
                //    return;
                //}
            }
            ...
            DataTable dt = null;
            dt = m_G2GDashboardBLL.GetOUATG2GData(LoginID, Department, category, DistrictCode, FromDate, ToDate, Status, AppID, RollNo);
