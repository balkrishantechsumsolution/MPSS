<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttendanceSheet_AG.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.OUAT.AttendanceSheet_AG" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>OUAT AG Attendance Sheet</title>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12">
                            <table style="width: 794px; height: 60%; background-color: #f9f9f9; padding: 10px; border-top-left-radius: 2px; border-top-right-radius: 2px; border-top: 8px solid #8bbbea; box-shadow: 3px 3px 5px #e0e0e0; margin: 0 auto;">
                                <tr>
                                    ...
                                    <td>
                                        <b>College of Agriculture, Bhubaneswar </b></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:DropDownList ID="drpCenter" runat="server" Height="23px" Width="269px">
                                            <asp:ListItem Value="0">Select</asp:ListItem>
                                            <asp:ListItem Value="AC001">Agriculture Science</asp:ListItem>
                                            <asp:ListItem Value="AC002">Animal Science</asp:ListItem>
                                            <asp:ListItem Value="AC003">Fishery Science</asp:ListItem>
                                            <asp:ListItem Value="AC004">Horticulture Science</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtSearch" runat="server" Height="16px" Width="261px" MaxLength="15"></asp:TextBox>
                                    </td>
