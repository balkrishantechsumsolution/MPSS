...
<head runat="server">
    ...
    <script>
        ...
        function ShowDocMessage(path, checkBox) {
            alert("There is an issue while downloading the document. Please inform the applicant to re-upload the documents.");
            return false;
        }
                    ...
                    <div class="box-body box-body-open">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-8">
                            ...
                            <div id="divReport" runat="server">
                                ...
                                <div id="divReportDPR" runat="server">
                                ...
                                <asp:Label ID="Label4" runat="server" Text="Project Report" Visible="False"></asp:Label>
                                <asp:FileUpload ID="FU_DOC997" runat="server" class="" Visible="False" />
