...
{
    public partial class SSEPDG2GDashboard : BasePage
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = null;
            //dt = m_G2GDashboardBLL.GetG2GDashboard_SSEPD(LoginID, Department, category, DistrictCode, FromDate, ToDate, Status, AppID);
            dt = m_G2GDashboardBLL.GetG2GDashboard_SSEPD(LoginID, Department, service, DistrictCode, FromDate, ToDate, Status, AppID);
