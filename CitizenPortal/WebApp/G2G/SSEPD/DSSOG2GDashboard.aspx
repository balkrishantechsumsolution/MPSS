<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="DSSOG2GDashboard.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.SSEPD.DSSOG2GDashboard" %>
...
<div id="page-wrapper" style="min-height: 500px !important;">
        ...
        <div>           
              <div style="min-height: 4.66em; z-index: -760; display: block;" class="SrvDiv" id="105">
                    ...
                    </a><a href="../ServiceDetail.aspx" target="_self">Pendancy Report</a>
                    <br />
                    <span>Service List Wise</span>
                </div>
                <div style="min-height: 4.66em; z-index: -760; display: block;" class="SrvDiv" id="104">
                    <a href="#" onclick="javascript:return RedirectToService('/WebApp/KIOSK/OUAT/OUATScrutiny.aspx?SvcID=403');">
                        <img src="/webapp/kiosk/Images/odisalogo_1.png" alt="" align="left" style="height: 70px;" />
                    </a><a href="/WebApp/G2G/SSEPD/G2GDSSOReport.aspx" target="_blank">Report</a>
                    <br />
                    <span>District / Block Wise</span>
                </div>
        </div>
        <%----END of Filter-----%>
