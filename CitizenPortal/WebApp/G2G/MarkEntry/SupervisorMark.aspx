<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="SupervisorMark.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.MarkEntry.SupervisorMark" %>
    ...
    <script type="text/javascript">
        ...
        function EnableControls(p_RowID) {
            ...
            if (document.getElementById("ContentPlaceHolder1_DataGridView_chkRollNo_" + p_ID).checked) {
                ...
                document.getElementById("ContentPlaceHolder1_DataGridView_txtMarks_" + p_ID).value = document.getElementById("ContentPlaceHolder1_DataGridView_lblMark_" + p_ID).innerHTML;
            }
            else {
                document.getElementById("ContentPlaceHolder1_DataGridView_txtMarks_" + p_ID).disabled = true;
                document.getElementById("ContentPlaceHolder1_DataGridView_txtMarks_" + p_ID).value = "";
            }
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>Supervisor Mark Verification</h2>
                </div>
            </div>
            <%---Start of Filter----%>
            <div class="row" style="">
                    ...
                    <div class="box-body box-body-open">
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlPaper" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlPaper_SelectedIndexChanged">
                                    <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="display:none">
                            <div class="form-group">
                                ...
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" InitialValue="0" ControlToValidate="ddlExamType" Display="Dynamic"
                ...
                <div class="box-body box-body-open">
                    <div style="text-align: center; color: red; font-weight: bold; padding: 3px">Note: After submission of Marks, please take print out of the submitted marks by clicking on "PRINT ACKNOWLEDGEMENT" button </div>
                                ...
                                <asp:GridView ID="DataGridView" runat="server" Width="98%" OnPreRender="DataGridView_PreRender"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Marks Obtain">
                                            <ItemTemplate>
                                                <asp:Label ID="lblMark" runat="server" Text='<%#Eval("MarksObtained") %>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Supervisor Marks">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtMarks" runat="server" MaxLength="2" Width="70" Text='<%#Eval("SupervisorMarks") %>' onkeypress="return isNumberKeyAB(event);" Enabled="false"></asp:TextBox>
                ...
                <div class="row">
                    <div class="col-md-12 box-container" style="margin-top: 5px;">
                        <div class="box-body box-body-open" style="text-align: center;">
                            <asp:Button ID="btnSave" runat="server" CssClass="btn btn-primary" Text="Verified Mark" OnClick="btnSave_Click" />
                            <asp:Button ID="btnSubmit" runat="server" Text="Submitted to University" CssClass="btn btn-danger" OnClick="btnSubmit_Click" OnClientClick="javascript:return ConfirmSubmit();" />
