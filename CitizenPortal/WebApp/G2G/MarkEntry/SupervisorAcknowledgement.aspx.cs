...
{
    public partial class SupervisorAcknowledgement : AdminBasePage
    {
        string mCollege, mBranch, mSemester,mPaper,mYear,mType, mCreatedBy;
        ...
        protected void Page_Load(object sender, EventArgs e)
            ...
            DataSet dt = m_AdmissionFormBLL.SupervisorMarksSummary(mCollege, mBranch, mSemester, mPaper, mYear, mType, mCreatedBy);
