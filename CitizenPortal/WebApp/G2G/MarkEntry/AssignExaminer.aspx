<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="AssignExaminer.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.MarkEntry.AssignExaminer" %>
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>Assign Examiner</h2>
                </div>
            </div>
            <%---Start of Filter----%>
            <div class="row" style="">
                <div class="col-md-12 box-container">
                    ...
                    <div class="box-body box-body-open">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
                            <div class="form-group">
                                <label class="manadatory" for="ddlExaminer">
                                    Examiner 
                                </label>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3" style="display:none">
                            <div class="form-group">
                                <label class="" for="ddlCollege">
                                    College</label>
                                <asp:DropDownList ID="ddlCollege" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlCollege_SelectedIndexChanged">
                                <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5 text-right">
                            <div class="form-group">
                                ...
                                &nbsp;<asp:Button ID="btnPrint" runat="server" Text="Print Mark File" CssClass="btn btn-primary" OnClick="btnPrint_Click" />
                            </div>
                        </div>
                    ...
                    <div class="box-body box-body-open" runat="server" id="divAddD">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                <label class="manadatory" for="txtExaminerName">
                                    Examiner Name
                                </label>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow-y: auto;">
                                    ...
                                    <asp:GridView ID="DataGridView" runat="server" Width="98%" OnPreRender="DataGridView_PreRender"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Roll No Range">
                                                <ItemTemplate>
                                                    <asp:Label ID="RollNoRange" runat="server" Text='<%#Eval("RollNo") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="SetID" HeaderText="Set No." />
                                            <asp:BoundField DataField="RollCount" HeaderText="Roll Count" />
                                            ...
                                            <asp:TemplateField HeaderText="Examiner">
                                                <ItemTemplate>
                                                    <asp:Label ID="Examiner" runat="server" Text='<%# Bind("ExaminerID") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <div class="row" id="divButton" runat="server">
                        <div class="col-md-12 box-container" style="margin-top: 5px;">
                            <div class="box-body box-body-open" style="text-align: center;">
                                <asp:Button ID="btnSave" runat="server" CssClass="btn btn-primary" Text="Assigne Examiner" OnClick="btnSave_Click" />
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit to Verification" CssClass="btn btn-danger" OnClick="btnSubmit_Click" OnClientClick="javascript:return ConfirmSubmit();" style="display:none" />
