<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="TheoryMarkReport.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.MarkEntry.TheoryMarkReport" %>
        ...
        <div id="page-wrapper" style="min-height: 500px !important;">
            <div class="row">
                <div class="col-lg-12 cscPgehd">
                    <h2 class="form-heading"><i class="fa fa-pencil-square-o"></i>WRITTEN MARKS REPORT</h2>
                </div>
            </div>
            <%---Start of Filter----%>
            <div class="row" style="">
                        ...
                        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlExamType" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem Value="3" Text="Imporvement"></asp:ListItem>
                                </asp:DropDownList>
