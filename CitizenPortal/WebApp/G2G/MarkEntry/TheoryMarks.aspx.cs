...
{
    public partial class TheoryMarks : AdminBasePage
    {
        ...
        public void LoadGridData()
        {
            ...
            t_Ds = m_AdmissionFormBLL.GetStudentTheoryPaperDetails(College, ExamType, Branch, t_Year, Semester, PaperCode, RollNo,ddlSubject.SelectedValue, t_Range, ddlExaminer.SelectedValue, ddlZone.SelectedValue);
            ds = t_Ds.Tables[1];
            t_dt = t_Ds.Tables[0];
        ...
        protected void grdView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                CheckBox chk = (CheckBox)e.Row.FindControl("chkRollNo");
                ...
                TextBox txtMark = (TextBox)e.Row.FindControl("txtMarks");
                chk.Checked = true;
                    ...
                    foreach (GridViewRow rows in DataGridView.Rows)
                    {
                        ...
                        //if (chkenroll.Checked)
                        {
                            ...
                            //if (chk_RowID == t_RowIDArr[i])
                            {
                                ...
                                if (t_txtMarks.Text != "" && t_txtMarks.Text != null)
                                {
                                    string[] AFields =
                                    {
                                  "RowID"
                                ...
                                , "ExaminerID"
                                    ...
                                    result = m_AdmissionFormBLL.InsertTheoryMarkData(t_TheoryMark_DT, AFields);
