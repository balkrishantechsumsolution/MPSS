...
{
    public partial class InternalMarksV2 : AdminBasePage
    {
                    ...
                    foreach (GridViewRow rows in DataGridView.Rows)
                    {
                        ...
                        if (chkenroll.Checked)
                        {
                            ...
                            if(chk_RowID == t_RowIDArr[i])
                            {
                                ...
                                TextBox t_txtPracticalMarks = (TextBox)rows.FindControl("txtPractMO");
                                TextBox t_txtInternalMarks = (TextBox)rows.FindControl("txtInternalMO");
                                TextBox t_txtTheoryMarks = (TextBox)rows.FindControl("txtTheoryMO");
                                ...
                                if (!chkAbent.Checked) {
                                    ...
                                    */
                                    ...
                                    t_InternalMark_DT.PracticalMark = t_txtPracticalMarks.Text;
                                    t_InternalMark_DT.InternalMark = t_txtInternalMarks.Text;
                                    t_InternalMark_DT.TheoryMark = t_txtTheoryMarks.Text;
                                }
                                else
                                {
