...
{
    public partial class SupervisorMark : AdminBasePage
    {
        ...
        public void LoadGridData()
        {
            ...
            DataTable ds = null;
            ds = m_AdmissionFormBLL.GetSupervisorTheoryPaperDetail(College, ExamType, Branch, t_Year, Semester, PaperCode, RollNo,ddlSubject.SelectedValue, ddlExaminer.SelectedValue);
        ...
        */
        ...
        void GetSelectedRec()
        {
            ...
            {
                a = rows.Cells.Count - 1;
                if (rows.Cells[9].Controls.Count > 0 && rows.Cells[9].Controls[1].GetType().FullName.Equals(typeof(CheckBox).FullName))
                {
                    CheckBox chk = rows.Cells[9].Controls[1] as CheckBox;
                    ...
                    foreach (GridViewRow rows in DataGridView.Rows)
                    {
                        ...
                        if (chkenroll.Checked)
                        {
                            ...
                            if(chk_RowID == t_RowIDArr[i])
                            {
                                ...
                                t_TheoryMark_DT.RowID = RowID.Value;
                                t_TheoryMark_DT.RollNo = RollNo.Text;
                                ...
                                t_TheoryMark_DT.TheoryMark = t_txtMarks.Text;                               
                                ...
                                result = m_AdmissionFormBLL.InsertSupervisorMarkData(t_TheoryMark_DT, AFields);
        ...
        {
            string t_URL = "/WebApp/G2G/MarkEntry/SupervisorAcknowledgement.aspx?CC=" + ddlCollege.SelectedValue + "&BC=" + ddlBranch.SelectedValue + "&PC=" + ddlPaper.SelectedValue + "&SC=" + ddlSemester.SelectedValue + "&ET=" + ddlExamType.SelectedValue + "&EY=" + ddlSession.SelectedItem.Text + "&CB=" + ddlZone.SelectedValue;
