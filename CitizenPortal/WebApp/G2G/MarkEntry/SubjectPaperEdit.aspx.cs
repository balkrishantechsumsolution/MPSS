...
{
    public partial class SubjectPaperEdit : AdminBasePage
    {
                        ...
                        if (chkenroll != null && chkenroll.Checked)
                        {
                            ...
                            if (chk_RowID == t_RowIDArr[i])
                            {
                                ...
                                if (ctrl != null)
                                {
                                    ...
                                    {
                                        DT = t_AdmitCardBLL.InsertEditStudentListV2(RowID, RollNo, AppID, OldSubjectCode, SubjectCode, SubjectName, txtRemarks.Text.Trim(), Session["LoginID"].ToString(), ddlSemester.SelectedValue, ddlExamYear.SelectedValue, ddlExamType.SelectedValue, ddlSession.SelectedValue,ddlBranch.SelectedValue,ddlCollege.SelectedValue, SubjectType);
        ...
        private void GetSubjectType()
        {
            ...
            {
                DataTable dt = new DataTable();
                dt = m_AdmissionFormBLL.GetSubjectType(ddlBranch.SelectedValue);
                if (dt != null && dt.Rows.Count > 0)
                {
