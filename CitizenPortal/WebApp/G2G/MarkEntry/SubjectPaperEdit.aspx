<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="SubjectPaperEdit.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.MarkEntry.SubjectPaperEdit" %>
                    ...
                    <div class="box-body box-body-open">
                        ...
                        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlSubject" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem Value="MIL-B" Text="SEC-B"></asp:ListItem>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" InitialValue="0" ControlToValidate="ddlSession" Display="Dynamic"
                                    ErrorMessage="Please select SESSION" ValidationGroup="G" ForeColor="Red" SetFocusOnError="true" EnableClientScript="true" />
                            </div>
                        </div>
