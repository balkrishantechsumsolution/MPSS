<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="InternalMarksV2.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.MarkEntry.InternalMarksV2" %>
    ...
    <script type="text/javascript">
        ...
        function EnableControls(p_RowID) {
            ...
            if (document.getElementById("ContentPlaceHolder1_DataGridView_chkRollNo_" + p_ID).checked) {
                ...
                if ((document.getElementById("ContentPlaceHolder1_DataGridView_PractTM_" + p_ID).innerHTML == '0')
                    || (document.getElementById("ContentPlaceHolder1_DataGridView_PractTM_" + p_ID).innerHTML == ''))
                    document.getElementById("ContentPlaceHolder1_DataGridView_txtPractMO_" + p_ID).disabled = true;
                else
                    document.getElementById("ContentPlaceHolder1_DataGridView_txtPractMO_" + p_ID).disabled = false;

                if ((document.getElementById("ContentPlaceHolder1_DataGridView_InternalTM_" + p_ID).innerHTML == '0')
                    || (document.getElementById("ContentPlaceHolder1_DataGridView_InternalTM_" + p_ID).innerHTML == ''))
                    document.getElementById("ContentPlaceHolder1_DataGridView_txtInternalMO_" + p_ID).disabled = true;
                else
                    document.getElementById("ContentPlaceHolder1_DataGridView_txtInternalMO_" + p_ID).disabled = false;

                if ((document.getElementById("ContentPlaceHolder1_DataGridView_TheoryTM_" + p_ID).innerHTML == '0')
                    || (document.getElementById("ContentPlaceHolder1_DataGridView_TheoryTM_" + p_ID).innerHTML == ''))
                    document.getElementById("ContentPlaceHolder1_DataGridView_txtTheoryMO_" + p_ID).disabled = true;
                else
                    document.getElementById("ContentPlaceHolder1_DataGridView_txtTheoryMO_" + p_ID).disabled = false;
            }
            else {
                //document.getElementById("ContentPlaceHolder1_DataGridView_txtMarks_" + p_ID).disabled = true;
                document.getElementById("ContentPlaceHolder1_DataGridView_txtPractMO_" + p_ID).disabled = true;
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="overflow-y: auto;">
                                    ...
                                    <asp:GridView ID="DataGridView" runat="server" Width="99%" OnPreRender="DataGridView_PreRender"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Total Marks" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="TotalMarks" runat="server" Text='<%# Bind("TotalMarks") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Marks Obtain" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Practical Total Marks">
                                                <ItemTemplate>
                                                    <asp:Label ID="PractTM" runat="server" Text='<%# Bind("Pract_TM") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Practical Marks Obtain">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtPractMO" runat="server" MaxLength="2" Width="70" Text='<%#Eval("Pract_MO") %>' onkeypress="return isNumberKeyAB(event);" Enabled="false"></asp:TextBox>
                                                    <asp:CustomValidator ID="CustomValidator2" runat="server" Display="Dynamic" SetFocusOnError="True" ForeColor="Red" ControlToValidate="txtPractMO" ErrorMessage="Invalid Entry! Enter:(<= Total Marks or AB or MB)" ClientValidationFunction="CheckMarksEnter2"></asp:CustomValidator>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Internal Total Marks">
                                                <ItemTemplate>
                                                    <asp:Label ID="InternalTM" runat="server" Text='<%# Bind("Internal_TM") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Internal Marks Obtain">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtInternalMO" runat="server" MaxLength="2" Width="70" Text='<%#Eval("Internal_MO") %>' onkeypress="return isNumberKeyAB(event);" Enabled="false"></asp:TextBox>
                                                    <asp:CustomValidator ID="CustomValidator3" runat="server" Display="Dynamic" SetFocusOnError="True" ForeColor="Red" ControlToValidate="txtInternalMO" ErrorMessage="Invalid Entry! Enter:(<= Total Marks or AB or MB)" ClientValidationFunction="CheckMarksEnter3"></asp:CustomValidator>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                             <asp:TemplateField HeaderText="Theory Total Marks">
                                                <ItemTemplate>
                                                    <asp:Label ID="TheoryTM" runat="server" Text='<%# Bind("Theory_TM") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Theory Marks Obtain">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtTheoryMO" runat="server" MaxLength="2" Width="70" Text='<%#Eval("Theory_MO") %>' onkeypress="return isNumberKeyAB(event);" Enabled="false"></asp:TextBox>
                                                    <asp:CustomValidator ID="CustomValidator4" runat="server" Display="Dynamic" SetFocusOnError="True" ForeColor="Red" ControlToValidate="txtTheoryMO" ErrorMessage="Invalid Entry! Enter:(<= Total Marks or AB or MB)" ClientValidationFunction="CheckMarksEnter4"></asp:CustomValidator>
                                                </ItemTemplate>
                                            </asp:TemplateField>
