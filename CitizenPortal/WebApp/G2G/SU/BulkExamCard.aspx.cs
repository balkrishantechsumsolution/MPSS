...
{
    public partial class BulkExamCard : AdminBasePage
    {
        ...
        public void Loadgrid()
        {
            ...
            ds = obj.GetExamCardDetail(m_BranchCode, m_CollegeCode, m_ExamType, m_ExamYear, m_Range, m_RollNo, m_ServiceID, m_Registration, m_PrintFlag);
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sb.Replace("<tr style='page-break-before:always;'><td>", "<tr><td>Total candidates Present:</td></tr><tr><td>Total Candidate absent : &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Signature of the Invigilator</td></tr><tr style='page-break-before:always;'><td><table rules='all'   id='grdAttendanceData' style='font-size:14px;width:100%;'><tr> <tr><td><img src='download1.png' style='height: 43px; width: 71px'/></td><td  align='center'><b><CHHATTISGARH SWAMI VIVEKANAD TECHNICAL UNIVERSITY</b><<br>Raipur<br> Admission Year-" + ddlSession.SelectedItem.Text.ToString() + " " + ddlSession.SelectedItem.Text.ToString() + "     </td> </tr><tr><td  align='center'>College Name : </td> <td  align='center'><b> " + ddlCollege.SelectedItem.Text.ToString() + " </b></td></tr><tr><td  align='center'>Roll Range : " + rollNumberRange + "</td> <td  align='center'>Exam. Date : <b>" + ExamDate + "</b> </td></tr></table>");
        ...
        protected void grdAttendanceSheet_ItemDataBound(object sender, DataListItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                if (e.Item.DataItem != null)
                {
                    ...
                    System.Web.UI.HtmlControls.HtmlImage Img11 = (System.Web.UI.HtmlControls.HtmlImage)e.Item.FindControl("ProfileSignature");
                    ...
                    try
                    {
                        ...
                        qrCode.GenerateQRStudent(t_RollNo);
            ...
            t_DS = obj.GetBulkExamPaperDetail(dtGlobal.Rows[e.Item.ItemIndex]["RollNo"].ToString(), ddlSession.SelectedValue, "");

            DataTable dt_1SEM = t_DS.Tables[0];
            DataTable dt_2SEM = t_DS.Tables[1];
            DataTable dt_3SEM = t_DS.Tables[2];
            DataTable dt_4SEM = t_DS.Tables[3];
            DataTable dt_5SEM = t_DS.Tables[4];
            DataTable dt_6SEM = t_DS.Tables[5];
            DataTable dt_SEM = t_DS.Tables[6];
            ...
            {
                DataRowView drv = e.Item.DataItem as DataRowView;
                GridView GridView1SEM = e.Item.FindControl("grd1SEM") as GridView;
                Label SEM1 = e.Item.FindControl("lblSEM1") as Label;

                GridView1SEM.DataSource = dt_1SEM;
                GridView1SEM.DataBind();
                SEM1.Text = dt_SEM.Rows[0]["SEMLebel"].ToString();
                
            }
            if (dt_2SEM.Rows.Count > 1)
            {
                DataRowView drv = e.Item.DataItem as DataRowView;
                GridView GridView2SEM = e.Item.FindControl("grd2SEM") as GridView;
                Label SEM2 = e.Item.FindControl("lblSEM2") as Label;

                GridView2SEM.DataSource = dt_2SEM;
                GridView2SEM.DataBind();
                SEM2.Text = dt_SEM.Rows[1]["SEMLebel"].ToString();                

            }
            if (dt_3SEM.Rows.Count > 1)
            {
                DataRowView drv = e.Item.DataItem as DataRowView;
                GridView GridView3SEM = e.Item.FindControl("grd3SEM") as GridView;
                Label SEM3 = e.Item.FindControl("lblSEM3") as Label;

                GridView3SEM.DataSource = dt_3SEM;
                GridView3SEM.DataBind();
                SEM3.Text = dt_SEM.Rows[2]["SEMLebel"].ToString();                

            }
            if (dt_4SEM.Rows.Count > 1)
            {
                DataRowView drv = e.Item.DataItem as DataRowView;
                GridView GridView4SEM = e.Item.FindControl("grd4SEM") as GridView;
                Label SEM4 = e.Item.FindControl("lblSEM4") as Label;

                GridView4SEM.DataSource = dt_4SEM;
                GridView4SEM.DataBind();
                SEM4.Text = dt_SEM.Rows[3]["SEMLebel"].ToString();                

            }
            if (dt_5SEM.Rows.Count > 1)
            {
                DataRowView drv = e.Item.DataItem as DataRowView;
                GridView GridView5SEM = e.Item.FindControl("grd5SEM") as GridView;
                Label SEM5 = e.Item.FindControl("lblSEM5") as Label;

                GridView5SEM.DataSource = dt_5SEM;
                GridView5SEM.DataBind();
                SEM5.Text = dt_SEM.Rows[4]["SEMLebel"].ToString();                

            }
            if (dt_6SEM.Rows.Count > 1)
            {
                DataRowView drv = e.Item.DataItem as DataRowView;
                GridView GridView6SEM = e.Item.FindControl("grd6SEM") as GridView;
                Label SEM6 = e.Item.FindControl("lblSEM6") as Label;

                GridView6SEM.DataSource = dt_6SEM;
                GridView6SEM.DataBind();
                SEM6.Text = dt_SEM.Rows[5]["SEMLebel"].ToString();
               
            }

            Label Print = e.Item.FindControl("lblPrint") as Label;
            Print.Text = "Printed On : " + DateTime.Now.ToString("dd-MM-yyyy hh:mm:ss");
