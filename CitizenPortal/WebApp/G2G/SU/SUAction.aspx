 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SUAction.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.SU.SUAction" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .flwrapper {border:1px solid red;
        }
        .fllable{float:left;}
        .flupload{float:left;}
        .flbutton {float:left;}
    ...
    <script>
        ...
        function ExecuteAction(StageID, ActionID) {
            ...
            if ($("#HFServiceID").val() == "1446") {
                if ($("#ddlCharacter").val() == "0") {
                    $('#ddlCharacter').attr('style', 'border:1px solid #d03100 !important;');
                    $('#ddlCharacter').css({ "background-color": "#fff2ee" });
                    alert('Please select Student Conduct & Character.');
                    return false;
                }
                else {
                    $('#ddlCharacter').attr('style', 'border:1px solid #cdcdcd !important;');
                    $('#ddlCharacter').css({ "background-color": "#ffffff" });
                }

                if ($("#ddlCharacter").val() == "2") {
                    alert('Application cannot be RECOMMENDED & SEND TO UNIV ADMIN as Student Conduct & Character is NOT GOOD. Please click on TERMINATED APPLICATION');
                    return false;
                }
            }
        ...
        function ExecuteAction_Reject(StageID, ActionID) {
            ...
            if (($("#HFServiceID").val() == "1446") && (ActionID == "A6")) {
                if ($("#ddlCharacter").val() == "0") {
                    $('#ddlCharacter').attr('style', 'border:1px solid #d03100 !important;');
                    $('#ddlCharacter').css({ "background-color": "#fff2ee" });
                    alert('Please select Student Conduct & Character.');
                ...
                if ($("#ddlCharacter").val() == "2") {
                    alert('Application cannot be TERMINATED as Student Conduct & Character is GOOD. Please click on RECOMMENDED & SEND TO UNIV ADMIN');
                    return false;
                }
            }
        ...
        function EditMigration(AppID,ServiceID)
        {
            var t_URL = "";
            var t_AppID = "", t_ServiceID = "";
            t_AppID = AppID;
            t_ServiceID = ServiceID;

         
            if (t_ServiceID == "1446") {
                t_URL = "/WebApp/G2G/SU/DMASForm.aspx?";
            }
...
<body>
 ...
 <div id="page-iframe" style="min-height: 500px !important;">
            <div class="row" id="divServiceDeliveryDetails" runat="server" visible="false" style="display:none">
            ...
            <div class="row">
                ...
                <div class="col-md-4 box-container mTop15" runat="server" id="divRecom" visible="false" style="display:none">
                    <div class="box-heading">
                        <h4 class="box-title">Conduct and character  
                        </h4>
                    </div>
                    <div class="box-body box-body-open">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <asp:Label ID="Label3" runat="server" Text="Conduct & character" CssClass="manadatory "></asp:Label>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <asp:DropDownList ID="ddlCharacter" runat="server">
                                <asp:ListItem Value="0">Select Character</asp:ListItem>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-8">
                            ...
                            <div id="divReport" runat="server">
                                ...
                                <table class="table table-bordered table-striped">  
                                    <thead>
                                        <tr>                                            
                                            <th scope="col" colspan="3">Upload Photocopy of Answer Sheet</th>
                                ...
                                <div style="color: darkred; margin-bottom: 5px">
                                    <span>Note: Only <b>.Jpeg</b>, <b>.Jpg</b> and <b>.pdf</b> files are allowed to upload! AND File should not be greater than 200 KB ! </span>
                                </div>
                                            </td>
                                        </tr>
                                        <tr>                                            
                                            <td><asp:Label ID="lblReport" runat="server" Text="Inquiry Report" Visible="true"></asp:Label></td>
                                            <td><asp:FileUpload ID="fuReport" runat="server" class="" /></td>
                                            <td><asp:ImageButton ID="btnUpload" runat="server" ImageUrl="~/WebApp/Kiosk/Images/upload.png" Height="50px" Width="50px" style="margin: -17px" ToolTip="Click to upload the file"
                                    Text="Upload" OnClick="btnUpload_Click" Visible="True"></asp:ImageButton></td>             
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
