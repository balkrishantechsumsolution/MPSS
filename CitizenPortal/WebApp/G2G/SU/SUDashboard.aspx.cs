...
{
    public partial class SUDashboard : AdminBasePage
    {
        G2GDashboardBLL m_G2GDashboardBLL = new G2GDashboardBLL();
        protected void Page_Load(object sender, EventArgs e)
        {
            Response.Redirect("SUDashboardNew.aspx");
            return;
            ...
            if (!IsPostBack)
            {
                ...
                //Apply Condition for users
                if (LoginID.Contains("ACOE.Univ"))
                {
                    DivReport.Visible = true;
                    DivLegacy.Visible = true;
                    DivRollNo.Visible = true;
                    DivRegNo.Visible = false;
                    DivAdmission.Visible = false;
                    divBulk.Visible = false;
                }
                else if (LoginID.Contains("ACDII.Univ"))
                {
                    DivReport.Visible = true;
                    DivLegacy.Visible = true;
                ...
                else if (LoginID.Contains("EGII.Univ"))
                {
                    DivReport.Visible = true;
                    DivLegacy.Visible = true;
                    DivRollNo.Visible = false;
                ...
                else if (LoginID.Contains("Principal")|| LoginID.Contains("Univ"))
                {
                    DivReport.Visible = true;
                    DivLegacy.Visible = true;
                    DivRollNo.Visible = false;
                ...
                else //(LoginID.Contains("ExamAdmin"))
                {
                    DivReport.Visible = true;
                    DivLegacy.Visible = true;
                    DivRollNo.Visible = false;
