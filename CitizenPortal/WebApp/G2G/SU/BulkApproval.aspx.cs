...
{
    public partial class BulkApproval : AdminBasePage
    {
        ...
        protected void gvDetail_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (ddlStatus.SelectedValue == "P")
                {
                    ...
                    {
                        t_Anchor.Attributes.Add("onclick", "TakeAction('', '" + ddlServices.SelectedItem.Value.Substring(0, 4) + "', '" + e.Row.Cells[2].Text + "')");
                    }
                }
                else
                {
                    t_Anchor.Attributes.Add("onclick", "TakeAction('', '" + ddlServices.SelectedItem.Value.Substring(0, 4) + "', '" + e.Row.Cells[1].Text + "')");
                }
                t_Anchor.Attributes.Add("style", "cursor:pointer;font-size:10pt;font-family:Arial;color:Firebrick;text-decoration:none;");
