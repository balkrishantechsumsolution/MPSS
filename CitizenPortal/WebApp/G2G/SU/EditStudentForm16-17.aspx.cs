...
{
    public partial class EditStudentForm16_17 : AdminBasePage
    {
        ...
        [WebMethod]
        public static string EditStudentDatas(string prefix, string Data)
        {
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(binding))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.EditStudentData1617(viewModel);//[EditStudentFormSP]
                }
            }
        ...
        public static string GetApplicationDetails(string AppID)
        {
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(binding))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.GetEditApplicationDetails1617(AppID);
                }
            }
            return text;
        }
