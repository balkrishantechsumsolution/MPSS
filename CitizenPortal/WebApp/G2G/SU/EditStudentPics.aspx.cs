...
{
    public partial class EditStudentPics : AdminBasePage
    {
        ...
        public static string GetApplicationDetails(string RollNo)
        {
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(binding))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.GetEditStudentPics(RollNo);
                }
            }
            return text;
        }
        ...
        public static string UpdateStudentData(string prefix, string Data)
        {
            ...
            EditStudentPics_DT viewModel = ToObjectFromJSON<EditStudentPics_DT>(noNewLines);
            ...
            using (ChannelFactory<IService1Channel> factory = new ChannelFactory<IService1Channel>(binding))
            {
                ...
                using (OperationContextScope scope = new OperationContextScope(proxy))
                {
                    ...
                    text = proxy.UpdateStudentPics(viewModel);//[UpdateStudentInfoDataSP]
                }
            }
