...
namespace CitizenPortal.WebApp.G2G.SU
{
    public partial class AttendanceSheet : System.Web.UI.Page
    {
        ...
        protected void grdAttendanceSheet_ItemDataBound(object sender, DataListItemEventArgs e)
        {
            ...
            t_DS = obj.GetAttendentPaperDetails(dtGlobal.Rows[e.Item.ItemIndex]["RollNo"].ToString(), "", "");
