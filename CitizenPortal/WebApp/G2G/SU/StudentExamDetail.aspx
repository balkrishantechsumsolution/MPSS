<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentExamDetail.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.SU.StudentExamDetail" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container" >
            <h3 style="text-align:center;">Student Examination Detail</h3>
                    ...
                    <div class="panel panel-default">
                        <div id="PrintBasicInformation">
                            <div style="color: #fff; background-color: #5A554D; border-color: #5A554D; border-top-left-radius: 3px; border-top-right-radius: 3px; -webkit-print-color-adjust: exact;">
                                ...
                                <a href="#" id="btnBasicInfoPanel" onclick="javascript: CallPrint('PrintBasicInformation');" style="color: #fff; text-decoration: none;display:none" title="Print this Section"><span style="float: right; margin-top: -30px; margin-right: 40px;"><i class="fa fa-print fa-2x fa-fw"></i></span></a>
                            </div>
                                        ...
                                        <tr>
                                            <td style="vertical-align: top; border-left: 1px solid #ccc;">
                                                <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; margin: 0;">
                                                    <tr>
                                                        <td style="padding: 5px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: center; font-size: 11px; vertical-align: top; width: 135px" rowspan="8">
                                                        ...
                                                        <td style="padding: 5px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left; font-size: 11px;" class="auto-style1">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 5px; border: 1px solid #ccc; color: #383E4B; text-align: left; font-size: 11px;" class="auto-style2" colspan="3">
                                                    ...
                                                    <tr>
                                                        <td width="194" style="padding: 5px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left; font-size: 11px;">
                                                            &nbsp;</td>
                                                        <td style="padding: 5px; border: 1px solid #ccc; color: #383E4B; text-align: left; font-size: 11px;" class="auto-style3" colspan="3">
                                                            &nbsp;</td>
                                                    </tr>
                                                    </table>
                                            </td>
                    ...
                    <div class="panel panel-default">
                        <div class="panel panel-default">
                            <div id="PrintAdmission">
                                <div style="color: #fff; background-color: #5A554D; border-color: #5A554D; border-top-left-radius: 3px; border-top-right-radius: 3px; -webkit-print-color-adjust: exact;">
                                    ...
                                    <a href="#" id="btnAdmissionPanel" onclick="javascript: CallPrint('PrintAdmission');" style="color: #fff; text-decoration: none;display:none" title="Print this Section"><span style="float: right; margin-top: -30px; margin-right: 40px;"><i class="fa fa-print fa-2x fa-fw"></i></span></a>
                                </div>
                                    ...
                                    <div class="panel-body p0">
                                        <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; margin: 0;">
                                            ...
                                            <tr>
                                                ...
                                                <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; margin: 0;">
                                                    <tr>
                                                        <td style="padding: 5px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left; font-size: 11px;width:120px;">
                                                            <b>Exam Year </b></td>
                                                        <td style="padding: 5px; border: 1px solid #ccc; text-align: left;font-size: 11px;">
                                                            <asp:Label ID="lblExamYear" runat="server"></asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left; font-size: 11px;width:120px;"><b>Exam Semester</b></td>
                                                        <td style="padding: 5px; border: 1px solid #ccc; color: #383E4B; text-align: left; font-size: 11px;">
                                                            <asp:Label ID="lblExamSemester" runat="server"></asp:Label>
                                                        </td>
                                                        <td style="padding: 5px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left; font-size: 11px;width:120px;"><b>Exam Type</b></td>
                                                        <td style="padding: 5px; border: 1px solid #ccc; color: #383E4B; text-align: left; font-size: 11px;">
                                        ...
                                        <table cellpadding="5" cellspacing="0" class="table-bordered" style="width: 100%; margin: 0;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 5px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: right; font-size: 11px;">
                                                    <b>PERCENTAGE :
                                            ...
                                            <tr>
                                                <td style="padding: 5px; border: 1px solid #ccc; background-color: #F8F8F8; color: #383E4B; text-align: left; font-size: 11px;">
                                                    <asp:GridView ID="grdResult" runat="server" CellPadding="5" ShowHeaderWhenEmpty="true" CssClass="table table-striped table-bordered" HeaderStyle-HorizontalAlign="Left"                                                         Style="margin-bottom: 0; width: 100%; margin: 0 auto;" ClientIDMode="Static" Width="100%" RowStyle-ForeColor="#383E4B" HeaderStyle-BackColor="#dddddd" Font-Size="11px" OnRowDataBound="grdResult_RowDataBound">
                                                    </asp:GridView>
                                                </td>
                                            </tr>
                        ...
                        <div class="panel panel-default" style="display:none">
                            <div id="PrintPreviousEducation">
                                <div style="color: #fff; background-color: #5A554D; border-color: #5A554D; border-top-left-radius: 3px; border-top-right-radius: 3px; -webkit-print-color-adjust: exact;">
                                    <h4 class="panel-title" style="padding: 10px 15px; margin-bottom: 0;">
                                        <a style="color: #fff; text-decoration: none;" data-toggle="collapse" data-parent="#accordion" href="#PreviousEducation" class="fsize1em"><span class="glyphicon glyphicon-minus more-less"></span>Previous Education                        <a href="#" id="btnPrevEducationPanel" onclick="javascript: CallPrint('PrintPreviousEducation');" style="color: #fff; text-decoration: none;" title="Print this Section"><span style="float: right; margin-top: -30px; margin-right: 40px;"><i class="fa fa-print fa-2x fa-fw"></i></span></a>
                                </div>
                        ...
                        <div class="panel panel-default" id="divPayment" runat="server" style="display:none">
                            <div id="PrintPayment">
                                <div style="color: #fff; background-color: #5A554D; border-color: #5A554D; border-top-left-radius: 3px; border-top-right-radius: 3px; -webkit-print-color-adjust: exact;">
                                    <h4 class="panel-title" style="padding: 10px 15px; margin-bottom: 0;">
