<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true" CodeBehind="AdminDashboard.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.SU.AdminDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ClientIDMode="Static">
    ...
    <uc1:NoticeBoard runat="server" ID="NoticeBoard" Visible="false" />
    ...
    <div id="page-wrapper" style="min-height: 500px !important;">        
        ...
        <div class="row">
            ...
            <div class="col-md-4 box-container mTop15">
                <div class="box-heading">
                    <h4 class="box-title register-num">Exam Data Count <span style="font-size:20px;font-weight:bold;padding-left:10%"><a href="#" onclick="GetDrillSEMFEEChart('0');">CHART</a>  |  <a href="#" onclick="GetSEMFEECount('','0','','','','','0');">GRID</a></span>
                    </h4>
                </div>
                <div class="box-body box-body-open p0" style="height: 250px; overflow: auto;">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12 p0">
        ...
        <div class="row" style="">
            <div class="col-md-12 box-container">
                <div class="box-heading">
                    <h4 class="box-title register-num">Application Detail
                    </h4>
                </div>
