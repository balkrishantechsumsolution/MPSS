...
{
    public partial class DTEAction : AdminBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (LoginID.Contains("Principal"))
            {
                divReport.Visible = true;
                m_DisplayFileUpload = true;
                //divSMSFee.Visible = true;

                if (m_ServiceID == "439")//Application for Mark Sheet
                {
                    lblReport.Text = "Upload Marksheet";
                    divReport.Visible = true;
                    m_DisplayFileUpload = true;
                }
                else if (m_ServiceID == "440")//College Transfer Certificate
                {
                    lblReport.Text = "Upload Transfer Certificate";
                    divReport.Visible = true;
                    m_DisplayFileUpload = true;
                }
                else if (m_ServiceID == "441")//Issue of Duplicate Degree Certificate
                {
                    lblReport.Text = "Upload Duplicate Degree Certificate";
                    divReport.Visible = true;
                    m_DisplayFileUpload = true;
                }
                else if (m_ServiceID == "442")//Issue of Photocopy of Valued Answer Scripts
                {
                    lblReport.Text = "Upload Answersheet";
                    divReport.Visible = true;
                    m_DisplayFileUpload = true;
                }
                else if (m_ServiceID == "443")//Registration as Graduate
                {
                    lblReport.Text = "Upload Document";
                    divReport.Visible = true;
                    m_DisplayFileUpload = true;
                }
                else if (m_ServiceID == "445")//Issue of Duplicate Registration Receipt
                {
                    lblReport.Text = "Upload Duplicate Registration Receipt";
                    divReport.Visible = true;
                    m_DisplayFileUpload = true;
                }
                else if (m_ServiceID == "446")//Issue of Migration Certificate
                {
                    lblReport.Text = "Upload Migration Certificate";
                    divReport.Visible = true;
                    m_DisplayFileUpload = true;
                }
                else if (m_ServiceID == "447")//Issue of Provisional Certificate
                {
                    lblReport.Text = "Upload Provisional Certificate";
                    divReport.Visible = true;
                    m_DisplayFileUpload = true;
                }
                else if (m_ServiceID == "448")//Verification  of Documents
                {
                    lblReport.Text = "Upload Document";
                    divReport.Visible = true;
                    m_DisplayFileUpload = true;
                ...
                if (HFSentBack.Value == "1")
                {
                    ...
                    if (MobileNo != "")
                        test.sendsms(MobileNo, "Your application with Reference ID " + 
                            m_AppID + " is sent back, please login to check the status of your application. From Lokaseba Adhikara -CAP, Odisha Govt.");
        ...
        protected void btnMemoDate_OnClick(object sender, EventArgs e)
        {
          ...
          /*  string MemoDate = txtMemoDate.Text*/;

            //if (txtMemoDate.Text == "")
            //{
            //    ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "Message",
            //        "alert('Please enter Memo Date.');", true);
            //    return;
            //}
            ...
            //{
            //    ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "Message",
            //        "alert('Please enter SMS to be sent to Applicant.');", true);
            //    return;
            //}
            ...
            //    try
            //    {
            //        int result = 1;// m_WorkFlowBLL.SaveCustomData(m_ServiceID, m_AppID, m_LoginID, txtMemoDate.Text, "", "", "", "");
            ...
            //            //test.sendsms(MobileNo, SMSText);
            //            ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "Message",
            //                    "alert('Memo Date successfully updated for the Application.');", true);
            ...
            //    {
            //        ScriptManager.RegisterClientScriptBlock(this.Page, this.GetType(), "Message",
            //                    "alert('There is an issue in processing the Request. Please try again.');", true);
            //    }
            //}
        }
    }
