...
namespace CitizenPortal.WebApp.G2G.DTE
{
    public partial class StudentHistory : AdminBasePage
    {
        ...
        public void LoadGridData()
        {
            ...
            DataTable ds = null;
            ds = m_G2GDashboardBLL.GetSUStudentHistory(LoginID, Department, FromDate, ToDate, RollNo, RegNo, College, Branch, Program, t_Year, SubProgram, t_Course);
        ...
        protected void grdView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                t_ViewOutput.Attributes.Add("onclick", "StudentHistory('', '" + e.Row.Cells[0].Text + "', '" + e.Row.Cells[1].Text + "')");
