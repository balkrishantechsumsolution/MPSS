<%@ Page Title="" Language="C#" MasterPageFile="~/WebApp/G2G/Master/G2GMaster.Master" AutoEventWireup="true"
    CodeBehind="CollegePGSummary.aspx.cs" Inherits="CitizenPortal.WebApp.G2G.DTE.CollegePGSummary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function TakeAction(p_URL, p_ServiceID, p_AppID, p_Semester, p_ExamYear, p_College) {
            //var t_URL = ResolveUrl(p_URL);
            var t_URL = "/WebApp/G2G/DTE/CollegePGDetail.aspx";
            t_URL = t_URL + "?AppID=" + p_AppID + "&SvcID=" + p_ServiceID + "&SEM=" + p_Semester + "&YEAR=" + p_ExamYear + "&COLLEGE=" + p_College;
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlSemester" runat="server" Width="95%" CssClass="form-control">
                                ...
                                <asp:ListItem Value="enrol">Enrollment</asp:ListItem>
                                ...
                                <asp:ListItem Value="Regd">Registration</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2">
