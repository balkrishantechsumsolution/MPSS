<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Header.ascx.cs" Inherits="CitizenPortal.CSVTU.controls.Header" %>
<header>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 common-nav pull-right">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 text-right ptop20 pull-right" id="divLogin" style="">
                        <a href="/Sambalpur/index.aspx" class="navtop-homebtn"><i class="fa fa-home fa-fw"></i>Home</a>
