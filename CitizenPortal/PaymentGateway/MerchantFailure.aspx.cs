...
namespace CitizenPortal.PaymentGateway
{
    public partial class MerchantFailure : System.Web.UI.Page
    {
           ...
           if (!IsPostBack)
            {
                if (Request.Params.Count > 0)
                {
                    ...
                    AppID = udf_1; ServiceID = udf_2; ProfileID = udf_4; PGAppID = udf_5;

                    hdfAppID.Value = udf_1;
                    hdfServiceID.Value = udf_2;
                    hdfProfileID.Value = udf_4;
        ...
        {
            Response.Redirect("/WebApp/Kiosk/Forms/ConfirmPayment.aspx" + "?SvcID=" + hdfServiceID.Value + "&AppID=" + hdfAppID.Value, false);
        }

        protected void btnHome_Click(object sender, EventArgs e)
        {
            //Response.Redirect("/WebApp/Entrance/Login/Dashboard.aspx?UID=" + hdfProfileID.Value, false);
