<%@ Page Title="" Language="C#" MasterPageFile="~/Sambalpur/master/Home.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="CitizenPortal.CSVTU.index" %>
        ...
        <div class="container-fluid">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mtop20 pleft0 pright0">
                ...
                <div class="tab-content" style="background-color: #fff; border-right: 1px solid #ddd; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; padding: 10px; overflow-y: scroll; height: 100%; max-height: 450px; margin-bottom: 15px;">
                     <div id="counterbaseapp" class="tab-pane fade in active tab-content">
                    ...
                    <div id="newsupadate" class="tab-pane fade">
                        <h3>About</h3>
                    ...
                    <div id="semesterexamapp" class="tab-pane fade ">
                        <div class="table-responsive">
                            <asp:GridView ID="grdExam" runat="server" ShowHeaderWhenEmpty="true" CssClass="table table-striped table-bordered">
                            </asp:GridView>
                        </div>
                    </div>
                </div>
