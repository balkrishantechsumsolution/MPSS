    ...
    <div class="container-fluid whitebg">
        <div class="row tophead">
            <div class="col-xs-12 col-sm-3 col-md-1 col-lg-1">
                <a href="../../../Default.aspx"><img src="/Sambalpur/img/sambalpur-university-logo.png" class="img-responsive small-view" style="width: 90% !important;"  alt="Chhattisgarh Swami Vivekanad Technical University, Raipur" /></a>
            </div>
