...
{
    internal class NFBSDAL:DALBase
    {
        Database m_DataBase;

        internal DataTable Insert(NFBS_DT objNFBS_DT, string[] aFields)
        {
            DbCommand cmdInsert;
            ...
            cmdInsert = qb.GetInsertCommandV3(objNFBS_DT, "InsertNFBSSP", aFields);
        ...
        internal DataSet GetAppDetails(string ServiceID, string AppID)
        {
            ...
            try
            {
                ...
                selectCommand = m_DataBase.GetStoredProcCommand("GetNFBSSP");
