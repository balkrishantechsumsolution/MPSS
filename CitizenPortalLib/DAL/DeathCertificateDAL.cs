...
{
    internal class DeathCertificateDAL : DALBase
    {
        Database m_DataBase;

        internal DataTable Insert(DeathCertificate_DT objDeathCertificate_DT, string[] aFields)
        {
            DbCommand cmdInsert;
            ...
            cmdInsert = qb.GetInsertCommandV3(objDeathCertificate_DT, "InsertDeathCertificateSP", aFields);
        ...
        internal DataSet GetAppDetails(string ServiceID, string AppID)
        {
            ...
            try
            {
                ...
                selectCommand = m_DataBase.GetStoredProcCommand("GetDeathCertificateDataSP");
