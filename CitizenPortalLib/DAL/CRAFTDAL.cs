...
{
    internal class CRAFTDAL : DALBase
    {
        Database m_DataBase;

        //Inserting CRAFT Data In Table//
        internal DataTable Insert(CRAFT_DT objCRAFT_DT, string[] aFields)
        {
            DbCommand cmdInsert;
            QueryBuilder qb = new QueryBuilder();
            m_DataBase = Factory.Create(this.ConnectionString);
            cmdInsert = qb.GetInsertCommandV3(objCRAFT_DT, "InsertCRAFTSP", aFields);
        ...
        //Getting CRAFT Data For Acknowledgment//
        internal DataSet GetAppDetails(string ServiceID, string AppID)
        {
            ...
            try
            {
                ...
                selectCommand = m_DataBase.GetStoredProcCommand("GetCRAFTDataSP");
