...
{
    internal class IGNOAPDAL:DALBase
    {
        Database m_DataBase;

        internal DataTable Insert(IGNOAP_DT objIGNOAP_DT, string[] aFields)
        {
            DbCommand cmdInsert;
            ...
            cmdInsert = qb.GetInsertCommandV3(objIGNOAP_DT, "InsertIGNOAPSP", aFields);
        ...
        internal DataSet GetIGNOAP(string ServiceID, string AppID)
        {
            ...
            try
            {
                ...
                selectCommand = m_DataBase.GetStoredProcCommand("GetIGNOAPSP");
