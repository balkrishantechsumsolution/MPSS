...
{
    internal class CMRFDAL:DALBase
    {
        Database m_DataBase;

        internal DataTable Insert(CMRF_DT objCMRF_DT, string[] aFields)
        {
            DbCommand cmdInsert;
            ...
            cmdInsert = qb.GetInsertCommandV3(objCMRF_DT, "InsertCMRFSP", aFields);
        ...
        internal DataSet GetAppDetails(string ServiceID, string AppID)
        {
            ...
            try
            {
                ...
                selectCommand = m_DataBase.GetStoredProcCommand("GetCMRFSP");
