...
{
    internal class IGNDPDAL:DALBase
    {
        Database m_DataBase;

        internal DataTable Insert(IGNDP_DT objIGNDP_DT, string[] aFields)
        {
            DbCommand cmdInsert;
            ...
            cmdInsert = qb.GetInsertCommandV3(objIGNDP_DT, "InsertIGNDPSP", aFields);
        ...
        internal DataSet GetIGNDP(string ServiceID, string AppID)
        {
            ...
            try
            {
                ...
                selectCommand = m_DataBase.GetStoredProcCommand("GetIGNDPSP");
