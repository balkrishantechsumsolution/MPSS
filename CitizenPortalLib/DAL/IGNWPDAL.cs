...
{
    internal class IGNWPDAL:DALBase
    {
        Database m_DataBase;

        internal DataTable Insert(IGNWP_DT objIGNWP_DT, string[] aFields)
        {
            DbCommand cmdInsert;
            ...
            cmdInsert = qb.GetInsertCommandV3(objIGNWP_DT, "InsertIGNWPSP", aFields);
        ...
        internal DataSet GetIGNWP(string ServiceID, string AppID)
        {
            ...
            try
            {
                ...
                selectCommand = m_DataBase.GetStoredProcCommand("GetIGNWPSP");
