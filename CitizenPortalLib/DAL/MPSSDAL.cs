...
{
    internal class MPSSDAL:DALBase
    {
        Database m_DataBase;
        ...
        internal DataSet GetAppDetails(string ServiceID, string AppID)
        {
            ...
            try
            {
                ...
                selectCommand = m_DataBase.GetStoredProcCommand("GetMPSSDataSP");
        ...
        internal DataTable UpdateSchoolProfile(SchoolDetail_DT t_SUCollege_DT, string[] aFields)
        {
            DbCommand cmdInsert;
