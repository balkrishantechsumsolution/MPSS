...
namespace CitizenPortalLib.DAL
{
    ...
    internal class BanishreeDAL : DALBase
    {
        Database m_DataBase;

        internal DataTable Insert(Banishree_DT objBanishree_DT, string[] aFields)
        {
            DbCommand cmdInsert;
            ...
            cmdInsert = qb.GetInsertCommandV3(objBanishree_DT, "InsertBanishreeSP", aFields);
        ...
        internal DataSet GetAppDetails(string ServiceID, string AppID)
        {
            ...
            try
            {
                ...
                selectCommand = m_DataBase.GetStoredProcCommand("GetBanishreeDataSP");
