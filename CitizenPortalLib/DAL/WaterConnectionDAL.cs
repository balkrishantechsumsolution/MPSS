...
{
    internal class WaterConnectionDAL:DALBase
    {
        Database m_DataBase;

        internal DataTable Insert(WaterConnection_DT objWaterConnection_DT, string[] aFields)
        {
            DbCommand cmdInsert;
            ...
            cmdInsert = qb.GetInsertCommandV3(objWaterConnection_DT, "InsertWaterConnectionSP", aFields);
        ...
        internal DataSet GetAppDetails(string ServiceID, string AppID)
        {
            ...
            try
            {
                ...
                selectCommand = m_DataBase.GetStoredProcCommand("GetWaterConnectionDataSP");
