...
{
    internal class MBPYDAL:DALBase
    {
        Database m_DataBase;

        internal DataTable Insert(MBPY_DT objMBPY_DT, string[] aFields)
        {
            DbCommand cmdInsert;
            ...
            cmdInsert = qb.GetInsertCommandV3(objMBPY_DT, "InsertMBPYSP", aFields);
        ...
        internal DataSet GetAppDetails(string ServiceID, string AppID)
        {
            ...
            try
            {
                ...
                selectCommand = m_DataBase.GetStoredProcCommand("GetMBPYDataSP");
