...
{
    internal class FarmerRegistrationDAL: DALBase
    {
        Database m_DataBase;

        internal DataTable Insert(FarmerRegistration_DT objFarmerRegistration_DT, string[] aFields)
        {
            DbCommand cmdInsert;
            ...
            cmdInsert = qb.GetInsertCommandV3(objFarmerRegistration_DT, "InsertFarmerRegistrationSP", aFields);
        ...
        internal DataSet GetFarmerRegistration(string ServiceID, string AppID)
        {
            ...
            try
            {
                ...
                selectCommand = m_DataBase.GetStoredProcCommand("GetFarmerRegistrationSP");
